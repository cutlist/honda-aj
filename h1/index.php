    ...
    <body class="bg-white">
        <div class="form-box" id="login-box">
            <div class="header">
            	...
            	<img src="../gambar/h1.png" style="height:60px"></br>
            </div>
            
            <form method="post" action="../page/module/loginh1.php">
                <div class="body bg-gray">
                    <div class="form-group">
                        <input type="text" name="user" autofocus class="form-control" placeholder="Username" required="" style="height:40px"/>
                    </div>
                    <div class="form-group">
