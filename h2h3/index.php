    ...
    <body class="bg-white">
        <div class="form-box" id="login-box">
            <div class="header">
            	...
            	<img src="../gambar/h2h3.png" style="height:60px"></br>
            </div>
            
            <form method="post" action="../page/module/loginh2h3.php">
                <div class="body bg-gray">
                    <div class="form-group">
                        <input type="text" name="user" class="form-control" autofocus="" placeholder="Username" required="" style="height:40px"/>
                    </div>
                    <div class="form-group">
                        <input type="password" name="pass" class="form-control" placeholder="Password" required="" style="height:40px"/>
                    </div>
                </div>
                <div class="footer" style="">                                                               
                    <button type="submit" class="btn bg-red btn-block" style="height: 50px">Login</button>
                    <!--
