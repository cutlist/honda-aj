...
$d1 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_notabeli WHERE id%2=0 AND nodo='$_REQUEST[nodo]'"));
...
?>
    ...
    <div class="col-xs-12">
	    <table width="100%" class="table table-striped table-bordered">
	        ...
	        while($dA = mysql_fetch_array($q1))
				...
				$dB = mysql_fetch_array(mysql_query("SELECT * FROM tbl_stokunit WHERE id%2=0 AND norangka='$dA[norangka]'"));
	...
	<div style="padding:20px">
	    ...
	    <?
	    $dR = mysql_fetch_array(mysql_query("SELECT * FROM tbl_returbeli WHERE id%2=0 AND nodo='$_REQUEST[nodo]'"));
	    ?>
		<div style="padding:20px;">
	    	<table width="70%">
	    		<tr>
