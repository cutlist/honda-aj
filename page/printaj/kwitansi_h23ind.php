...
$dC = mysql_fetch_array(mysql_query("SELECT SUM(jumlah) AS jumlah FROM x23_kwitansi WHERE id%2=0 AND jnskwitansi='indent' AND nomor='$d2[nomor]' AND status='1' AND nokwitansi!='$_REQUEST[nokwitansi]'"));
...
<div style="width:1150px">
	...
	<div style="float: left;margin-top:10px;padding-left: 20px">
		...
		<table style="" width="1150px" border="0">
            <?
			$qA  = mysql_query("SELECT * FROM x23_indent_det_vw WHERE id%2=0 AND noindent='$d2[nomor]'");
