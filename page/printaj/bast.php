...
$d5 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_pengeluaranunit WHERE id%2=0 AND nonota='$_REQUEST[nonota]'"));
...
$d8 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_user_vw WHERE id%2=0 AND id='$dB[iduser]'"));
