...
$dA = mysql_fetch_array(mysql_query("SELECT *,SUM(jumlahtagih2) AS total FROM x23_kwitansikpb WHERE id%2=0 AND nokwitansi='$_REQUEST[nokwitansi]'"));
$d3 = mysql_fetch_array(mysql_query("SELECT nama,posisi FROM x23_user_vw WHERE id%2=0 AND id='$dA[iduser]'"));
...
?>
	...
	<div class="col-xs-12" style="text-align:left">
		<table style="font-size: 16px;width: 100%">
			<tr>
				<td width="30%">NOMOR KWITANSI PENAGIHAN KPB</td>
				<td width="3%"><b>:</b></td>
			...
			<tr>
				...
				<td><b>
					<?
					if($dA[total]!="0"){echo Terbilang($dA[total])." RUPIAH";}
			...
			<tr>
				...
				<td width="3%"><b>:</b></td>
				<td><b><?echo tgl_indo(date("Y-m-d",strtotime($dA[tglpenagihan])))?></b></td>
			</tr>
			<tr>
				<td>UNTUK PEMBAYARAN</td>
				<td><b>:</b></td>
				<td><b>KARTU PERAWATAN BERKALA</b></td>
			</tr>
			<tr><td height="20px"></td></tr>
		</table>
	</div>
    ...
    <div class="col-xs-12">
    	<table id="example2" class="table table-bordered table-striped" style="width:100%">
			...
			<?
			$dA1 = mysql_fetch_array(mysql_query("SELECT COUNT(id) AS qty FROM x23_kwitansikpb_vw WHERE id%2=0 AND nokwitansi='$_REQUEST[nokwitansi]' AND kpbke='1'"));
			$dA2 = mysql_fetch_array(mysql_query("SELECT COUNT(id) AS qty FROM x23_kwitansikpb_vw WHERE id%2=0 AND nokwitansi='$_REQUEST[nokwitansi]' AND kpbke='2'"));
			$dA3 = mysql_fetch_array(mysql_query("SELECT COUNT(id) AS qty FROM x23_kwitansikpb_vw WHERE id%2=0 AND nokwitansi='$_REQUEST[nokwitansi]' AND kpbke='3'"));
			$dA4 = mysql_fetch_array(mysql_query("SELECT COUNT(id) AS qty FROM x23_kwitansikpb_vw WHERE id%2=0 AND nokwitansi='$_REQUEST[nokwitansi]' AND kpbke='4'"));
			
			$dB1 = mysql_fetch_array(mysql_query("SELECT SUM(jumlahtagih2) AS rp FROM x23_kwitansikpb_vw WHERE id%2=0 AND nokwitansi='$_REQUEST[nokwitansi]' AND kpbke='1'"));
			$dB2 = mysql_fetch_array(mysql_query("SELECT SUM(jumlahtagih2) AS rp FROM x23_kwitansikpb_vw WHERE id%2=0 AND nokwitansi='$_REQUEST[nokwitansi]' AND kpbke='2'"));
			$dB3 = mysql_fetch_array(mysql_query("SELECT SUM(jumlahtagih2) AS rp FROM x23_kwitansikpb_vw WHERE id%2=0 AND nokwitansi='$_REQUEST[nokwitansi]' AND kpbke='3'"));
			$dB4 = mysql_fetch_array(mysql_query("SELECT SUM(jumlahtagih2) AS rp FROM x23_kwitansikpb_vw WHERE id%2=0 AND nokwitansi='$_REQUEST[nokwitansi]' AND kpbke='4'"));
		...
		<table style="font-size: 16px;width: 100%">
			<tr>
				...
				<td><b><?echo number_format($dA[total],"0","",".")?></b></td>
			</tr>
			<tr><td height="20px"></td></tr>
		</table>
