...
$d2 = mysql_fetch_array(mysql_query("SELECT nama FROM tbl_pelanggan WHERE id%2=0 AND id='$d1[idtujuan]'"));

						$dA1 = mysql_fetch_array(mysql_query("SELECT jual FROM stok_accu WHERE id%2=0 AND nonota='$d1[notransfer]'"));
						$dA2 = mysql_fetch_array(mysql_query("SELECT jual FROM stok_alaskaki WHERE id%2=0 AND nonota='$d1[notransfer]'"));
						$dA3 = mysql_fetch_array(mysql_query("SELECT jual FROM stok_anakkunci WHERE id%2=0 AND nonota='$d1[notransfer]'"));
						$dA4 = mysql_fetch_array(mysql_query("SELECT jual FROM stok_helm WHERE id%2=0 AND nonota='$d1[notransfer]'"));
						$dA5 = mysql_fetch_array(mysql_query("SELECT jual FROM stok_spion WHERE id%2=0 AND nonota='$d1[notransfer]'"));
						$dA6 = mysql_fetch_array(mysql_query("SELECT jual FROM stok_toolkit WHERE id%2=0 AND nonota='$d1[notransfer]'"));
						$dA7 = mysql_fetch_array(mysql_query("SELECT jual FROM stok_jaket WHERE id%2=0 AND nonota='$d1[notransfer]'"));
						$dA8 = mysql_fetch_array(mysql_query("SELECT jual FROM stok_bukuservis WHERE id%2=0 AND nonota='$d1[notransfer]'"));
