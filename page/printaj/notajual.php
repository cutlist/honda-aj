...
?>
	...
	<div class="col-xs-12" style="text-align:center">
		<h4><b>NOTA JUAL</br>CV ANUGRAH JAYA</b></h5>
	</div>
	</br>
	<div class="col-xs-12">
		<b>DATA PELANGGAN</b>
	...
	<?
		...
		$dS  = mysql_fetch_array(mysql_query("SELECT nama FROM tbl_user_vw WHERE id%2=0 AND id='$dB[idsales]'"));
		$dI  = mysql_fetch_array(mysql_query("SELECT nama FROM tbl_user_vw WHERE id%2=0 AND id='$dB[iduser]'"));
	?>	
	<div class="col-xs-12">
	...
	<div class="col-xs-6" style="font-size:12px">
		<table width="100%">
    		<tr>
    			<td width="55%">HARGA JUAL</td>
    			<td width="2%">:</td>
    			<td colspan="1" width="1%">RP. </td>
    			<td align="right"><span style="padding-right:55%"><?echo number_format($dB[totr],"0","",".")?></span></td>
    		</tr>
                <?
        		...
        		?>
            		<tr>
            			...
            			<td>:</td>
		    			<td colspan="1" width="1%">RP. </td>
		    			<td align="right"><span style="padding-right:55%"><?echo number_format($dB[totr]*1.1,"0","",".")?></span></td>
            		</tr>
				<?
					}
    		...
    		<tr>
    			...
    			<td>:</td>
    			<td colspan="1">RP. </td>
    			<td align="right"><span style="padding-right:55%"><?echo number_format($dB[tdisc],"0","",".")?></span></td>
    		</tr>
		<?
		if($dA[jnstransaksi]=='CASH TEMPO')
			{
    		if($dA[jnscashtempo]=='MANDIRI')
    			{
		?>
	    		<tr>
	    			...
	    			<td>:</td>
	    			<td colspan="1">RP. </td>
	    			<td align="right"><span style="padding-right:55%"><?echo number_format(($dB[totr]-$dB[tdisc]+$dB[ppn]),"0","",".")?></span></td>
	    		</tr>
	    <?
				}
			}
		...
		?>
    		<tr>
    			...
    			<td>:</td>
    			<td colspan="1">RP. </td>
    			<td align="right"><span style="padding-right:55%"><?echo number_format($dB[bayar],"0","",".")?></span></td>
    		</tr>
    		<tr>
    			<td>SISA PEMBAYARAN</td>
    			<td>:</td>
    			<td colspan="1">RP. </td>
    			<td align="right"><span style="padding-right:55%"><?echo number_format($dB[sisabayar],"0","",".")?></span></td>
    		</tr>
    	<?
    		}
    	?>
