		...
		<tbody>
								...
								?>
			                                ...
			                                <tr style="cursor:pointer">
				                    			...
				                    			<td align="right"><span style="padding-right:10%"><?echo number_format(round($g/2),"0","",".")?></span></td>
				                    			<td align="right"><span style="padding-right:10%"><?echo number_format(round($c/2),"0","",".")?></span></td>
				                    			<td align="right"><span style="padding-right:10%"><?echo number_format(round($f2/2),"0","",".")?></span></td>
