...
?>
    ...
    <table>
										...
										if(!empty($_REQUEST[cari]))
											{
											$q1 = mysql_query("SELECT * FROM tbl_notajual_vw WHERE id%2=0 AND nama LIKE '%$_REQUEST[cari]%' OR jnstransaksi LIKE '%$_REQUEST[cari]%' OR nonota LIKE '%$_REQUEST[cari]%' LIMIT 0,20");
											}
										else
											{
