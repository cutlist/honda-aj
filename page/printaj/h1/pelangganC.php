...
?>
    ...
    <table width="100%">
										...
										if(!empty($_REQUEST[cari]))
											{
											$q1 = mysql_query("SELECT * FROM tbl_pelanggan WHERE id%2=0 AND ohc='' AND (nama LIKE '%$_REQUEST[cari]%' OR notelepon LIKE '%$_REQUEST[cari]%' OR alamat LIKE '%$_REQUEST[cari]%') LIMIT 0,5");
											}
										else{
