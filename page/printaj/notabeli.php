...
$d1 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_notabeli WHERE id%2=0 AND nonota='$_REQUEST[nonota]'"));
...
$d3 = mysql_fetch_array(mysql_query("SELECT nama,posisi FROM tbl_user_vw WHERE id%2=0 AND id='$d1[iduser]'"));
