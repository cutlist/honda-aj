	...
	?>
	        <ul class="sidebar-menu" style="overflow-y:auto;overflow-x:hidden;height:500px;">
	            ...
	            <li class="<?if($menu==md5(barang)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(barang);?>">
	                    <i class="fa fa-dropbox"></i> <span>Barang</span>
	                </a>
	            </li>
	            <li class="<?if($menu==md5(grossubsidi)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(grossubsidi);?>">
	                    <i class="fa fa-bolt"></i> <span>Pajak Matrix</span>
	                </a>
	            </li>
	            <li class="<?if($menu==md5(insentif)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(insentif);?>">
	                    <i class="fa fa-dollar"></i> <span>Komisi</span>
	                </a>
	            </li>
	            <li class="<?if($menu==md5(leasing)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(leasing);?>">
	                    <i class="fa fa-money"></i> <span>Leasing</span>
	                </a>
	            </li>
	            <li class="<?if($menu==md5(gudang)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(gudang);?>">
	            ...
	            <li class="treeview <?if($menu==md5(daerah)){echo "active";}?>">
	                ...
	                <ul class="treeview-menu">
			            <li <?if($menu==md5(daerah) && $submenu == "kab"){?>class="active"<?}?>">
			                <a href="<? echo "?opt=$opt&submenu=kab&menu=".md5(daerah);?>">
	            ...
	            <li class="<?if($menu==md5(perusahaan)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(perusahaan);?>">
	                    <i class="fa fa-building-o"></i> <span>Perusahaan</span>
	                </a>
	            </li>
	            <li class="<?if($menu==md5(target)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(target);?>">
	                    <i class="fa fa-dot-circle-o"></i> <span>Target</span>
	                </a>
	            </li>
	        </ul>
	<?
	...
	?>
	        <ul class="sidebar-menu" style="overflow-y:auto;overflow-x:hidden;height:500px;">
	            <li class="<?if($menu==md5(pelanggan)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(pelanggan);?>">
	                    <i class="fa fa-tags"></i> <span>Daftar Pelanggan</span>
	                </a>
	            </li>
	            <li class="<?if($menu==md5(pelangganohc)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=B&menu=".md5(pelangganohc);?>">
	                    <i class="fa fa-credit-card"></i> <span>OHC</span>
	                </a>
	            </li>
	            <li class="<?if($menu==md5(pelanggannonohc)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=C&menu=".md5(pelanggannonohc);?>">
	                    <i class="fa fa-bookmark-o"></i> <span>Non OHC</span>
	                </a>
	            </li>
	            ...
	            <li class="<?if($menu==md5(potensial)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=potensial&menu=".md5(potensial);?>" id="5">
	                    <i class="fa fa-retweet"></i> <span>Pelanggan Potensial</span>
	                </a>
	            </li>
	            <li class="<?if($menu==md5(prospek)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=prospek&menu=".md5(prospek);?>" id="6">
	                    <i class="fa fa-rocket"></i> <span>Prospek Terpilih</span>
	                </a>
	            </li>
	        </ul>
	<?
	...
	?>
	        <ul class="sidebar-menu" style="overflow-y:auto;overflow-x:hidden;height:500px;">
	            <li class="<?if($menu==md5(cekfisik)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(cekfisik);?>">
	                    <i class="fa fa-check"></i> <span>Cek Fisik</span>
	                </a>
	            </li>
	            <li class="<?if($menu==md5(konfnotabeli)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=unit&menu=".md5(konfnotabeli);?>">
	                    <i class="fa fa-file"></i> <span>Konfirmasi Nota Beli</span>
	                </a>
	            </li>
	            <li class="<?if($menu==md5(stok)){echo "active";}?>">
	            ...
	            <li class="<?if($menu==md5(stokaksesoris)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(stokaksesoris);?>">
	                    <i class="fa fa-gift"></i> <span>Stok Aksesoris</span>
	                </a>
	            </li>
	            <li class="<?if($menu==md5(statusaksesoris)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(statusaksesoris);?>" id="5">
	                    <i class="fa fa-asterisk"></i> <span>Status Aksesoris (Masuk)</span>
	                </a>
	            </li>
	            <li class="<?if($menu==md5(pindahlokasi)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(pindahlokasi);?>">
	                    <i class="fa fa-exchange"></i> <span>Pindah Lokasi</span>
	                </a>
	            </li>
	            <li class="treeview <?if($menu==md5(transferbrg)){echo "active";}?>">
	                ...
	                <ul class="treeview-menu">
			            ...
			            <li <?if($menu==md5(transferbrg) && $submenu == "F"){?>class="active"<?}?>">
	...
	?>
	        <ul class="sidebar-menu" style="overflow-y:auto;overflow-x:hidden;height:500px;">
	            <li class="<?if($menu==md5(notabeli)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(notabeli);?>">
	                    <i class="fa fa-file-o"></i> <span>Nota Beli</span>
	                </a>
	            </li>
	            <li class="<?if($menu==md5(bayarsup)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(bayarsup);?>">
	...
	?>
	        <ul class="sidebar-menu" style="overflow-y:auto;overflow-x:hidden;height:500px;">
	            ...
	            <li class="<?if($menu==md5(uangharian)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(uangharian);?>">
	            ...
	            <li class="treeview <?if($menu==md5(uanglembur)){echo "active";}?>">
	                ...
	                <ul class="treeview-menu">
			            <li class="<?if($menu==md5(uanglembur) && $submenu == "A"){echo "active";}?>"><a href="<? echo "?opt=$opt&submenu=A&menu=".md5(uanglembur);?>"><i class="fa fa-angle-double-right"></i> Daftar Lembur</a></li>
	...
	?>
	        <ul class="sidebar-menu" style="overflow-y:auto;overflow-x:hidden;height:500px;">
	            <li class="<?if($menu==md5(abis_dkonfirmasipic)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(abis_dkonfirmasipic);?>">
	                    <i class="fa fa-file"></i> <span>Daftar Konfirmasi</span>
	                </a>
	            </li>
	        </ul>
	<?
	...
	?>
	        <ul class="sidebar-menu" style="overflow-y:auto;overflow-x:hidden;height:500px;">
	            ...
	            <li class="<?if($menu==md5(supplier)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(supplier);?>">
	            ...
	            <li class="treeview <?if($menu==md5(hargabarang)){echo "active";}?>">
	                ...
	                <ul class="treeview-menu">
			            <li <?if($menu==md5(hargabarang) && $submenu == "input"){?>class="active"<?}?>">
			                <a href="<? echo "?opt=$opt&submenu=input&menu=".md5(hargabarang);?>">
							<i class="fa fa-angle-double-right"></i> Input Harga</a></li>
			            <li <?if($menu==md5(hargabarang) && $submenu == "daftar"){?>class="active"<?}?>">
	            ...
	            <li class="<?if($menu==md5(jasa)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(jasa);?>">
	                    <i class="fa fa-thumbs-up"></i> <span>Jasa</span>
	                </a>
	            </li>
	            <li class="<?if($menu==md5(tarifjasa)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(tarifjasa);?>">
	                    <i class="fa fa-dollar"></i> <span>Tarif Jasa ke Konsumen</span>
	                </a>
	            </li>
	            ...
	            <li class="<?if($menu==md5(kelompokjasa)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(kelompokjasa);?>">
	                    <i class="fa fa-th"></i> <span>Pengelompokkan Jasa</span>
	                </a>
	            </li>
	            <li class="<?if($menu==md5(gudang)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(gudang);?>">
	                    <i class="fa fa-archive"></i> <span>Gudang</span>
	                </a>
	            </li>
	            <li class="<?if($menu==md5(rak)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(rak);?>">
	                    <i class="fa fa-archive"></i> <span>Rak</span>
	                </a>
	            </li>
	            <li class="<?if($menu==md5(perusahaan)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(perusahaan);?>">
	...
	?>
	        <ul class="sidebar-menu" style="overflow-y:auto;overflow-x:hidden;height:500px;">
	            ...
	            <li class="<?if($menu==md5(historyjual)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(historyjual);?>">
	                    <i class="fa fa-paperclip""></i> <span>History</span>
	                </a>
	            </li>
	            <li class="<?if($menu==md5(indent)){echo "active";}?>">
	...
	?>
	        <ul class="sidebar-menu" style="overflow-y:auto;overflow-x:hidden;height:500px;">
	            <li class="treeview <?if($menu==md5(kwitansi)){echo "active";}?>">
	                ...
	                <ul class="treeview-menu">
			            <li class="<?if($menu==md5(kwitansi) && $submenu == "A"){echo "active";}?>"><a href="<? echo "?opt=$opt&submenu=A&menu=".md5(kwitansi);?>"><i class="fa fa-angle-double-right"></i> Servis</a></li>
			            ...
			            <li class="<?if($menu==md5(kwitansi) && $submenu == "D"){echo "active";}?>"><a href="<? echo "?opt=$opt&submenu=D&menu=".md5(kwitansi);?>"><i class="fa fa-angle-double-right"></i> Tunai</a></li>
					</ul>
	            </li>
	            <li class="<?if($menu==md5(kaskecil)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(kaskecil);?>">
	            ...
	            <li class="treeview <?if($menu==md5(pndharian)){echo "active";}?>">
	                ...
	                <ul class="treeview-menu">
			            <li class="<?if($menu==md5(pndharian) && $submenu == "A"){echo "active";}?>"><a href="<? echo "?opt=$opt&submenu=A&menu=".md5(pndharian);?>"><i class="fa fa-angle-double-right"></i> Servis</a></li>
			            <li class="<?if($menu==md5(pndharian) && $submenu == "B"){echo "active";}?>"><a href="<? echo "?opt=$opt&submenu=B&menu=".md5(pndharian);?>"><i class="fa fa-angle-double-right"></i> Sparepart</a></li>
			        </ul>
	            </li>
	            <li class="<?if($menu==md5(laporanws1)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(laporanws1);?>">
	                    <i class="fa fa-thumb-tack"></i> <span>Laporan Workshop 1</span>
	                </a>
	            </li>
	            <li class="<?if($menu==md5(laporanws2)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(laporanws2);?>">
	                    <i class="fa fa-thumb-tack"></i> <span>Laporan Workshop 2</span>
	                </a>
	            </li>
	            <li class="<?if($menu==md5(tutupharian)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(tutupharian);?>">
	                    <i class="fa fa-minus-square"></i> <span>Tutup Harian</span>
	                </a>
	            </li>
	        </ul>
	<?
	...
	?>
	        <ul class="sidebar-menu" style="overflow-y:auto;overflow-x:hidden;height:500px;">
	        	<li class="<?if($menu==md5(konfnotabeli)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(konfnotabeli);?>">
	                    <i class="fa fa-file"></i> <span>Konfirmasi Nota Beli</span>
	                </a>
	            </li>
	        	<li class="<?if($menu==md5(konfnotaclaim)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(konfnotaclaim);?>">
	                    <i class="fa fa-file"></i> <span>Konfirmasi Nota Claim</span>
	                </a>
	            </li>
	            <li class="<?if($menu==md5(konfreturbeli)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(konfreturbeli);?>">
	                    <i class="fa fa-file"></i> <span>Konfirmasi Retur Beli</span>
	                </a>
	            </li>
				<li class="<?if($menu==md5(stok)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(stok);?>">
	            ...
	            <li class="<?if($menu==md5(penyesuaianstok)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(penyesuaianstok);?>">
	                    <i class="fa fa-wrench"></i> <span>Stock Opname</span>
	                </a>
	            </li>
	        </ul>
	<?
	...
	?>
	        <ul class="sidebar-menu" style="overflow-y:auto;overflow-x:hidden;height:500px;">
	            ...
	            <li class="<?if($menu==md5(notaretur)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(notaretur);?>">
	                    <i class="fa fa-share-square-o"></i> <span>Nota Retur</span>
	                </a>
	            </li>
	            <li class="<?if($menu==md5(bayarkpb)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(bayarkpb);?>">
	                    <i class="fa fa-dollar"></i> <span>Bayar Servis KPB</span>
	                </a>
	            </li>
	        </ul>
	<?
	...
	?>
	        <ul class="sidebar-menu" style="overflow-y:auto;overflow-x:hidden;height:500px;">
	            ...
	            <li class="<?if($menu==md5(claimoli)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(claimoli);?>">
	                    <i class="fa fa-circle-o"></i> <span>Claim Oli Ke MPM</span>
	                </a>
	            </li>
	        </ul>
	<?
	...
	?>
	        <ul class="sidebar-menu" style="overflow-y:auto;overflow-x:hidden;height:500px;">
	            <li class="<?if($menu==md5(abis_penjualan)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(abis_penjualan);?>">
	                    <i class="fa fa-paperclip"></i> <span>Ringkasan Penjualan</span>
	                </a>
	            </li>
	            <li class="<?if($menu==md5(abis_servis)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(abis_servis);?>">
	                    <i class="fa fa-paperclip"></i> <span>Ringkasan Servis</span>
	                </a>
	            </li>
	            <li class="<?if($menu==md5(abis_motorservis)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(abis_motorservis);?>">
	                    <i class="fa fa-paperclip"></i> <span>Ringkasan Motor Servis</span>
	                </a>
	            </li>
	            <li class="<?if($menu==md5(abis_pembelian)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(abis_pembelian);?>">
	                    <i class="fa fa-paperclip"></i> <span>Ringkasan Pembelian</span>
	                </a>
	            </li>
	            <li class="<?if($menu==md5(abis_arusbarang)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(abis_arusbarang);?>">
	                    <i class="fa fa-paperclip"></i> <span>Ringkasan Arus Barang</span>
	                </a>
	            </li>
	            <li class="<?if($menu==md5(abis_dkonfirmasi)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(abis_dkonfirmasi);?>">
	                    <i class="fa fa-file"></i> <span>Daftar Konfirmasi</span>
	                </a>
	            </li>
	            <li class="<?if($menu==md5(abis_ikesalahan)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(abis_ikesalahan);?>">
	                    <i class="fa fa-times"></i> <span>Indikasi Kesalahan</span>
	                </a>
	            </li>
	        </ul>
	<?
	...
	?>
	        <ul class="sidebar-menu" style="overflow-y:auto;overflow-x:hidden;height:500px;">
	            <li class="<?if($menu==md5(antrianinput)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(antrianinput);?>">
	                    <i class="fa fa-tags"></i> <span>Input Antrian</span>
	                </a>
	            </li>
	            <li class="<?if($menu==md5(antrianshow)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(antrianshow);?>">
	                    <i class="fa fa-desktop"></i> <span>Antrian Berjalan</span>
	                </a>
	            </li>
	            <li class="<?if($menu==md5(notaservice)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(notaservice);?>">
	                    <i class="fa fa-play"></i> <span>Memulai Servis</span>
	                </a>
	            </li>
	            <li class="<?if($menu==md5(notaservice2)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(notaservice2);?>">
	                    <i class="fa fa-wrench"></i> <span>Input Nota Servis</span>
	                </a>
	            </li>
	            <li class="<?if($menu==md5(historyservice)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(historyservice);?>">
	                    <i class="fa fa-wrench"></i> <span>History Servis</span>
	                </a>
	            </li>
	            <li class="treeview <?if($menu==md5(kinerjamekanik)){echo "active";}?>">
	                <a href="#">
	                    <i class="fa fa-gears"></i>
	                    <span>Kinerja Mekanik</span>
	                    <i class="fa fa-angle-left pull-right"></i>
	                </a>
	                <ul class="treeview-menu">
			            <li <?if($menu==md5(kinerjamekanik) && $submenu == "individu"){?>class="active"<?}?>">
			                <a href="<? echo "?opt=$opt&submenu=individu&menu=".md5(kinerjamekanik);?>">
							<i class="fa fa-angle-double-right"></i> Individu</a></li>
			            ...
			            <li <?if($menu==md5(kinerjamekanik) && $submenu == "semuaomset"){?>class="active"<?}?>">
			                ...
			                <i class="fa fa-angle-double-right"></i> Semua 2</a></li>
					</ul>
	            </li>
	            <li class="<?if($menu==md5(tutupservis)){echo "active";}?>">
	                <a href="<? echo "?opt=$opt&submenu=A&menu=".md5(tutupservis);?>">
	                    <i class="fa fa-check-square-o"></i> <span>Tutup Servis</span>
	                </a>
	            </li>
	        </ul>
	<?
	...
	?>
	        <ul class="sidebar-menu" style="overflow-y:auto;overflow-x:hidden;height:500px;">
	            <li>
	                <a data-toggle="modal" data-target="#compose-modal-listtarif" style="cursor:pointer">
	                    <i class="fa fa-hdd-o"></i> <span>Backup Database</span>
	                </a>
	            </li>
	        </ul>
	        ...
	        <ul class="sidebar-menu" style="overflow-y:auto;overflow-x:hidden;height:500px;">
	            <li class="treeview <?if($menu==md5(kwitansi)){echo "active";}?>">
	                ...
	                <ul class="treeview-menu">
			            ...
			            <li class="<?if($menu==md5(kwitansi) && $submenu == "C"){echo "active";}?>"><a href="<? echo "?opt=$opt&submenu=C&menu=".md5(kwitansi);?>"><i class="fa fa-angle-double-right"></i> Indent</a></li>
			            <li class="<?if($menu==md5(kwitansi) && $submenu == "D"){echo "active";}?>"><a href="<? echo "?opt=$opt&submenu=D&menu=".md5(kwitansi);?>"><i class="fa fa-angle-double-right"></i> Tunai</a></li>
			            <li class="<?if($menu==md5(kwitansi) && $submenu == "E"){echo "active";}?>"><a href="<? echo "?opt=$opt&submenu=E&menu=".md5(kwitansi);?>"><i class="fa fa-angle-double-right"></i> Piutang</a></li>
					</ul>
	            </li>
	            <li class="<?if($menu==md5(kaskecil)){echo "active";}?>">
	            ...
	            <li class="treeview <?if($menu==md5(laporanws1) || $menu==md5(laporanws2) || $menu==md5(laporanws3) || $menu==md5(laporanws4)){echo "active";}?>">
	                <a href="#">
	                    ...
	                    <span><u>L</u>aporan Workshop</span>
	                    <i class="fa fa-angle-left pull-right"></i>
	                </a>
	                <ul class="treeview-menu">
	        ...
	        <ul class="sidebar-menu" style="overflow-y:auto;overflow-x:hidden;height:500px;">
	            ...
	            <li class="<?if($menu==md5(notaretur)){echo "active";}?>">
	                <a id="2" href="<? echo "?opt=$opt&submenu=A&menu=".md5(notaretur);?>">
	                    <i class="fa fa-share-square-o"></i> <span><u>N</u>ota Retur</span>
	                </a>
	            </li>
	            <li class="<?if($menu==md5(bayarkpb)){echo "active";}?>">
	...
	?>
	        <ul class="sidebar-menu" style="overflow-y:auto;overflow-x:hidden;height:500px;">
	            ...
	            <li class="<?if($menu==md5(antrianshow)){echo "active";}?>">
	                <a id="2" href="<? echo "?opt=$opt&submenu=A&menu=".md5(antrianshow);?>">
	            ...
	            <li class="<?if($menu==md5(servisjr)){echo "active";}?>">
	                <a id="8" href="<? echo "?opt=$opt&submenu=A&menu=".md5(servisjr);?>">
	                    <i class="fa fa-search"></i> <span><u>C</u>ek Servis JR</span>
	                </a>
	            </li>
	            <li class="<?if($menu==md5(notaservice)){echo "active";}?>">
	            ...
	            <li class="<?if($menu==md5(historyservice)){echo "active";}?>">
	                <a id="5" href="<? echo "?opt=$opt&submenu=A&menu=".md5(historyservice);?>">
	                    <i class="fa fa-wrench"></i> <span><u>H</u>istory Servis</span>
	                </a>
	            </li>
	            <li class="treeview <?if($menu==md5(kinerjamekanik)){echo "active";}?>">
	                <a href="#">
