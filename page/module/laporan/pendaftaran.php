...
class FPDF_AutoWrapTable extends FPDF {
	...
	public function rptDetailData () {
		...
		$this->SetFont("", "B", 12);
		$this->Ln(10);
		$this->SetX($left); $this->Cell(0, 10, "REPORT PENDAFTARAN", 0, 1,'C');
		$this->Ln(4);
		$this->SetX($left); $this->Cell(0, 10, "Periode ".$_REQUEST['awal']." s/d ".$_REQUEST['akhir'], 0, 1,'C');
		$this->Ln(10);
			...
			$this->SetX($left += 60); $this->Cell(70, $h, 'Kode', 1, 0, 'C',true);
			$this->SetX($left += 70); $this->Cell(130, $h, 'Nama Anggota', 1, 0, 'C',true);
			$this->SetX($left += 130); $this->Cell(130, $h, 'Pasien', 1, 0, 'C',true);
			$this->SetX($left += 130); $this->Cell(130, $h, 'Dokter', 1, 1, 'C',true);
			//$this->Ln(20);
			
			$this->SetFont('Arial','',7);
			$this->SetWidths(array(20,60,70,130,130,130));
			$this->SetAligns(array('R','C','L','L','L','L'));
