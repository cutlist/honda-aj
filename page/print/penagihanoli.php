...
$dA = mysql_fetch_array(mysql_query("SELECT * FROM x23_notabeli WHERE nokwitansi='$_REQUEST[nokwitansi]'"));			                           
$d2 = mysql_fetch_array(mysql_query("SELECT SUM(hargaoli) AS hargaoli FROM x23_notabeli_claim_det WHERE nonota='$dA[nonota]'"));	
$d3 = mysql_fetch_array(mysql_query("SELECT nama,posisi FROM x23_user_vw WHERE id='$dA[iduserbeli]'"));
...
?>
    ...
    <div class="col-xs-12">
    	<table id="example2" class="table table-bordered table-striped" style="width:100%">
			...
			<?
			$dA1 = mysql_fetch_array(mysql_query("SELECT COUNT(id) AS qty FROM x23_notabeli_claim_det WHERE nonota='$dA[nonota]' AND kpbke='1'"));
			$dA2 = mysql_fetch_array(mysql_query("SELECT COUNT(id) AS qty FROM x23_notabeli_claim_det WHERE nonota='$dA[nonota]' AND kpbke='2'"));
			$dA3 = mysql_fetch_array(mysql_query("SELECT COUNT(id) AS qty FROM x23_notabeli_claim_det WHERE nonota='$dA[nonota]' AND kpbke='3'"));
			$dA4 = mysql_fetch_array(mysql_query("SELECT COUNT(id) AS qty FROM x23_notabeli_claim_det WHERE nonota='$dA[nonota]' AND kpbke='4'"));
			
			$dB1 = mysql_fetch_array(mysql_query("SELECT SUM(hargaoli) AS rp FROM x23_notabeli_claim_det WHERE nonota='$dA[nonota]' AND kpbke='1'"));
			$dB2 = mysql_fetch_array(mysql_query("SELECT SUM(hargaoli) AS rp FROM x23_notabeli_claim_det WHERE nonota='$dA[nonota]' AND kpbke='2'"));
			$dB3 = mysql_fetch_array(mysql_query("SELECT SUM(hargaoli) AS rp FROM x23_notabeli_claim_det WHERE nonota='$dA[nonota]' AND kpbke='3'"));
			$dB4 = mysql_fetch_array(mysql_query("SELECT SUM(hargaoli) AS rp FROM x23_notabeli_claim_det WHERE nonota='$dA[nonota]' AND kpbke='4'"));
