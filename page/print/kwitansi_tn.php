...
$d2 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_kwitansi WHERE nokwitansi='$_REQUEST[nokwitansi]'"));
$d3 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_karyawan WHERE id='$d2[idpelanggan]'"));
		
		if($d2[cetak]=="0"){
			if($d2[idpotkom]=="1"){
				$dB = mysql_fetch_array(mysql_query("SELECT * FROM tbl_piutang WHERE id='$d2[nomor]'"));
...
mysql_query("UPDATE tbl_kwitansi SET cetak='1' WHERE nokwitansi='$_REQUEST[nokwitansi]'");

mysql_query("UPDATE tbl_kwitansi SET status='1' WHERE nokwitansi='$_REQUEST[nokwitansi]'");
if($d2[idpotkom]=="0"){
	mysql_query("UPDATE tbl_piutang SET status='1',updatex='$updatex' WHERE id='$d2[nomor]'");
	}
if($d2[idpotkom]!="0"){
	mysql_query("UPDATE tbl_potkompensasi SET status='1',updatex='$updatex' WHERE id='$d2[nomor]'");
	}
