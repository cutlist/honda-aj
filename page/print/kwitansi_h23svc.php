...
$dAx = mysql_fetch_array(mysql_query("SELECT * FROM x23_notaservice_vw WHERE nonota='$d2[nomor]'"));

$d4 = mysql_fetch_array(mysql_query("SELECT * FROM x23_karyawan WHERE id='$dAx[idmekanik]'"));
...
$dC = mysql_fetch_array(mysql_query("SELECT *,COUNT(tarif) AS tqty, SUM(tarif) AS ttotal, SUM(tarifasli) AS tottarifasli, SUM(diskon) AS totdiskon FROM x23_notaservice_det WHERE nonota='$d2[nomor]'"));
...
mysql_query("UPDATE x23_notaservice SET statuskwitansi='1' WHERE nonota='$d2[nomor]'");
?>
...
<div style="width:1150px">
	...
	<div style="float: left;margin-top:10px;padding-left: 20px">
		...
		<table style="" width="1150px" border="0">
            <?
            $dA1 = mysql_fetch_array(mysql_query("SELECT * FROM x23_notajual_det_vw WHERE nonota='$d2[nomor]'"));
			$qA  = mysql_query("SELECT * FROM x23_notajual_det_vw WHERE nonota='$d2[nomor]'");
            ...
            $dA2 = mysql_fetch_array(mysql_query("SELECT * FROM x23_notaservice_det WHERE nonota='$d2[nomor]'"));
			$qA = mysql_query("SELECT * FROM x23_notaservice_det WHERE nonota='$d2[nomor]'");
            while($dA = mysql_fetch_array($qA))
            	{
            ...
            $dA2 = mysql_fetch_array(mysql_query("SELECT * FROM x23_notaservice_det WHERE nonota='$dAx[noservis]' AND nonota!=''"));
			$qA = mysql_query("SELECT * FROM x23_notaservice_det WHERE nonota='$dAx[noservis]' AND nonota!=''");
            while($dA = mysql_fetch_array($qA))
            	{
            	if(!empty($dA[kodepaket]))
            		{
        ...
        <?
		$dA = mysql_fetch_array(mysql_query("SELECT * FROM x23_notaservice_vw WHERE nonota='$d2[nomor]'"));
		?>
