...
$dA = mysql_fetch_array(mysql_query("SELECT * FROM tbl_pesanan_vw WHERE nopesan='$_REQUEST[nopesan]'"));
...
?>
	...
	<?
		...
		$dS  = mysql_fetch_array(mysql_query("SELECT nama FROM tbl_user_vw WHERE id='$dA[idsales]'"));
	?>	
	<div class="col-xs-12">
