...
?>
	...
	<?
		...
		$dI  = mysql_fetch_array(mysql_query("SELECT nama FROM tbl_user_vw WHERE id='$dB[iduser]'"));
	?>	
	<div class="col-xs-12">
    ...
    <?
    $dSC  = mysql_fetch_array(mysql_query("SELECT nama FROM tbl_user_vw WHERE id='$dB[iduser]'"));
    ?>
	<div class="col-xs-6" style="font-size:12px">
		<table width="100%" style="">
    		<tr>
