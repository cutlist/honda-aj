...
$d2 = mysql_fetch_array(mysql_query("SELECT nama FROM tbl_pelanggan WHERE id='$d1[idasal]'"));
						...
						$dA1 = mysql_fetch_array(mysql_query("SELECT accu FROM stok_accu WHERE nonota='$d1[notransfer]'"));
						$dA2 = mysql_fetch_array(mysql_query("SELECT alaskaki FROM stok_alaskaki WHERE nonota='$d1[notransfer]'"));
						$dA3 = mysql_fetch_array(mysql_query("SELECT anakkunci FROM stok_anakkunci WHERE nonota='$d1[notransfer]'"));
						$dA4 = mysql_fetch_array(mysql_query("SELECT helm FROM stok_helm WHERE nonota='$d1[notransfer]'"));
						$dA5 = mysql_fetch_array(mysql_query("SELECT spion FROM stok_spion WHERE nonota='$d1[notransfer]'"));
						$dA6 = mysql_fetch_array(mysql_query("SELECT toolkit FROM stok_toolkit WHERE nonota='$d1[notransfer]'"));
						$dA7 = mysql_fetch_array(mysql_query("SELECT jaket FROM stok_jaket WHERE nonota='$d1[notransfer]'"));
						$dA8 = mysql_fetch_array(mysql_query("SELECT bukuservis FROM stok_bukuservis WHERE nonota='$d1[notransfer]'"));
