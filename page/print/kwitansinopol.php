...
$d4 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_bpkb WHERE nopesan='$d2[nomor]' OR notajual='$d2[nomor]'"));
$d5 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_user_vw WHERE id='$d2[user]'"));
...
mysql_query("UPDATE tbl_bpkb SET status='1' WHERE nopesan='$d2[nomor]'");
?>
