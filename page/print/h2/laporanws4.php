...
$tgl = date("Ymd");
$judul = "LAPORAN_WORKSHOP_MPM.xls";
header("Content-Disposition: attachment; filename=$judul");
 


?>
	<h4>LAPORAN PENJUALAN WORKSHOP MPM PERIODE TANGGAL NOTA JUAL <?echo date("d-m-Y",strtotime($_SESSION[periode_awal]))?> SAMPAI DENGAN <?echo date("d-m-Y",strtotime($_SESSION[periode_akhir]))?></h4>
    <table>
        <thead>
			<tr>
