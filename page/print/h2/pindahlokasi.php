...
header("Content-Disposition: attachment; filename=$judul");
		...
		$g1 = mysql_fetch_array(mysql_query("SELECT * FROM x23_gudang WHERE id='$d1[idgudang1]'"));
		$g2 = mysql_fetch_array(mysql_query("SELECT * FROM x23_gudang WHERE id='$d1[idgudang2]'"));
...
<?
		...
		$q1 = mysql_query("SELECT * FROM x23_pindah WHERE bulan='$_REQUEST[bulan]' AND tahun='$_REQUEST[tahun]'");
