...
?>
	...
	<h4>CARI NAMA PELANGGAN / NO. NOTA INDENT / NO. KWITANSI / STATUS CETAK : <?echo $_REQUEST[cari]?></h4>
    <table>
			                            <thead style="color:#666;font-size:13px">
			                                <tr>
			                                    ...
			                                    <th style="height:45px;background:#37A58A;color:#fff;">STATUS CETAK</th>
			                                </tr>
			                            </thead>
			                            <tbody>
			                            <?
			                            ...
			                            while($d1 = mysql_fetch_array($q1))
			                            	{
											$d3 = mysql_fetch_array(mysql_query("SELECT totalqty FROM x23_indent WHERE noindent='$d1[nomor]'"));

											if($d1[status]=="0"){
												$red = "color:#ff0227";
												}
											else{$red="";}
									    	if($d1[status]=="0"){$status = "BELUM CETAK";}
									    	else{$status = "SUDAH DICETAK";}
