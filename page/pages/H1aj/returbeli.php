			                	...
			                	<h4>ADMINISTRASI <small>RETUR BELI</small></h4>
			                        ...
			                        <table id="example4" class="table table-striped table-hover">
										...
										if(!empty($_REQUEST[cari]))
											...
											{
											$q1 = mysql_query("SELECT * FROM tbl_returbeli WHERE id%2=0 ORDER BY id DESC LIMIT 0,20");
											}
			                        ...
			                        <table id="example3" class="table table-bordered table-striped table-hover">
			                            <thead style="color:#666;font-size:13px">
			                                <tr>
			                                    ...
			                                    <th width="" style="padding:7px">QTY RETUR (UNIT)</th>
			                                </tr>
			                            </thead>
			                            <tbody>
			                            <?
...
<?
		...
		<script type='text/javascript'>
			window.open('printaj/returbeli.php?nodo=$_REQUEST[nodo]','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')
		</script>";
		*/
		if($q1)
			{
...
?>
			<script type="text/javascript">
				...
				function popup_print(){
					window.open('printaj/returbeli.php?nodo=<?echo $d1[nodo]?>','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')
					}
			</script>
			<aside class="right-side">
			    <section class="content">
