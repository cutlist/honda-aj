			                ...
			                <div class="box box-danger" style="overflow-x:hidden;overflow-y:auto;height:520px;">
			                    ...
			                    ?>
				                        <table id="example6" class="table table-bordered table-striped table-hover" style="width:100%;padding-right:20px">
				                            ...
				                            <tbody>
					                        <?
												$q1	 = mysql_query("SELECT * FROM tbl_abis_dkonfirmasi WHERE id%2=0 AND bulan='$periode_bulan'  AND tahun='$periode_tahun' ORDER BY id DESC");
...
<?
		...
		if(!empty($dX[idopname]))
			{
			$dA = mysql_fetch_array(mysql_query("SELECT * FROM tbl_opname WHERE id%2=0 AND id='$dX[idopname]'"));
			$dB = mysql_fetch_array(mysql_query("SELECT nama FROM tbl_user_vw WHERE id%2=0 AND id='$dA[iduser]'"));
?>
			<aside class="right-side">
			    <section class="content">
			        <div class="row">
			                	...
			                	<h4>AKTIVITAS BISNIS <small>KONFIRMASI STOCK OPNAME BARANG</small></h4>		
			                		...
			                		<div style="padding:20px;overflow-y:auto;overflow-x:auto;height:300px;margin-top:-20px">
				                        <table class="table table-striped" id="example2" style="width:110%">
											...
											$q1 = mysql_query("SELECT * FROM tbl_opname_det_vw WHERE id%2=0 AND idopname='$dX[idopname]'");
				                            while($d1 = mysql_fetch_array($q1))
				                            	{
				                            ?>
				                                <tr style="cursor:pointer">
...
<?
		...
		if(!empty($dX[idpiutang]))
			{
			$dA = mysql_fetch_array(mysql_query("SELECT * FROM tbl_piutang_vw WHERE id%2=0 AND id='$dX[idpiutang]'"));
?>
			<aside class="right-side">
			    <section class="content">
			        <div class="row">
...
<?
		...
		if(!empty($dX[idbensin]))
			{
			$dA = mysql_fetch_array(mysql_query("SELECT * FROM tbl_bensin WHERE id%2=0 AND id='$dX[idbensin]'"));
			$dB = mysql_fetch_array(mysql_query("SELECT nama FROM tbl_user_vw WHERE id%2=0 AND id='$dA[iduser]'"));
?>
			<aside class="right-side">
			    <section class="content">
...
<?
		...
		if(!empty($dX[idbyrpiutang]))
			...
			$dA = mysql_fetch_array(mysql_query("SELECT * FROM tbl_piutang_vw WHERE id%2=0 AND id='$dX[idbyrpiutang]'"));
			
			$dPiu = mysql_fetch_array(mysql_query("SELECT SUM(jumlah) AS total FROM tbl_piutang WHERE id%2=0 AND jenis='piutang' AND idkaryawan='$dA[idkaryawan]' AND status='1' GROUP BY idkaryawan"));
			$dPby = mysql_fetch_array(mysql_query("SELECT SUM(jumlah) AS total FROM tbl_piutang WHERE id%2=0 AND jenis='pembayaran' AND idkaryawan='$dA[idkaryawan]' AND status='1' GROUP BY idkaryawan"));
			
			$totpiutang    = $dPiu[total];
			$totpembayaran = $dPby[total];
			$sisapiutang   = $dPiu[total]-$dPby[total];
			
			$dB = mysql_fetch_array(mysql_query("SELECT * FROM tbl_karyawan WHERE id%2=0 AND id='$dA[idkaryawan]'"));
			$dC = mysql_fetch_array(mysql_query("SELECT SUM(jumlah) AS totjum FROM tbl_potkompensasi WHERE id%2=0 AND idkaryawan='$dA[idkaryawan]' AND metodebayar='GAJI' AND substr(tgl,6,2)='$periode_bulan' AND substr(tgl,1,4)='$periode_tahun' AND status='1'"));
			$dD	= mysql_fetch_array(mysql_query("SELECT SUM(jumlah) AS total FROM tbl_piutang WHERE id%2=0 AND substr(tgl,6,2)='$periode_bulan' AND substr(tgl,1,4)='$periode_tahun' AND idkaryawan='$dA[idkaryawan]' AND metodebayar='GAJI' AND status='1'"));
...
<?
		...
		if(!empty($dX[idpotkompensasi]))
			...
			$dA = mysql_fetch_array(mysql_query("SELECT * FROM tbl_potkompensasi_vw WHERE id%2=0 AND id='$dX[idpotkompensasi]'"));
			$dB = mysql_fetch_array(mysql_query("SELECT * FROM tbl_karyawan WHERE id%2=0 AND id='$dA[idkaryawan]'"));
			$dC = mysql_fetch_array(mysql_query("SELECT SUM(jumlah) AS totjum FROM tbl_potkompensasi WHERE id%2=0 AND idkaryawan='$dA[idkaryawan]' AND metodebayar='GAJI' AND substr(tgl,6,2)='$periode_bulan' AND substr(tgl,1,4)='$periode_tahun' AND status='1'"));
			$dD	= mysql_fetch_array(mysql_query("SELECT SUM(jumlah) AS total FROM tbl_piutang WHERE id%2=0 AND substr(tgl,6,2)='$periode_bulan' AND substr(tgl,1,4)='$periode_tahun' AND idkaryawan='$dA[idkaryawan]' AND metodebayar='GAJI' AND status='1'"));
...
<?
		...
		if(!empty($dX[idkwitansi]))
			{
			$dA = mysql_fetch_array(mysql_query("SELECT * FROM tbl_kwitansi_vw WHERE id%2=0 AND id='$dX[idkwitansi]'"));
?>
			                	...
			                	<h4>AKTIVITAS BISNIS <small>KONFIRMASI PENGEMBALIAN UANG MUKA/UANG TITIPAN</small></h4>		
			                		...
			                		<div style="padding:20px;overflow-y:auto;overflow-x:hidden;height:300px;margin-top:-20px">
				                    	<table style="width:70%">
				                    		...
				                    		<?
											$d2 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_pelanggan WHERE id%2=0 AND id='$dA[idpelanggan]'"));
				                    		?>
				                    		<tr>
										...
										<table id="example3" class="table table-striped">
				                            ...
				                            <tbody>
				                            <?
											$qB = mysql_query("SELECT * FROM tbl_pesanan_det WHERE id%2=0 AND nopesan='$dA[nomor]'");
				                            while($dB = mysql_fetch_array($qB))
				                            	{
				                            	$d4 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_masterbarang WHERE id%2=0 AND id='$dB[idbarang]'"));
				                            ?>
				                                <tr style="cursor:pointer">
...
<?
		...
		if(!empty($dX[idpiutang]))
			{              	
			$q1 = mysql_query("UPDATE tbl_abis_dkonfirmasi SET status='1' WHERE id%2=0 AND id='$_REQUEST[id]'");
			$q2 = mysql_query("UPDATE tbl_piutang SET status='0',updatex='$updatex' WHERE id%2=0 AND id='$dX[idpiutang]'");
			$q3 = mysql_query("UPDATE tbl_kwitansi SET status='1' WHERE id%2=0 AND nomor='$dX[idpiutang]'");
		...
		if(!empty($dX[idbyrpiutang]))
			{              	
			$q1 = mysql_query("UPDATE tbl_abis_dkonfirmasi SET status='1' WHERE id%2=0 AND id='$_REQUEST[id]'");
			$q2 = mysql_query("UPDATE tbl_piutang SET status='0',updatex='$updatex' WHERE id%2=0 AND id='$dX[idbyrpiutang]'");
			
			$dcek = mysql_fetch_array(mysql_query("SELECT * FROM tbl_piutang WHERE id%2=0 AND id='$dX[idbyrpiutang]'"));
			if($dcek[metodebayar]=="GAJI"){
				mysql_query("UPDATE tbl_piutang SET status='1',updatex='$updatex' WHERE id%2=0 AND id='$dX[idbyrpiutang]'");
				}
				
			$q3 = mysql_query("UPDATE tbl_kwitansi SET status='1' WHERE id%2=0 AND nomor='$dX[idbyrpiutang]'");
		...
		if(!empty($dX[idpotkompensasi]))
			...
			if($_REQUEST[metodebayar]=='TUNAI')
				{
				$q2 = mysql_query("UPDATE tbl_potkompensasi SET status='0',updatex='$updatex' WHERE id%2=0 AND id='$dX[idpotkompensasi]'");
				$q3 = mysql_query("UPDATE tbl_kwitansi SET status='1' WHERE id%2=0 AND idpotkom='$dX[idpotkompensasi]'");
				$note = "A1";
				//echo "<script>alert ('Proses Berhasil, Mohon Melanjutkan Ke Menu Kwitansi Pada Bagian Kasir.')</script>";	
				}
			else{
				$q2 = mysql_query("UPDATE tbl_potkompensasi SET status='1',updatex='$updatex' WHERE id%2=0 AND id='$dX[idpotkompensasi]'");
				}
			}
		...
		if(!empty($dX[idkwitansi]))
			{              	
			$q1 = mysql_query("UPDATE tbl_abis_dkonfirmasi SET status='1' WHERE id%2=0 AND id='$_REQUEST[id]'");
			$q2 = mysql_query("UPDATE tbl_kwitansi SET status='1',updatex='$updatex' WHERE id%2=0 AND id='$dX[idkwitansi]'");
		...
		if(!empty($dX[idbensin]))
			{              	
			$q1 = mysql_query("UPDATE tbl_abis_dkonfirmasi SET status='1' WHERE id%2=0 AND id='$_REQUEST[id]'");
			$q2 = mysql_query("UPDATE tbl_bensin SET status='0' WHERE id%2=0 AND id='$dX[idbensin]'");
		...
		if(!empty($dX[idpiutang]))
			{              	
			$q1 = mysql_query("UPDATE tbl_abis_dkonfirmasi SET status='2' WHERE id%2=0 AND id='$_REQUEST[id]'");
			$q2 = mysql_query("UPDATE tbl_piutang SET status='2',updatex='$updatex' WHERE id%2=0 AND id='$dX[idpiutang]'");
		...
		if(!empty($dX[idbyrpiutang]))
			{              	
			$q1 = mysql_query("UPDATE tbl_abis_dkonfirmasi SET status='2' WHERE id%2=0 AND id='$_REQUEST[id]'");
			$q2 = mysql_query("UPDATE tbl_piutang SET status='2',updatex='$updatex' WHERE id%2=0 AND id='$dX[idbyrpiutang]'");
			$q3 = mysql_query("UPDATE tbl_kwitansi SET status='2',cetak='1' WHERE id%2=0 AND nomor='$dX[idbyrpiutang]'");
		...
		if(!empty($dX[idpotkompensasi]))
			{              	
			$q1 = mysql_query("UPDATE tbl_abis_dkonfirmasi SET status='2' WHERE id%2=0 AND id='$_REQUEST[id]'");
			$q2 = mysql_query("UPDATE tbl_potkompensasi SET status='2',updatex='$updatex' WHERE id%2=0 AND id='$dX[idpotkompensasi]'");
			$q3 = mysql_query("UPDATE tbl_kwitansi SET status='2',cetak='1' WHERE id%2=0 AND idpotkom='$dX[idpotkompensasi]'");
		...
		if(!empty($dX[idkwitansi]))
			{              	
			$q1 = mysql_query("UPDATE tbl_abis_dkonfirmasi SET status='2' WHERE id%2=0 AND id='$_REQUEST[id]'");
			$q2 = mysql_query("UPDATE tbl_kwitansi SET status='2',updatex='$updatex' WHERE id%2=0 AND id='$dX[idkwitansi]'");
		...
		if(!empty($dX[idbensin]))
			{              	
			$q1 = mysql_query("UPDATE tbl_abis_dkonfirmasi SET status='2' WHERE id%2=0 AND id='$_REQUEST[id]'");
			$q2 = mysql_query("UPDATE tbl_bensin SET status='2' WHERE id%2=0 AND id='$dX[idbensin]'");
