	...
	if($submenu == 'A')
		...
		if(!empty($_REQUEST[resetpass]))
			...
			if($pass1 != $pass2)
				...
				{
				$q1 = mysql_query("UPDATE tbl_user SET pass='$pass' WHERE id%2=0 AND id='$_SESSION[id]'");
				$q2 = mysql_query("INSERT INTO log_act VALUES (										
		                                    '',
		                                    'tbl_user',
		                                    CURDATE(),
...
?>
			<aside class="right-side">
			    <section class="content">
			        <div class="row">
<?
						$dA = mysql_fetch_array(mysql_query("SELECT * FROM tbl_karyawan_vw WHERE id%2=0 AND nama='$_SESSION[nama]'"));
						$d1 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_karyawan_vw WHERE id%2=0 AND id='$dA[id]'"));
?>
			            <div class="col-xs-12">
