...
?>
			<script type="text/javascript">
				...
				function popup_print(){
					window.open('printaj/abs_individuh1.php?EmployeeID=<?echo $_REQUEST[EmployeeID]?>','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')
					}
			</script>
				                    			...
				                    			<td><select name="EmployeeID" style="padding:3px;" class="form-control" id="select1" required="">
				                    							<option value=''>PILIH KARYAWAN</option>
																		...
																		if($_SESSION[posisi]=='DIREKSI'){
																			$q1 = mysql_query("SELECT * FROM abs_employee GROUP BY EmployeeID  ORDER BY FirstName");
																			}
																		else{
																			$q1 = mysql_query("SELECT * FROM abs_employee WHERE EmployeeID IN (SELECT nik FROM tbl_karyawan WHERE posisi!='6') GROUP BY EmployeeID  ORDER BY FirstName");
																			}
	                            ...
	                            ?>
			                        <table id="example2" class="table table-bordered table-striped table-hover" style="width:100%;padding-right:20px">
										...
										?>
													<tr style='cursor:pointer'> 
														<td align='center'><?echo tgl_indo1($awal)?></td> 
														<td align='left'><?echo $hari?></td> 
														<td align='center'><?echo $jammasuk?></td> 
														<td align='center'><?echo $terlambat?></td> 
														<td align='center'><?echo $jamkeluar?></td> 
														<td align='center'><?echo $overtime?></td> 
	                            	...
	                            	<div class="col-xs-6">
				                    	<table width="100%">
				                    		...
				                    		<!--
				                    		<tr>
				                    			<td width="40%">JUMLAH OVER BREAK</td>
				                    			<td width="2%">:</td>
				                    			<td colspan="1">
				                                    <div class="input-group">
				                                      	 <input type="text" value="<?echo number_format($overbreak[total])?>" style="text-align:right" class="form-control" maxlength="40" readonly="">
				                                        <span class="input-group-addon" style="min-width:60px">Hari</span>
				                                    </div></td>
				                                <td width="35%"></td>
				                    		</tr>
				                    		<tr>
				                    			<td width="40%">DURASI OVER BREAK</td>
				                    			<td width="2%">:</td>
				                    			<td colspan="1">
				                                    <div class="input-group">
				                                      	 <input type="text" value="<?echo number_format($doverbreak[total])?>" style="text-align:right" class="form-control" maxlength="40" readonly="">
				                                        <span class="input-group-addon" style="min-width:60px">Menit</span>
				                                    </div></td>
				                                <td width="35%"></td>
				                    		</tr>
				                    		...
				                    		<tr>
				                    			...
				                    			<td colspan="1">
				                                    <div class="input-group">
				                                      	 <input type="text" value="<?echo $dTemp[norangka]?>" class="form-control" maxlength="40" readonly="">
