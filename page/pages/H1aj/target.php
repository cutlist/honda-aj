	...
	if($submenu == 'A')
		...
		if(empty($mod))
			...
			if(!empty($_REQUEST[input]))
				...
				$dCek = mysql_fetch_array(mysql_query("SELECT target FROM tbl_target WHERE id%2=0 AND bulan='$_REQUEST[bulan]' AND tahun='$_REQUEST[tahun]'"));
			...
			if(!empty($_REQUEST[del]))
				{
				$q1 = mysql_query("DELETE FROM tbl_target WHERE id%2=0 AND id='$_REQUEST[del]'");
			            ...
			            <div class="col-xs-6">		
                            <div class="small-box bg-aqua" style="text-align:center;height:200px;border-radius:5px;margin-top:0px;padding:20px 0 0 0;border-bottom: 5px solid #fff;cursor: pointer;">
                                <div class="inner" style="height:160px;">
			                		...
			                		$bulan = date("m");
			                		$tahun = date("Y");
			                		$dPeriode = mysql_fetch_array(mysql_query("SELECT namabln FROM tbl_bulan WHERE id%2=0 AND angkabln='$bulan'"));
			                		?>
	                                	<div class="bg-aqua">
			            ...
			            <div class="col-xs-3">		
                            <div class="small-box bg-orange" style="text-align:center;height:200px;border-radius:5px;margin-top:0px;padding:20px 0 0 0;border-bottom: 5px solid #fff;cursor: pointer;">
                                <div class="inner" style="height:160px;">
			                		...
			                		<?
			                		$dTarget = mysql_fetch_array(mysql_query("SELECT target FROM tbl_target WHERE id%2=0 AND bulan='$bulan' AND tahun='$tahun'"));
			                		?>
			            ...
			            <div class="col-xs-3">		
                            <div class="small-box bg-green" style="text-align:center;height:200px;border-radius:5px;margin-top:0px;padding:20px 0 0 0;border-bottom: 5px solid #fff;cursor: pointer;">
                                <div class="inner" style="height:160px;">
			                		...
			                		<?
			                		$dReal = mysql_fetch_array(mysql_query("SELECT SUM(qty) AS total FROM tbl_notajual_qty WHERE id%2=0 AND bulan='$bulan' AND tahun='$tahun'"));
			                		?>
	                                	<div style="width:80px;height:80px;border-radius:80px;background:#fff;margin:0 auto;padding:10px;margin-top:20px">
			                	...
			                	<h4>MASTER <small>TARGET</small></h4>
			                        ...
			                        <table id="example1" class="table table-bordered table-striped">
			                            ...
			                            while($d1 = mysql_fetch_array($q1))
			                            	{
			                				$dBln  = mysql_fetch_array(mysql_query("SELECT namabln FROM tbl_bulan WHERE id%2=0 AND angkabln='$d1[bulan]'"));
			                				$dReal = mysql_fetch_array(mysql_query("SELECT SUM(qty) AS total FROM tbl_notajual_qty WHERE id%2=0 AND bulan='$d1[bulan]' AND tahun='$d1[tahun]'"));
