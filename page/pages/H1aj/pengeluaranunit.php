			                ...
			                <div class="box box-danger" style="overflow-x:hidden;overflow-y:auto;height:520px;">
			                	...
			                	<h4>ADMINISTRASI <small>DAFTAR PENGELUARAN UNIT</small></h4>
									...
									<table id="example1" class="table table-striped table-hover">
			                            ...
			                            <?
										$no=1;
										$q1 = mysql_query("SELECT * FROM tbl_notajual WHERE id%2=0 AND status='1' AND cekfisik='1' AND adm='0'");
...
<?
		...
		<script type='text/javascript'>
			window.open('printaj/bast.php?nonota=$_REQUEST[nonota]','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')
		</script>";
...
?>
			...
			<script type="text/javascript">
				...
				function popup_print(){
					window.open('printaj/bast.php?nonota=<?echo $dB[nonota]?>','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')
					}
			</script>
			<aside class="right-side">
			    <section class="content">
