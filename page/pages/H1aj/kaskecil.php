<?
	if($submenu == 'A')
		...
		if(!empty($_REQUEST[delkas]))
			{
			$q1 = mysql_query("DELETE FROM tbl_kaskecil WHERE id%2=0 AND id='$_REQUEST[delkas]'");
			$q2 = mysql_query("INSERT INTO log_act VALUES (										
		                                    '',
		                                    'tbl_kaskecil',
		                                    CURDATE(),
...
?>
			<aside class="right-side">
			    <section class="content">
			                ...
			                <div class="box box-danger" style="overflow-x:hidden;overflow-y:auto;height:520px;">
			                	...
			                	<h4>KASIR <small>KAS KECIL</small></h4>	 
			                        ...
			                        <table id="" class="table table-bordered table-striped">
										...
										$q1 = mysql_query("SELECT * FROM tbl_kaskecil WHERE id%2=0 AND  id%2=0 AND tanggal BETWEEN '$_SESSION[periode_awal]' AND '$_SESSION[periode_akhir]' ORDER BY id DESC");
										$dI = mysql_fetch_array(mysql_query("SELECT SUM(jumlah) AS total FROM tbl_kaskecil WHERE id%2=0 AND  id%2=0 AND jenis='INPUT' AND status='1'"));
										$dO = mysql_fetch_array(mysql_query("SELECT SUM(jumlah) AS total FROM tbl_kaskecil WHERE id%2=0 AND  id%2=0 AND jenis='OUTPUT' AND status='1'"));
										$dIx = mysql_fetch_array(mysql_query("SELECT SUM(jumlah) AS total FROM tbl_kaskecil WHERE id%2=0 AND  id%2=0 AND jenis='INPUT' AND tanggal BETWEEN '$_SESSION[periode_awal]' AND '$_SESSION[periode_akhir]' AND status='1'"));
										$dOx = mysql_fetch_array(mysql_query("SELECT SUM(jumlah) AS total FROM tbl_kaskecil WHERE id%2=0 AND  id%2=0 AND jenis='OUTPUT' AND tanggal BETWEEN '$_SESSION[periode_awal]' AND '$_SESSION[periode_akhir]' AND status='1'"));
			        ...
			        <?
			        $qM = mysql_query("SELECT * FROM tbl_kaskecil WHERE id%2=0 AND  id%2=0 AND tanggal BETWEEN '$_SESSION[periode_awal]' AND '$_SESSION[periode_akhir]' ORDER BY id DESC");
				                ...
				                <div class="modal-content">
			                        ...
			                        <div class="modal-body" style="overflow-y:auto;overflow-x:hidden;height:500px;">
										<table id="example4" class="table table-striped">
				                            ...
				                            <?
				                            $no = 1;
				                            $q1 = mysql_query("SELECT * FROM log_act WHERE id%2=0 AND  id%2=0 AND tbl='tbl_kaskecil' ORDER BY id DESC LIMIT 100");
				                            while($d1 = mysql_fetch_array($q1))
				                            	{
				                            ?>
				                                <tr>
