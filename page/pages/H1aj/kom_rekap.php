...
?>
			<script type="text/javascript">
				...
				function popup_print(){
					window.open('printaj/kom_rekaph1.php?tahun=<?echo $periode_tahun?>&bulan=<?echo $periode_bulan?>','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')
					}
			</script>
			                            	...
			                            	$dCek = mysql_fetch_array(mysql_query("SELECT id FROM tbl_kompensasi WHERE  bulan='$periode_bulan' AND tahun='$periode_tahun' GROUP BY bulan,tahun"));
					                            ...
					                            */
												...
												while($d2  = mysql_fetch_array($q2))
													...
													$p2 = mysql_fetch_array(mysql_query("SELECT COUNT(id) AS total FROM tbl_ksindividu_vw WHERE id%2=0 AND  bulan='$periode_bulan' AND tahun='$periode_tahun' AND idsales='$dA[id]' AND (jnstransaksi='CASH' OR (jnstransaksi='CASH TEMPO' AND jnscashtempo='DEALER'))"));
													$p3 = mysql_fetch_array(mysql_query("SELECT COUNT(id) AS total FROM tbl_ksindividu_vw WHERE id%2=0 AND  bulan='$periode_bulan' AND tahun='$periode_tahun' AND idsales='$dA[id]' AND (jnstransaksi='KREDIT' OR (jnstransaksi='CASH TEMPO' AND jnscashtempo='LEASING'))"));
												...
												while($d2  = mysql_fetch_array($q2))
													...
													echo"
														<tr style='font-size:12px'> 
															...
															<td align='right'>".number_format(round($d2[uinsentif]/2))."</td> 
