...
?>
			<script type="text/javascript">
				...
				function popup_print(){
					window.open('printaj/abs_rekaph1.php','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')
					}
			</script>
			                        ...
			                        <table id="example2" class="table table-bordered table-striped table-hover" style="width:100%;padding-right:20px">
										<thead>
											<tr>
												...
												<!--
												<th width="7%"><center>CUTI</center></th> 
												-->
										...
										if($_SESSION[posisi]=='DIREKSI'){
											...
											$q2	 = mysql_query("SELECT * FROM abs_employee WHERE EmployeeID IN (SELECT nik FROM tbl_karyawan WHERE posisi!='6')");
											}
										while($d2  = mysql_fetch_array($q2))
											...
											while (strtotime($awal) <= strtotime($akhir)) 
												...
												//<td align='center'>".number_format($cuti[total])." Hari</td> 
												echo"
													<tr> 
