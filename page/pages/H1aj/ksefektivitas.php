		            ...
		            ?>
                        <div class="nav-tabs-custom" style="border-radius:4px 4px 0 0">
                            ...
                            -->
                                ...
                                <li class="pull-left header"><h4>KINERJA SALES <small>EFEKTIVITAS</small></h4></li>
                            </ul>
									...
									<div class="col-xs-12" style="width:100%;margin:0 auto;margin-top:10px">
				                        <table id="example3" class="table table-striped table-bordered">
				                            <thead style="cursor:pointer">
												...
												<th class="btn-info" style="width:20%;text-align:center">JUMLAH PROSEPEK</br>(ORANG)</th>
												<th class="btn-info" style="width:20%;text-align:center">JUMLAH TINDAK LANJUT</br>(TINDAKAN)</th>
												<th class="btn-info" style="width:20%;text-align:center">JUMLAH PENJUALAN</br>(TRANSAKSI)</th>
											</thead>
											...
											while($dA = mysql_fetch_array($qA))
												...
												$h2 = mysql_fetch_array(mysql_query("SELECT COUNT(id) AS total FROM tbl_pesanan_vw WHERE bulan='$periode_bulan' AND tahun='$periode_tahun' AND idsales='$dA[id]' AND id%2=0 AND idpelanggan IN (SELECT idpelanggan FROM tbl_prospek WHERE bulan='$periode_bulan' AND tahun='$periode_tahun' AND idsales='$dA[id]')"));
												if(!empty($h2[total])){
												...
												$h3 = mysql_fetch_array(mysql_query("SELECT COUNT(id) AS total FROM tbl_notajual_det_vw WHERE bulan='$periode_bulan' AND tahun='$periode_tahun' AND idsales='$dA[id]' AND id%2=0 AND tglsampai!='0000-00-00' AND idpelanggan IN (SELECT idpelanggan FROM tbl_prospek WHERE bulan='$periode_bulan' AND tahun='$periode_tahun' AND idsales='$dA[id]')"));
												if(!empty($h3[total])){
