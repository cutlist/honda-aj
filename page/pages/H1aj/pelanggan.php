			                        ...
			                        <table id="example1" class="table table-bordered table-striped table-hover" style="width: 130%">
			                            <thead style="color:#666;font-size:13px">
			                                <tr>
			                                    ...
			                                    <th width="" style="padding:7px">TANGGAL TRANSAKSI</br>TERAKHIR</th>
			                                    <th width="" style="padding:7px">TAHUN</br>KENDARAAN</th>
										...
										if(!empty($_REQUEST[periode]))
											...
											$q2 = mysql_query("SELECT * FROM tbl_pelanganpotensial WHERE tglnota BETWEEN '$_SESSION[periode_awal]' AND '$_SESSION[periode_akhir]' GROUP BY idpelanggan");
											}
										else
											{
											$q1 = mysql_query("SELECT * FROM tbl_pelanganpotensial GROUP BY idpelanggan ORDER BY id DESC LIMIT 0,100");
											$q2 = mysql_query("SELECT * FROM tbl_pelanganpotensial GROUP BY idpelanggan ORDER BY id DESC LIMIT 0,100");
											}
			                            while($d1 = mysql_fetch_array($q1))
			                            	{
			                            	/*	
			    ...
			    <section class="content">
			        <div class="row">
			            <div class="col-xs-12">
			                <div class="box box-danger">
			                    <div class="box-body table-responsive" style="overflow-y:auto;overflow-x:auto;height:520px;">
			                	<h4>PELANGGAN <small>DAFTAR PROSPEK <?//echo $periode_bulan?></small></h4>
			                        ...
			                        <table id="example1" class="table table-bordered table-striped table-hover" style="width: 130%">
			                            <thead style="color:#666;font-size:13px">
			                                <tr>
			                                    ...
			                                    <th width="" style="padding:7px">NO. TELEPON</th>
			                                    <th width="" style="padding:7px">ALAMAT</th>
			                                    <th width="" style="padding:7px">NAMA COUNTER SALES/SALES</th>
