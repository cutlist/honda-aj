			                    ...
			                    ?>
			                        <table id="example2" class="table table-bordered table-striped table-hover" style="width:550%;padding-right:20px">
			                            ...
			                            while($d1 = mysql_fetch_array($q1))
											...
											$d2 = mysql_fetch_array(mysql_query("SELECT * FROM x23_notaservice_det1_vw WHERE id%2=0 AND nonota='$d1[nonota]'"));
											...
											$d5 = mysql_fetch_array(mysql_query("SELECT * FROM x23_kwitansi_vw WHERE id%2=0 AND nomor='$d1[nonota]'"));
											if($d5[status]=="1"){
											...
											$d6 = mysql_fetch_array(mysql_query("SELECT nama FROM x23_user_vw WHERE id%2=0 AND id='$d1[iduser]'"));
			                            ?>
			                                <tr style="cursor:pointer">
					                            ...
					                            while($dA = mysql_fetch_array($qA))
					                            	{
													$dB = mysql_fetch_array(mysql_query("SELECT SUM(totalstok) AS stok FROM x23_stokpart_group_vw WHERE id%2=0 AND idbarang='$dA[idbarang]' GROUP BY idbarang"));
						                        ?>
