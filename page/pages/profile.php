...
<!-- ################## MODAL LOG KARYAWAN ########################################################################################## -->
				        <div class="modal fade " id="compose-modal-log-karyawan" tabindex="-1" role="dialog" aria-hidden="true">
				                ...
				                <div class="modal-content">
			                        ...
			                        <div class="modal-body"style="overflow-y:auto;overflow-x:hidden;height:420px;">
										<table id="example4" class="table table-striped" >
				                            ...
				                            <?
				                            $no = 1;
				                            $q1 = mysql_query("SELECT * FROM log_act WHERE tbl='x23_karyawan' ORDER BY id DESC LIMIT 0,20");
				                            while($d1 = mysql_fetch_array($q1))
				                            	{
				                            ?>
				                                <tr>
				                	...
				                	<div style="padding:20px">
				                    	<table style="width:50%;">
				                    		...
				                    		<tr>
				                    			<td>PANGKAT</td>
				                    			<td>:</td>
				                    			<td colspan="2"><select class="form-control" name="pangkat" required style="width: 50%">
																	<option value=''>Pilih</option>
																<?
																	$q1 = mysql_query("SELECT * FROM x23_pangkat ORDER BY pangkat");
																	while($dA=mysql_fetch_array($q1))
				                	...
				                	<div style="padding:20px">
				                    	<table style="width:50%;">
				                    		...
				                    		<tr>
				                    			<td>NIK</td>
				                    			<td>:</td>
				                    			<td colspan="2"><input type="text" name="nik" value="<?echo $d1[nik]?>" class="form-control" style="width: 50%" maxlength="12" required></td>
				                    		</tr>
				                    		<tr>
				                    			<td>POSISI</td>
				                    			<td>:</td>
