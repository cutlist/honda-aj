	...
	if($submenu == 'A')
		...
		if(empty($mod))
			...
			if(!empty($_REQUEST[input]))
				...
				$d1 = mysql_fetch_array(mysql_query("SELECT user FROM tbl_user WHERE user='$user' OR id_karyawan='$id_karyawan'"));
			...
			if(!empty($_REQUEST[resetpass]))
				...
				if($pass1 != $pass2)
					...
					{
					$q1 = mysql_query("UPDATE tbl_user SET pass='$pass',pic_user='$_SESSION[user]' WHERE id='$_REQUEST[resetpass]'");
					$q2 = mysql_query("INSERT INTO log_act VALUES (										
			                                    '',
			                                    'tbl_user',
			                                    CURDATE(),
			...
			if(!empty($_REQUEST[ubahdetail]))
				{
				$q1 = mysql_query("UPDATE tbl_user SET hakakses='$_REQUEST[hakakses]',pic_user='$_SESSION[user]' WHERE id='$_REQUEST[ubahdetail]'");
				$q2 = mysql_query("INSERT INTO log_act VALUES (										
		                                    '',
		                                    'tbl_user',
		                                    CURDATE(),
			                        ...
			                        <table id="example1" class="table table-bordered table-striped">
			                            <thead style="color:#666;font-size:13px">
			                                <tr>
			                                    ...
			                                    <th width="13%" style="padding:7px">HAK AKSES</th>
			                            ...
			                            <?
										$no=1;
										$q1 = mysql_query("SELECT * FROM tbl_user_vw ORDER BY nama");
			                            ...
			                            ?>
			                                <tr style="cursor:pointer">
			                                    ...
			                                    <td align="center"><?echo $d1[hakakses]?></td>
			                        ...
			                        <div class="modal-body">
				                    	<table width="100%">
				                    		<tr>
				                    			...
				                    			<td width="2%">:</td>
				                    			<td colspan="2"><select class="form-control" name="id_karyawan" style="width:70%" required>
																	<option value=''>Pilih</option>
																<?
																	$q1 = mysql_query("SELECT * FROM tbl_karyawan WHERE id NOT IN (SELECT id_karyawan FROM tbl_user) ORDER BY nama");
																	while($dA=mysql_fetch_array($q1))
																		{
																?>
...
<?
						...
						{
						$d1 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_user_vw WHERE id='$_REQUEST[id]'"));
?>
			            <div class="col-xs-12">
			                <div class="box box-danger">
			                    <div class="box-body table-responsive" style="overflow-y:auto;overflow-x:hidden;height:520px;">
