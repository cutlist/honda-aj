			                	...
			                	<h4>ADMINISTRASI <small>NOTA RETUR BELI</small></h4>
			                        ...
			                        <table id="example1" class="table table-striped" style="width:125%">
										...
										if(!empty($_REQUEST[cari]))
											{
											$q1 = mysql_query("SELECT * FROM x23_notaretur_vw WHERE (nonota LIKE '%$_REQUEST[cari]%' OR noretur LIKE '%$_REQUEST[cari]%' OR nama LIKE '%$_REQUEST[cari]%')");
											}
										else
											{
											$q1 = mysql_query("SELECT * FROM x23_notaretur_vw ORDER BY id DESC LIMIT 0,20");
											}
