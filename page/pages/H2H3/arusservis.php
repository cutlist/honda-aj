			                ...
			                <div class="box box-danger" style="overflow-x:hidden;overflow-y:auto;height:520px;">
			                	...
			                	<h4>SERVIS <small>ARUS SERVIS</small></h4>	 
			                        ...
			                        <table id="example4" class="table table-bordered table-striped table-hover">
										...
										$dA = mysql_fetch_array(mysql_query("SELECT COUNT(id) AS total FROM x23_scanmasuk WHERE tanggal BETWEEN '$periode_awal' AND '$periode_akhir'"));
										if(empty($dA[total])){
											$a = "-";
											}
										else{
										...
										$dB = mysql_fetch_array(mysql_query("SELECT COUNT(id) AS total FROM x23_notaservice WHERE tglnota BETWEEN '$periode_awal' AND '$periode_akhir'"));
										if(empty($dB[total])){
											$b = "-";
											}
										else{
										...
										$dC = mysql_fetch_array(mysql_query("SELECT COUNT(id) AS total FROM x23_notaservice WHERE tglnota BETWEEN '$periode_awal' AND '$periode_akhir' AND status!='0'"));
										if(empty($dC[total])){
											$c = "-";
											}
										else{
										...
										$dD = mysql_fetch_array(mysql_query("SELECT COUNT(id) AS total FROM x23_scankeluar WHERE tanggal BETWEEN '$periode_awal' AND '$periode_akhir'"));
										if(empty($dD[total])){
											$d = "-";
											}
										else{
										...
										$dF = mysql_fetch_array(mysql_query("SELECT COUNT(id) AS total FROM x23_notaservice WHERE tglnota BETWEEN '$periode_awal' AND '$periode_akhir' AND status='2'"));
										if(empty($dF[total])){
											$f = "-";
											}
										else{
