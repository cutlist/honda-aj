			                        	...
			                        	<table id="example2" class="table table-bordered table-striped table-hover" style="width:100%">
				                            ...
				                            ?>
				                                <tr style="cursor:pointer">
			                                		...
			                                		<td align="center"><i class="fa fa-print" onclick="window.open('print/kwitansikpb.php?nokwitansi=<?echo $d1[nokwitansi]?>','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')"></i></td>
				                                </tr>
				                            <?
				                            	}
				                            ?>
...
<?
	...
	if($submenu == 'B')
		...
		<script type='text/javascript'>
			window.open('print/kwitansikpb.php?nokwitansi=$nokwitansi','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')
		</script>";
