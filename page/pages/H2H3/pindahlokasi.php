			                ...
			                <div class="box box-danger">
			                	...
			                	<h4>GUDANG & PDI <small>PINDAH LOKASI</small></h4>
                                    <div style="float:left;width:30%;margin-left:15px">
	                           		...
	                           		<div style="float:right" class="col-xs-8">
										...
										if($_SESSION[posisi]=='DIREKSI' || $_SESSION[posisi]=='KEPALA BENGKEL')
														{
													?>
				                           				<button type="button"  onclick="window.open('print/h2/pindahlokasi.php?bulan=<?echo $periode_bulan?>&tahun=<?echo $periode_tahun?>','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')" class="btn btn-danger pull-right"><i class="fa fa-print"></i> Export Ke Excel</button>
				                           			<?
				                           				}
				                           			?>
	                           		</div>
			                        <table id="example3" class="table table-striped table-hover">
			                            ...
			                            <?
										$no=1;
										$q1 = mysql_query("SELECT * FROM x23_pindah WHERE bulan='$periode_bulan' AND tahun='$periode_tahun'");
				                		...
				                		<table width="100%">
					           			...
					           			<div class="col-xs-12">
					                        <div class="modal-footer clearfix">
					                        	<button type="button"  onclick="window.open('print/h2/pindahlokasidet.php?id=<?echo $_REQUEST[id]?>','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')" class="btn btn-info pull-left"><i class="fa fa-print"></i> Export Ke Excel</button>
