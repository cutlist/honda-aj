			                ...
			                <div class="box box-danger" style="overflow-x:auto;overflow-y:auto;height:520px;">
			                    ...
			                    ?>
			                        <table id="example2" class="table table-bordered table-striped table-hover" style="width:140%;padding-right:20px">
										...
										$no = 1;
										$q1 = mysql_query("SELECT *,COUNT(id) AS jumlah FROM x23_notaservice WHERE tglnota BETWEEN '$_SESSION[periode_awal]' AND '$_SESSION[periode_akhir]' AND statuskwitansi='1' GROUP BY kodemotor");
			                        ...
			                        <table id="example3" class="table table-bordered table-striped table-hover" style="width:30%;padding-right:20px">
										<thead>
											<tr>
												<th width="60%">TAHUN KENDARAAN</th>
												<th width="40%">JUMLAH UNIT</th>
											</tr>
										</thead>
			                            <tbody>
			                            <?		
										$q1 = mysql_query("SELECT tahunmotor,COUNT(id) AS jumlah FROM x23_notaservice WHERE tglnota BETWEEN '$_SESSION[periode_awal]' AND '$_SESSION[periode_akhir]' AND statuskwitansi='1' AND jns IN ('SERVIS BARU','KPB') OR 
										                  tglnota BETWEEN '$_SESSION[periode_awal]' AND '$_SESSION[periode_akhir]' AND statuskwitansi='1' AND jns IN ('SERVIS JR') AND grandtotal!='0' 
										                  GROUP BY tahunmotor");
			                            while($d1 = mysql_fetch_array($q1))
			                            	{
			                            ?>
			                                <tr style="cursor:pointer">
			                                    ...
			                                    <td align="right"><span style="padding-right:30%"><?echo $d1[jumlah]?></span></td>
			                                </tr>
