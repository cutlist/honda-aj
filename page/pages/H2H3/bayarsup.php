			                    ...
			                    <div class="box-body table-responsive" style="overflow-y:auto;overflow-x:auto;height:260px;">
			                        <table id="example2" class="table table-striped" style="width:120%">
			                            ...
			                            $q1 = mysql_query("SELECT * FROM x23_notabeli_det2_vw WHERE nonota='$d1[nonota]'");
										 while($dA = mysql_fetch_array($q1))
			                            	{
											$d3 = mysql_fetch_array(mysql_query("SELECT stok FROM x23_stokpart WHERE idbarang='$dA[idbarang]' AND idgudang='$dA[idgudang]' AND rak='$dA[rak]' AND nonota='$dA[nonota]'"));
			                            ?>
			                                <tr style="cursor:pointer">
						...
						if(!empty($_REQUEST[bayarnota]))
							...
							if($_REQUEST[gtbayar] >= $_REQUEST['totalretur'])
	                    		...
	                    		while($dA = mysql_fetch_array($qA))
		                    		{
									$dxz2 = mysql_fetch_array(mysql_query("SELECT * FROM x23_notaretur WHERE noretur='$dA[noretur]'"));
							...
							if($_REQUEST[gtbayar] < $_REQUEST['totalretur'])
								...
								*/
	                    		...
	                    		while($dC = mysql_fetch_array($qC))
									...
									$dxz1 = mysql_fetch_array(mysql_query("SELECT * FROM x23_notaretur WHERE noretur='$dC[noretur]'"));
		                    		mysql_query("INSERT INTO x23_notaretur_use (
			                    											noretur,
			                    											tanggal,
			                    											bulan,
			                        ...
			                        <table id="example3" class="table table-striped table-hover" style="width:130%">
										...
										if(empty($_REQUEST[periode]))
											...
											if(!empty($_REQUEST[cari]))
												{
												$q1 = mysql_query("SELECT * FROM x23_notabeli_vw WHERE bayar NOT IN ('0','') AND scan='1' AND dk='0' AND (nonota LIKE '%$_REQUEST[cari]%' OR nama LIKE '%$_REQUEST[cari]%') LIMIT 0,20");
												$q3 = mysql_query("SELECT * FROM x23_notabeli_vw WHERE bayar NOT IN ('0','') AND scan='1' AND dk='0' AND (nonota LIKE '%$_REQUEST[cari]%' OR nama LIKE '%$_REQUEST[cari]%') LIMIT 0,20");
												}
											else
												{
											...
											if(!empty($_REQUEST[cari]))
												{
												$q1 = mysql_query("SELECT * FROM x23_notabeli_vw WHERE bayar NOT IN ('0','') AND scan='1' AND dk='0' AND tglnota BETWEEN '$_SESSION[periode_awal]' AND '$_SESSION[periode_akhir]'  AND (nonota LIKE '%$_REQUEST[cari]%' OR nama LIKE '%$_REQUEST[cari]%') LIMIT 0,20");
												$q3 = mysql_query("SELECT * FROM x23_notabeli_vw WHERE bayar NOT IN ('0','') AND scan='1' AND dk='0' AND tglnota BETWEEN '$_SESSION[periode_awal]' AND '$_SESSION[periode_akhir]' AND (nonota LIKE '%$_REQUEST[cari]%' OR nama LIKE '%$_REQUEST[cari]%') LIMIT 0,20");
												}
											else
												{
												$q1 = mysql_query("SELECT * FROM x23_notabeli_vw WHERE bayar NOT IN ('0','') AND scan='1' AND dk='0' AND tglnota BETWEEN '$_SESSION[periode_awal]' AND '$_SESSION[periode_akhir]' ORDER BY id DESC LIMIT 0,20");
												$q3 = mysql_query("SELECT * FROM x23_notabeli_vw WHERE bayar NOT IN ('0','') AND scan='1' AND dk='0' AND tglnota BETWEEN '$_SESSION[periode_awal]' AND '$_SESSION[periode_akhir]' ORDER BY id DESC LIMIT 0,20");
												}
											}
			                            while($d1 = mysql_fetch_array($q1))
			                            	{
