			                ...
			                <div class="box box-danger" style="overflow-x:auto;overflow-y:auto;height:520px;">
			                    ...
			                    ?>
				                        <table id="example3" class="table table-bordered table-striped table-hover" style="width:100%;padding-right:20px">
				                            ...
				                            <tbody>
				                            <?
												$qDS = mysql_query("SELECT * FROM x23_stokpart_group_vw2 WHERE totalstok<'0' GROUP BY idbarang,nonota,idgudang,rak");
											...
											<?
												...
												$q1	 = mysql_query("SELECT * FROM x23_abis_ikesalahan WHERE bulan='$periode_bulan'  AND tahun='$periode_tahun' ORDER BY id DESC");
...
<?
		...
		{
		$dX = mysql_fetch_array(mysql_query("SELECT * FROM x23_abis_ikesalahan WHERE id='$_REQUEST[id]'"));
		...
		if(!empty($dX[idtutupservis1]))
			...
			if(!empty($_REQUEST[ubah]))
				...
				mysql_query("UPDATE x23_tutupservis SET asmasukbengkel='$asmasukbengkel', askeluarbengkel='$askeluarbengkel', asnginap='$asnginep' WHERE id='$dX[idtutupservis1]'");
				mysql_query("UPDATE x23_abis_ikesalahan SET status='1' WHERE id='$_REQUEST[id]'");
				
				print "<meta http-equiv='refresh' content='0;url=?opt=$opt&menu=$menu&submenu=$submenu&id=$_REQUEST[id]'/>";
				exit();
				}
				
			$d1 = mysql_fetch_array(mysql_query("SELECT * FROM x23_tutupservis WHERE id='$dX[idtutupservis1]'"));
			$d2 = mysql_fetch_array(mysql_query("SELECT nama FROM x23_user_vw WHERE id='$d1[iduser]'"));
			                	...
			                	<h4>AKTIVITAS BISNIS <small>INDIKASI KESALAHAN</small></h4>	
			                		<div style="padding:20px">
				                    	<table width="70%">
				                        	...
				                        	<tr>
				                        		<td>NAMA PENANGGUNG JAWAB TUTUP SERVIS</td>
				                        		<td>:</td>
...
<?
		...
		if(!empty($dX[idtutupservis2]))
			...
			if(!empty($_REQUEST[ubah]))
				...
				mysql_query("UPDATE x23_tutupservis SET asmasukbengkel='$asmasukbengkel' WHERE id='$dX[idtutupservis2]'");
				mysql_query("UPDATE x23_abis_ikesalahan SET status='1' WHERE id='$_REQUEST[id]'");
			...
			$d1 = mysql_fetch_array(mysql_query("SELECT * FROM x23_tutupservis WHERE id='$dX[idtutupservis2]'"));
			$d2 = mysql_fetch_array(mysql_query("SELECT nama FROM x23_user_vw WHERE id='$d1[iduser]'"));
?>
			<aside class="right-side">
			    <section class="content">
...
<?
		...
		if(!empty($dX[idtutupservis3]))
			...
			if(!empty($_REQUEST[ubah]))
				...
				mysql_query("UPDATE x23_tutupservis SET askeluarbengkel='$askeluarbengkel' WHERE id='$dX[idtutupservis3]'");
				mysql_query("UPDATE x23_abis_ikesalahan SET status='1' WHERE id='$_REQUEST[id]'");
			...
			$d1 = mysql_fetch_array(mysql_query("SELECT * FROM x23_tutupservis WHERE id='$dX[idtutupservis3]'"));
			$d2 = mysql_fetch_array(mysql_query("SELECT nama FROM x23_user_vw WHERE id='$d1[iduser]'"));
?>
			<aside class="right-side">
			    <section class="content">
...
<?
		...
		if(!empty($dX[idtutupservis4]))
			{
			mysql_query("UPDATE x23_abis_ikesalahan SET status='1' WHERE id='$_REQUEST[id]'");
			$d1 = mysql_fetch_array(mysql_query("SELECT * FROM x23_tutupservis WHERE id='$dX[idtutupservis4]'"));
			$d2 = mysql_fetch_array(mysql_query("SELECT nama FROM x23_user_vw WHERE id='$d1[iduser]'"));
?>
			<aside class="right-side">
			    <section class="content">
			            ...
			            <div class="col-xs-12">
			                <div class="box box-danger">
			                	...
			                	<h4>AKTIVITAS BISNIS <small>INDIKASI KESALAHAN</small></h4>	
									...
									<?
										$dB = mysql_fetch_array(mysql_query("SELECT COUNT(id) AS tot FROM x23_kwitansi_vw WHERE jnskwitansi='servis' AND status='0' AND tanggal='$d1[tanggal]'"));
										if(!empty($dB[tot]))
											{
											$qA = mysql_query("SELECT * FROM x23_kwitansi_vw WHERE jnskwitansi='servis' AND status='0' AND tanggal='$d1[tanggal]'");
									?>
											<div style="padding:20px;overflow-y:auto;overflow-x:hidden;height:150px;margin-top:-40px;">
												<div class="col-xs-12" style="border-bottom:1px #aaa dashed;">
...
<?
		...
		if(!empty($dX[idtutupservis5]))
			...
			if(!empty($_REQUEST[ubah]))
				...
				mysql_query("UPDATE x23_tutupservis SET asmasukbengkel='$asmasukbengkel' WHERE id='$dX[idtutupservis5]'");
				mysql_query("UPDATE x23_abis_ikesalahan SET status='1' WHERE id='$_REQUEST[id]'");
			...
			$d1 = mysql_fetch_array(mysql_query("SELECT * FROM x23_tutupservis WHERE id='$dX[idtutupservis5]'"));
			$d2 = mysql_fetch_array(mysql_query("SELECT nama FROM x23_user_vw WHERE id='$d1[iduser]'"));
?>
			<aside class="right-side">
			    <section class="content">
...
<?
		...
		if(!empty($dX[idnotajualdet]))
			...
			if(!empty($_REQUEST[ubah]))
				...
				mysql_query("UPDATE x23_abis_ikesalahan SET status='1' WHERE id='$_REQUEST[id]'");
				mysql_query("UPDATE x23_notajual_det SET jumlahbayarkpb='$jumlahbayarkpb',statusbayar='1' WHERE id='$dX[idnotajualdet]'");
				
				print "<meta http-equiv='refresh' content='0;url=?opt=$opt&menu=$menu&submenu=$submenu&id=$_REQUEST[id]'/>";
				exit();
				}
				
			$dA = mysql_fetch_array(mysql_query("SELECT * FROM x23_notajual_det WHERE id='$dX[idnotajualdet]'"));
			$d2 = mysql_fetch_array(mysql_query("SELECT nama FROM x23_user_vw WHERE id='$dA[idbayar]'"));
?>
			<aside class="right-side">
			    <section class="content">
			        <div class="row">
			                		...
			                		<div style="padding:20px;overflow-y:auto;overflow-x:auto;height:300px;margin-top:-20px">
					           			<div class="col-xs-12">
				                        	<table id="example3" class="table table-bordered table-striped" style="min-width:160%">
					                            ...
					                            <tbody>
					                            <?
												$q1 = mysql_query("SELECT * FROM x23_notajual_det_vw WHERE id='$dX[idnotajualdet]'");
												while($d1 = mysql_fetch_array($q1))
					                            	{
...
<?
		...
		if(!empty($dX[idpenagihankpb]))
			...
			if(!empty($_REQUEST[ubah]))
				...
				$jumlahbayarkpb = preg_replace( "/[^0-9]/", "",$_REQUEST[jumlahbayarkpb]);
				mysql_query("UPDATE x23_abis_ikesalahan SET status='1' WHERE id='$_REQUEST[id]'");
				//mysql_query("UPDATE x23_notaservice_det SET jumlahbayarkpb='$jumlahbayarkpb',statusbayar='1' WHERE id='$dX[idpenagihankpb]'");
				
				print "<meta http-equiv='refresh' content='0;url=?opt=$opt&menu=$menu&submenu=$submenu&id=$_REQUEST[id]'/>";
				exit();
				}
				
			$dA = mysql_fetch_array(mysql_query("SELECT * FROM x23_penagihankpb WHERE id='$dX[idpenagihankpb]'"));
			$d2 = mysql_fetch_array(mysql_query("SELECT nama FROM x23_user_vw WHERE id='$dA[idbayar]'"));
?>
			<aside class="right-side">
			    <section class="content">
			                		...
			                		<div style="padding:20px;overflow-y:auto;overflow-x:auto;height:300px;margin-top:-20px">
					           			<div class="col-xs-12">
				                        	<table id="example2" class="table table-bordered table-striped" style="min-width:220%">
												...
												$q1 = mysql_query("SELECT * FROM x23_penagihankpb WHERE id='$dX[idpenagihankpb]'");
												while($d1 = mysql_fetch_array($q1))
					                            	{
...
<?
		...
		if(!empty($dX[idnotaindent]))
			{
			mysql_query("UPDATE x23_abis_ikesalahan SET status='1' WHERE id='$_REQUEST[id]'");
			$dA = mysql_fetch_array(mysql_query("SELECT * FROM x23_abis_ikesalahan WHERE idnotaindent='$dX[idnotaindent]'"));
			$d1 = mysql_fetch_array(mysql_query("SELECT * FROM x23_notajual_vw WHERE nonota='$dA[notajual]'"));
?>
...
<?
		...
		if(!empty($dX[idpenagihanoli]))
			{
			mysql_query("UPDATE x23_abis_ikesalahan SET status='1' WHERE id='$_REQUEST[id]'");
			$dA = mysql_fetch_array(mysql_query("SELECT * FROM x23_abis_ikesalahan WHERE idpenagihanoli='$dX[idpenagihanoli]'"));
			$d1 = mysql_fetch_array(mysql_query("SELECT * FROM x23_notabeli WHERE id='$dX[idpenagihanoli]'"));
			$d2 = mysql_fetch_array(mysql_query("SELECT SUM(qty) AS qty FROM x23_notabeli_det WHERE nonota='$d1[nonota]'"));			                           
			$d3 = mysql_fetch_array(mysql_query("SELECT SUM(hargaoli) AS hargaoli FROM x23_claimoli_det WHERE nonota='$d1[nonota]'"));	
			                	...
			                	<h4>PENAGIHAN <small>OLI KE MPM</h4>
			                    	...
			                    	<div class="box-body table-responsive" style="overflow-y:auto;overflow-x:auto;height:260px;">
				                        <table id="example2" class="table table-striped table-hover" style="width:150%">
				                            ...
				                            while($d1 = mysql_fetch_array($q1))
				                            	{
				                            	$dD1 = mysql_fetch_array(mysql_query("SELECT * FROM x23_claimoli_det WHERE id='$d1[id_claimoli_det]'"));
