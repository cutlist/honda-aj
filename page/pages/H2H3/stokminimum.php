									...
									?>
	                           		<div style="float:right" class="col-xs-7">
										...
										if($_SESSION[posisi]=='DIREKSI' || $_SESSION[posisi]=='KEPALA BENGKEL')
											{
										?>
	                           				<button type="button"  onclick="window.open('print/h2/stokminimum.php','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')" class="btn btn-danger pull-right"><i class="fa fa-print"></i> Export Ke Excel</button>
	                           			<?
	                           				}
	                           			?>
	                           		</div>
			                        <table id="example1" class="table table-bordered table-striped table-hover">
			                            ...
			                            ?>
			                                <tr style="cursor:pointer">
			                                	...
			                                	<td align="right" onclick="location.href='<?echo "?opt=$opt&menu=$menu&submenu=$submenu&mod=view&id=$d1[idbarang]"?>'"><span style="padding-right:20%"><?echo number_format($d3[totqty],"0","",".")?> PCS</span></td>
			                        ...
			                        <table id="example2" class="table table-striped table-hover">
			                            ...
			                            ?>
			                                <tr style="cursor:pointer">
			                                    ...
			                                    <td align="right"><span style="margin-right:0%"><?echo number_format($dA[stok],"0","",".")?> PCS</span></td>
			                                </tr>
