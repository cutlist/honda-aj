...
?>
			<script type="text/javascript">
				...
				function popup_print(){
					window.open('print/kom_rekaph2h3.php?tahun=<?echo $periode_tahun?>&bulan=<?echo $periode_bulan?>','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')
					}
			</script>
			                ...
			                <div class="box box-danger" style="overflow-x:auto;overflow-y:auto;height:520px;">
								...
								?>
														...
														<tr style='font-size:12px'> 
															...
															<td align='right'><?echo number_format($d2[kservis],"0","",".")?></td> 
															<td align='right'><?echo number_format($d2[kjasa],"0","",".")?></td> 
															<td align='right'><?echo number_format($d2[kkplbengkel],"0","",".")?></td> 
