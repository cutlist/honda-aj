			                ...
			                <div class="box box-danger" style="overflow-x:auto;overflow-y:auto;height:520px;">
				                    			...
				                    			<td colspan="2"><select name="EmployeeID" style="padding:3px;" class="form-control" id="select1" required="">
				                    							<option value=''>PILIH KARYAWAN</option>
																		<?
																			...
																			else if($_SESSION[posisi]=='KEPALA BENGKEL')
												                            	{
																				$q1 = mysql_query("SELECT * FROM abs_x23_employee_vw WHERE status='AKTIF' AND posisi!='6' GROUP BY EmployeeID  ORDER BY FirstName");
																				}
			                           									 	else
												                            	{
								...
								?>
			                                ...
			                                <tr style="cursor:pointer">
				                    			...
				                    			<td width="12%"align="right"><span style="padding-right:10%"><?echo number_format($g,"0","",".")?></span></td>
				                    			<td width="12%"align="right"><span style="padding-right:10%"><?echo number_format($c,"0","",".")?></span></td>
				                    			<td width="12%"align="right"><span style="padding-right:10%"><?echo number_format($f2,"0","",".")?></span></td>
