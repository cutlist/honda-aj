			                ...
			                <div class="box box-danger" style="overflow-x:auto;overflow-y:auto;height:520px;">
			                	...
			                	<h4>KASIR <small>KWITANSI <i class="fa fa-angle-double-right"></i> SERVIS</small></h4>
                                    	...
                                    	<table width="100%">
                                    		<tr>
                                    			<td>
		                                            	...
		                                            	<input type="text" style="height:34px" name="cari" autofocus placeholder="CARI NAMA PELANGGAN / NO. ANTRIAN / NO. POLISI / STATUS CETAK ..." class="form-control"/>
		                                            </div>
                                    			</td>
	                           		...
	                           		<div style="float:right" class="col-xs-4">
										<button type="button"  onclick="window.open('print/h2/kwitansiservis.php?cari=<?echo $_REQUEST[cari]?>','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')" class="btn btn-danger pull-right"><i class="fa fa-print"></i> Export Ke Excel</button>
	                           		</div>
	                           		<?}?>
	                           		
									<table id="example3" class="table table-striped table-hover" style="width:160%">
			                            <thead style="color:#666;font-size:13px">
			                                <tr>
			                                    <th style="padding:7px" width="8%">NO. KWITANSI</th>
			                                    <th style="padding:7px" width="8%">JENIS SERVIS</th>
			                                    <th style="padding:7px" width="8%">NO. NOTA SERVIS</th>
			                                    <th style="padding:7px" width="8%">TGL NOTA SERVIS</th>
			                                    <th style="padding:7px" width="8%">WAKTU SELESAI</th>
			                                    <th style="padding:7px" width="10%">NO. ANTRIAN</th>
			                                    <th style="padding:7px" width="8%">NO. POLISI</th>
			                                    <th style="padding:7px">NAMA PELANGGAN</th>
			                                    <th style="padding:7px" width="8%">JUMLAH (RP)</th>
			                                    <th style="padding:7px" width="14%">JUMLAH (PEMBULATAN) (RP)</th>
			                                    <th style="padding:7px" width="">STATUS CETAK</th>
			                                </tr>
			                            </thead>
			                            <tbody>
			                            <?
										if(!empty($_REQUEST[cari]))
											{
											$q1 = mysql_query("SELECT * FROM x23_kwitansi_vw WHERE jnskwitansi='servis' AND (ket LIKE '%$_REQUEST[cari]%' OR nama LIKE '%$_REQUEST[cari]%' OR nopol LIKE '%$_REQUEST[cari]%' OR noantrian LIKE '%$_REQUEST[cari]%') ORDER BY id DESC");
											}
										else
											{
											$q1 = mysql_query("SELECT * FROM x23_kwitansi_vw WHERE jnskwitansi='servis' ORDER BY id DESC LIMIT 0,20");
											}
			                            while($d1 = mysql_fetch_array($q1))
									    	...
									    	if($d1[status]=="0"){$status = "<span class='btn btn-danger' style='padding:0px 10px;font-size:12px;'>BELUM CETAK</span>";}
									    	else{$status = "<span class='btn btn-primary' style='padding:0px 10px;font-size:12px;'>SUDAH DICETAK</span>";}
			                            ?>
...
?>
						<script type="text/javascript">
							...
							function popup_print(){
								window.open('print/kwitansi_h23svc.php?nokwitansi=<?echo $d1[nokwitansi]?>','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')
								}
						</script>
			            <div class="col-xs-12">	     
...
<?
        ...
        */
		...
		echo "			
		<script type='text/javascript'>
			window.open('print/kwitansi_h23svc.php?nokwitansi=$_REQUEST[nokwitansi]','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')
		</script>";
			                ...
			                <div class="box box-danger" style="overflow-x:auto;overflow-y:auto;height:520px;">
			                	...
			                	<h4>KASIR <small>KWITANSI <i class="fa fa-angle-double-right"></i> PENJUALAN BARANG</small></h4>
				                   	...
				                   	<form method="post" action="" enctype="multipart/form-data">
                                    	<table width="100%">
                                    		<tr>
                                    			<td>
		                                            	...
		                                            	<input type="text" style="height:34px" name="cari" autofocus placeholder="CARI NAMA PELANGGAN / NO. KWITANSI / NO. NOTA JUAL / STATUS CETAK ..." class="form-control"/>
		                                            </div>
                                    			</td>
                                    			<td width="1%"><button type="submit" class="btn btn-primary pull-left"><i class="fa fa-search"></i></button>
                                    			</td>
										...
										?>
	                           		<div style="float:right" class="col-xs-4">
										<button type="button"  onclick="window.open('print/h2/kwitansipenjualan.php?cari=<?echo $_REQUEST[cari]?>','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')" class="btn btn-danger pull-right"><i class="fa fa-print"></i> Export Ke Excel</button>
	                           		</div><?}?>
	                           		
									<table id="example3" class="table table-striped table-hover" style="width:130%">
			                            <thead style="color:#666;font-size:13px">
			                                <tr>
			                                    <th style="padding:7px" width="13%">NO. KWITANSI</th>
			                                    <th style="padding:7px" width="13%">NO. NOTA JUAL</th>
			                                    <th style="padding:7px" width="8%">TGL NOTA JUAL</th>
			                                    <th style="padding:7px" width="">NAMA PELANGGAN</th>
			                                    <th style="padding:7px" width="10%">TOTAL QTY JUAL</th>
			                                    <th style="padding:7px" width="16%">JUMLAH (RP)</th>
			                                    <th style="padding:7px" width="16%">JUMLAH (RP) (PEMBULATAN)</th>
			                                    <th style="padding:7px" width="">STATUS CETAK</th>
			                                </tr>
			                            </thead>
			                            <tbody>
										...
										if(!empty($_REQUEST[cari]))
											{
											$q1 = mysql_query("SELECT * FROM x23_kwitansi_vw WHERE jnskwitansi='penjualan' AND (ket LIKE '%$_REQUEST[cari]%' OR nama LIKE '%$_REQUEST[cari]%' OR nokwitansi LIKE '%$_REQUEST[cari]%' OR nomor LIKE '%$_REQUEST[cari]%') ORDER BY id DESC");
											}
										else
											{
											$q1 = mysql_query("SELECT * FROM x23_kwitansi_vw WHERE jnskwitansi='penjualan' ORDER BY id DESC LIMIT 0,20");
											}
			                            while($d1 = mysql_fetch_array($q1))
			                            	{
...
?>
						<script type="text/javascript">
							var s5_taf_parent = window.location;
							function popup_print(){
								window.open('print/kwitansi_h23sp.php?nokwitansi=<?echo $d1[nokwitansi]?>','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')
								}
						</script>
			            <div class="col-xs-12">	     
			                <div class="box box-danger" style="overflow-x:hidden;overflow-y:auto;height:520px;">
...
<?
		...
		echo "			
		<script type='text/javascript'>
			window.open('print/kwitansi_h23sp.php?nokwitansi=$_REQUEST[nokwitansi]','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')
		</script>";
			                	...
			                	<h4>KASIR <small>KWITANSI <i class="fa fa-angle-double-right"></i> INDENT</small></h4>
									...
									?>
				                   	...
				                   	<form method="post" action="" enctype="multipart/form-data">
                                    	<table width="100%">
                                    		<tr>
                                    			<td>
		                                            	...
		                                            	<input type="text" style="height:34px" name="cari" autofocus placeholder="CARI NAMA PELANGGAN / NO. NOTA INDENT / NO. KWITANSI / STATUS CETAK ..." class="form-control"/>
		                                            </div>
                                    			</td>
                                    			<td width="1%"><button type="submit" class="btn btn-primary pull-left"><i class="fa fa-search"></i></button>
                                    			</td>
										...
										?>
	                           		<div style="float:right" class="col-xs-4">
										<button type="button"  onclick="window.open('print/h2/kwitansiindent.php?cari=<?echo $_REQUEST[cari]?>','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')" class="btn btn-danger pull-right"><i class="fa fa-print"></i> Export Ke Excel</button>
	                           		</div><?}?>
	                           		
									<table id="example3" class="table table-striped table-hover" style="width:140%">
			                            <thead style="color:#666;font-size:13px">
			                                <tr>
			                                    <th style="padding:7px" width="12%">NO. KWITANSI</th>
			                                    <th style="padding:7px" width="12%">NO. NOTA INDENT</th>
			                                    <th style="padding:7px" width="12%">TGL NOTA INDENT</th>
			                                    <th style="padding:7px" width="">NAMA PELANGGAN</th>
			                                    <th style="padding:7px" width="9%">TOTAL QTY INDENT</th>
			                                    <th style="padding:7px" width="17%">JUMLAH UANG MUKA INDENT (RP)</th>
			                                    <th style="padding:7px" width="15%">JUMLAH HO (RP)</th>
			                                    <th style="padding:7px" width="">STATUS CETAK</th>
			                                </tr>
			                            </thead>
			                            <tbody>
										...
										if(!empty($_REQUEST[cari]))
											{
											$q1 = mysql_query("SELECT * FROM x23_kwitansi_vw WHERE jnskwitansi='indent' AND (ket LIKE '%$_REQUEST[cari]%' OR nama LIKE '%$_REQUEST[cari]%' OR nokwitansi LIKE '%$_REQUEST[cari]%' OR nomor LIKE '%$_REQUEST[cari]%') ORDER BY id DESC");
											}
										else
											{
											$q1 = mysql_query("SELECT * FROM x23_kwitansi_vw WHERE jnskwitansi='indent' ORDER BY id DESC LIMIT 0,20");
											}
			                            while($d1 = mysql_fetch_array($q1))
			                            	{
...
?>
						<script type="text/javascript">
							var s5_taf_parent = window.location;
							function popup_print(){
								window.open('print/kwitansi_h23ind.php?nokwitansi=<?echo $d1[nokwitansi]?>','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')
								}
						</script>
			            <div class="col-xs-12">	     
			                <div class="box box-danger" style="overflow-x:hidden;overflow-y:auto;height:520px;">
...
<?
		...
		echo "			
		<script type='text/javascript'>
			window.open('print/kwitansi_h23ind.php?nokwitansi=$_REQUEST[nokwitansi]','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')
		</script>";
			                ...
			                <div class="box box-danger" style="overflow-x:hidden;overflow-y:auto;height:520px;">
			                	...
			                	<h4>KASIR <small>KWITANSI <i class="fa fa-angle-double-right"></i> PEMBAYARAN PIUTANG TUNAI & POTONGAN KOMPENSASI TUNAI</small></h4>
				                   	...
				                   	<form method="post" action="" enctype="multipart/form-data">
                                    	<table width="100%">
                                    		<tr>
                                    			<td>
		                                            	...
		                                            	<input type="text" style="height:34px" name="cari" autofocus placeholder="CARI NAMA KARYAWAN / NO. KWITANSI / STATUS CETAK ..." class="form-control"/>
		                                            </div>
                                    			</td>
                                    			<td width="1%"><button type="submit" class="btn btn-primary pull-left"><i class="fa fa-search"></i></button>
                                    			</td>
										...
										?>
	                           		<div style="float:right" class="col-xs-4">
										<button type="button"  onclick="window.open('print/h2/kwitansitunai.php?cari=<?echo $_REQUEST[cari]?>','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')" class="btn btn-danger pull-right"><i class="fa fa-print"></i> Export Ke Excel</button>
	                           		</div><?}?>
									...
									<table id="example3" class="table table-striped table-hover">
			                            <thead style="color:#666;font-size:13px">
			                                <tr>
			                                    ...
			                                    <th style="padding:7px" width="17%">STATUS CETAK</th>
			                                </tr>
			                            </thead>
			                            <tbody>
			                            <?
										if(!empty($_REQUEST[cari]))
											{
											$q1 = mysql_query("SELECT * FROM x23_kwitansi_tunai_vw WHERE jnskwitansi IN ('tunai') AND (ket LIKE '%$_REQUEST[cari]%' OR nama LIKE '%$_REQUEST[cari]%' OR nokwitansi LIKE '%$_REQUEST[cari]%') AND status!='2' ORDER BY id DESC");
											}
										else
											{
											$q1 = mysql_query("SELECT * FROM x23_kwitansi_tunai_vw WHERE jnskwitansi IN ('tunai') AND status!='2' ORDER BY id DESC LIMIT 0,20");
											}
			                            while($d1 = mysql_fetch_array($q1))
			                            	{
											if($d1[status]=="0"){
...
?>
						<script type="text/javascript">
							var s5_taf_parent = window.location;
							function popup_print(){
								window.open('print/kwitansi_tnx23.php?nokwitansi=<?echo $d1[nokwitansi]?>&status=1','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')
								}
						</script>
			            <div class="col-xs-12">	     
			                <div class="box box-danger" style="overflow-x:hidden;overflow-y:auto;height:520px;">
			                ...
			                <div class="box box-danger" style="overflow-x:hidden;overflow-y:auto;height:520px;">
			                	...
			                	<h4>KASIR <small>KWITANSI <i class="fa fa-angle-double-right"></i> PIUTANG KARYAWAN</small></h4>
				                   	...
				                   	<form method="post" action="" enctype="multipart/form-data">
										...
										?>
	                           		<div style="float:right" class="col-xs-4">
										<button type="button"  onclick="window.open('print/h2/kwitansipiutang.php?cari=<?echo $_REQUEST[cari]?>','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')" class="btn btn-danger pull-right"><i class="fa fa-print"></i> Export Ke Excel</button>
	                           		</div><?}?>
									...
									<table id="example3" class="table table-striped table-hover">
										...
										if(!empty($_REQUEST[cari]))
											{
											$q1 = mysql_query("SELECT * FROM x23_kwitansi_piutang_vw WHERE jnskwitansi IN ('piutang') AND (ket LIKE '%$_REQUEST[cari]%' OR nama LIKE '%$_REQUEST[cari]%' OR nokwitansi LIKE '%$_REQUEST[cari]%') AND status!='2' ORDER BY id DESC");
											}
										else
											{
											$q1 = mysql_query("SELECT * FROM x23_kwitansi_piutang_vw WHERE jnskwitansi IN ('piutang') AND status!='2' ORDER BY id DESC LIMIT 0,20");
											}
			                            while($d1 = mysql_fetch_array($q1))
			                            	{
