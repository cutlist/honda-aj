		            ...
		            ?>
						<script type="text/javascript">
							...
							function popup_print1(){
								window.open('print/aruskash2.php?tahun=<?echo $periode_tahun?>&bulan=<?echo $periode_bulan?>','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')
								}
						</script>
		            ...
		            ?>
						<script type="text/javascript">
							...
							function popup_print2(){
								window.open('print/aruskash1tgl.php?periode=<?echo $_REQUEST[periode]?>','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')
								}
						</script>
                        <div class="nav-tabs-custom" style="border-radius:4px 4px 0 0">
                            <ul class="nav nav-tabs pull-right" style="border-radius:4px 4px 0 0">
                        	...
                        	if(!empty($_REQUEST[periode]))
                        		{
					                $dA1  = mysql_fetch_array(mysql_query("SELECT SUM(jumlah) AS total FROM x23_bayarsup_history WHERE tanggal BETWEEN '$periode_awal' AND '$periode_akhir'"));
					                $dA2  = mysql_fetch_array(mysql_query("SELECT SUM(jumlah) AS total FROM x23_kaskecil WHERE tanggal BETWEEN '$periode_awal' AND '$periode_akhir' AND jenis='OUTPUT'"));
					                $dA2B  = mysql_fetch_array(mysql_query("SELECT SUM(jumlah) AS total FROM x23_kaskecil WHERE tanggal BETWEEN '$periode_awal' AND '$periode_akhir' AND jenis='INPUT'"));
		                            $dA3  = mysql_fetch_array(mysql_query("SELECT SUM(jumlah) AS total FROM x23_piutang WHERE tgl BETWEEN '$periode_awal' AND '$periode_akhir' AND jenis='piutang' AND status='1'"));
		                            $dA4S = mysql_fetch_array(mysql_query("SELECT SUM(pembulatan) AS total FROM x23_kwitansi WHERE tanggal BETWEEN '$periode_awal' AND '$periode_akhir' AND jnskwitansi='servis' AND status='1'"));
		                            $dA4J1= mysql_fetch_array(mysql_query("SELECT SUM(pembulatan) AS total FROM x23_kwitansi WHERE tanggal BETWEEN '$periode_awal' AND '$periode_akhir' AND jnskwitansi='penjualan' AND jumlah>=0 AND status='1'"));
		                            $dA4J2= mysql_fetch_array(mysql_query("SELECT SUM(jumlah) AS total FROM x23_kwitansi WHERE tanggal BETWEEN '$periode_awal' AND '$periode_akhir' AND jnskwitansi='penjualan' AND jumlah<0 AND status='1'"));
		                            $dA4I = mysql_fetch_array(mysql_query("SELECT SUM(jumlah) AS total FROM x23_kwitansi WHERE tanggal BETWEEN '$periode_awal' AND '$periode_akhir' AND jnskwitansi='indent' AND status='1'"));
		                            
		                            $dA5A = mysql_fetch_array(mysql_query("SELECT SUM(jumlah) AS total FROM x23_piutang WHERE tgl BETWEEN '$periode_awal' AND '$periode_akhir' AND jenis='pembayaran' AND metodebayar='TUNAI' AND status='1'"));
		                            $dA5B = mysql_fetch_array(mysql_query("SELECT SUM(jumlah) AS total FROM x23_piutang WHERE tgl BETWEEN '$periode_awal' AND '$periode_akhir' AND jenis='pembayaran' AND metodebayar='GAJI' AND status='1' AND potkompensasi='1'"));
		                            $dA8  = mysql_fetch_array(mysql_query("SELECT SUM(totuharian) AS total FROM x23_uangharian WHERE tglbayar BETWEEN '$periode_awal' AND '$periode_akhir' AND status='1'"));
		                            $dA9  = mysql_fetch_array(mysql_query("SELECT SUM(ulembur) AS total FROM x23_uanglembur WHERE tglbayar BETWEEN '$periode_awal' AND '$periode_akhir'"));
		                            $dA10A = mysql_fetch_array(mysql_query("SELECT SUM(jumlah) AS total FROM x23_potkompensasi WHERE tgl BETWEEN '$periode_awal' AND '$periode_akhir' AND status='1' AND metodebayar='GAJI' AND potkompensasi='1'"));
		                            $dA10B = mysql_fetch_array(mysql_query("SELECT SUM(jumlah) AS total FROM x23_potkompensasi WHERE tgl BETWEEN '$periode_awal' AND '$periode_akhir' AND metodebayar='TUNAI' AND status='1'"));
		                            $dA11 = mysql_fetch_array(mysql_query("SELECT SUM(total) AS total FROM x23_kompensasi WHERE tglbayar BETWEEN '$periode_awal' AND '$periode_akhir' AND status='1'"));
		                            $dA12A = mysql_fetch_array(mysql_query("SELECT SUM(totjumselisih) AS total FROM x23_opname WHERE tanggal BETWEEN '$periode_awal' AND '$periode_akhir' AND totjumselisih>=0 AND status='1'"));
		                            $dA12B = mysql_fetch_array(mysql_query("SELECT SUM(totjumselisih) AS total FROM x23_opname WHERE tanggal BETWEEN '$periode_awal' AND '$periode_akhir' AND totjumselisih<0 AND status='1'"));
							...
							?>
				                        ...
				                        <table id="example2" class="table table-bordered table-striped table-hover">
				                            ...
				                            <!-- ############################ PEMBAYARAN PEMBELIAN ######################################################################### -->
					                            ...
					                            <?
													$q1 = mysql_query("SELECT tanggal,jumlah,nonota FROM x23_bayarsup_history WHERE tanggal BETWEEN '$periode_awal' AND '$periode_akhir'");
						                            while($d1 = mysql_fetch_array($q1))
						                            	{
												?>
						                                <tr style="cursor:pointer">
				                            ...
				                            <!-- ############################ PENGEMBALIAN KELEBIHAN UANG MUKA ####################################################################################### -->
					                            ...
					                            <?
													$q1 = mysql_query("SELECT * FROM x23_kwitansi WHERE tanggal BETWEEN '$periode_awal' AND '$periode_akhir' AND jnskwitansi='penjualan' AND status='1'");
						                            while($d1 = mysql_fetch_array($q1))
						                            	{
						                            	$d2 = mysql_fetch_array(mysql_query("SELECT nama FROM tbl_pelanggan WHERE id='$d1[idpelanggan]'"));
												?>
				                            ...
				                            <!-- ############################ PENGELUARAN KAS KECIL ######################################################################### -->
					                            ...
					                            <?
													$q1 = mysql_query("SELECT * FROM x23_kaskecil WHERE tanggal BETWEEN '$periode_awal' AND '$periode_akhir' AND jenis='OUTPUT'");
						                            while($d1 = mysql_fetch_array($q1))
						                            	{
												?>
						                                <tr style="cursor:pointer">
				                            ...
				                            <!-- ############################ PIUTANG KARYAWAN ################################################################################ -->
					                            ...
					                            <?
													$q1 = mysql_query("SELECT * FROM x23_piutang WHERE tgl BETWEEN '$periode_awal' AND '$periode_akhir' AND jenis='piutang' AND status='1'");
						                            while($d1 = mysql_fetch_array($q1))
						                            	{
												?>
						                                <tr style="cursor:pointer">
				                            ...
				                            <!-- ############################ PEMBAYARAN UANG HARIAN ################################################################################ -->
					                            ...
					                            <?
													$q1 = mysql_query("SELECT * FROM x23_uangharian WHERE tglbayar BETWEEN '$periode_awal' AND '$periode_akhir' AND status='1' AND totuharian!=0 ORDER BY updatex");
						                            while($d1 = mysql_fetch_array($q1))
						                            	{
							                    ?>
						                                <tr style="cursor:pointer">
				                            ...
				                            <!-- ############################ PEMBAYARAN UANG LEMBUR ################################################################################ -->
					                            ...
					                            <?
													$q1 = mysql_query("SELECT * FROM x23_uanglembur WHERE tglbayar BETWEEN '$periode_awal' AND '$periode_akhir' ORDER BY updatex");
						                            while($d1 = mysql_fetch_array($q1))
						                            	{
												?>
						                                <tr style="cursor:pointer">
				                            ...
				                            <!-- ############################ PEMBAYARAN KOMPENSASI / GAJI ################################################################################ -->
					                            ...
					                            <?
													$q1 = mysql_query("SELECT * FROM x23_kompensasi WHERE tglbayar BETWEEN '$periode_awal' AND '$periode_akhir' AND status='1' ORDER BY updatex");
						                            while($d1 = mysql_fetch_array($q1))
						                            	{
												?>
						                                <tr style="cursor:pointer">
				                            ...
				                            <!-- ############################ SELISIH STOCK OPNAME ################################################################################ -->
					                            ...
					                            <?
													$q1 = mysql_query("SELECT * FROM x23_opname_vw WHERE tanggal BETWEEN '$periode_awal' AND '$periode_akhir' AND status='1' ORDER BY inputx");
						                            while($d1 = mysql_fetch_array($q1))
						                            	{
												?>
						                                <tr style="cursor:pointer">
				                            ...
				                            <!-- ############################ SERVIS ####################################################################################### -->
					                            ...
					                            <?
													$q1 = mysql_query("SELECT * FROM x23_kwitansi WHERE tanggal BETWEEN '$periode_awal' AND '$periode_akhir' AND jnskwitansi='servis' AND status='1'");
						                            while($d1 = mysql_fetch_array($q1))
						                            	{
						                            	$d2 = mysql_fetch_array(mysql_query("SELECT nama FROM tbl_pelanggan WHERE id='$d1[idpelanggan]'"));
												?>
				                            ...
				                            <!-- ############################ UANG MUKA BARANG INDENT ####################################################################################### -->
					                            ...
					                            <?
													$q1 = mysql_query("SELECT * FROM x23_kwitansi WHERE tanggal BETWEEN '$periode_awal' AND '$periode_akhir' AND jnskwitansi='indent' AND status='1'");
						                            while($d1 = mysql_fetch_array($q1))
						                            	{
						                            	$d2 = mysql_fetch_array(mysql_query("SELECT nama FROM tbl_pelanggan WHERE id='$d1[idpelanggan]'"));
												?>
				                            ...
				                            <!-- ############################ PEMASUKAN KAS KECIL ######################################################################### -->
					                            ...
					                            <?
													$q1 = mysql_query("SELECT * FROM x23_kaskecil WHERE tanggal BETWEEN '$periode_awal' AND '$periode_akhir' AND jenis='INPUT'");
						                            while($d1 = mysql_fetch_array($q1))
						                            	{
												?>
						                                <tr style="cursor:pointer">
				                            ...
				                            <!-- ############################ PEMBAYARAN PIUTANG KARYAWAN (TUNAI) ########################################################################### -->
					                            ...
					                            <?
													$q1 = mysql_query("SELECT * FROM x23_piutang WHERE tgl BETWEEN '$periode_awal' AND '$periode_akhir' AND jenis='pembayaran' AND metodebayar='TUNAI' AND status='1'");
						                            while($d1 = mysql_fetch_array($q1))
						                            	{
												?>
						                                <tr style="cursor:pointer">
				                            ...
				                            <!-- ############################ PEMBAYARAN PIUTANG KARYAWAN DIPOTONG GAJI########################################################################### -->
					                            ...
					                            <?
													$q1 = mysql_query("SELECT * FROM x23_piutang WHERE tgl BETWEEN '$periode_awal' AND '$periode_akhir' AND status='1' AND potkompensasi='1' AND jenis='pembayaran' AND metodebayar='GAJI' AND potkompensasi='1'");
													while($d1 = mysql_fetch_array($q1))
														{
												?>
						                                <tr style="cursor:pointer">
				                            ...
				                            <!-- ############################ PEMBAYARAN POTONGAN KOMPENSASI (TUNAI) ########################################################################### -->
					                            ...
					                            <?
													$q1 = mysql_query("SELECT * FROM x23_potkompensasi WHERE tgl BETWEEN '$periode_awal' AND '$periode_akhir' AND metodebayar='TUNAI' AND status='1'");
													while($d1 = mysql_fetch_array($q1))
														{
												?>
						                                <tr style="cursor:pointer">
				                            ...
				                            <!-- ############################ PEMBAYARAN POTONGAN KOMPENSASI DIPOTONG GAJI ########################################################################### -->
					                            ...
					                            <?
													$q1 = mysql_query("SELECT * FROM x23_potkompensasi WHERE tgl BETWEEN '$periode_awal' AND '$periode_akhir' AND status='1' AND metodebayar='GAJI' AND potkompensasi='1'");
													while($d1 = mysql_fetch_array($q1))
														{
												?>
						                                <tr style="cursor:pointer">
				                            ...
				                            <!-- ############################ KELEBIHAN SELISIH DARI STOCK OPNAME ################################################################################ -->
					                            ...
					                            <?
													$q1 = mysql_query("SELECT * FROM x23_opname_vw WHERE tanggal BETWEEN '$periode_awal' AND '$periode_akhir' AND status='1' AND totjumselisih < 0 ORDER BY inputx");
						                            while($d1 = mysql_fetch_array($q1))
						                            	{
												?>
						                                <tr style="cursor:pointer">
