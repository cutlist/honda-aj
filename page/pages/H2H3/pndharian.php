...
?>
			<script type="text/javascript">
				...
				function popup_print(){
					window.open('print/h2/pndharianservis.php?periode=<?echo $_REQUEST[periode]?>','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')
					}
			</script>
			                	...
			                	<h4>KASIR <small>PENDAPATAN HARIAN <i class="fa fa-angle-right"></i> SERVIS</small></h4>	 
			                        ...
			                        <table id="example2" class="table table-bordered table-striped" style="width:220%">
										...
										if(empty($_REQUEST[periode]))
											{
			                            	$q1 = mysql_query("SELECT * FROM x23_notaservice WHERE tglnota=CURDATE() AND status='2'");
											}
										else
											{
			                            	$q1 = mysql_query("SELECT * FROM x23_notaservice WHERE tglnota BETWEEN '$periode_awal' AND '$periode_akhir' AND status='2'");
											}
...
?>
			<script type="text/javascript">
				var s5_taf_parent = window.location;
				function popup_print(){
					window.open('print/h2/pndhariansp.php?periode=<?echo $_REQUEST[periode]?>','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')
					}
			</script>
			<aside class="right-side">
			    <section class="content">
