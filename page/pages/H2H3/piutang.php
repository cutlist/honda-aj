			                		...
			                		<div style="padding:20px 0px 20px 20px;overflow-x:hidden;overflow-y:auto;height:380px;">
										...
										<div style="margin-top:20px">
					                    	<table width="100%">
					                    		<tr>
					                    			<td align="center">
                                    					<button type="button"  onclick="window.open('print/h2/historypiutang.php?idkaryawan=<?echo $_REQUEST[idkaryawan]?>','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')" class="btn btn-danger pull-right"><i class="fa fa-print"></i> Export Ke Excel</button>
