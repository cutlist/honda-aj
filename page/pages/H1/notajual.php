				                    		...
				                    		<tr>
				                    			...
				                    			<td>:</td>
					                    			<td colspan="2">
					                                    <div class="input-group">
					                                        <span class="input-group-addon">RP.</span>
					                                        <input type="text" name="utitipan" id="utitipan" value="<?echo number_format($dB[utitipan],"0","",".")?>" class="form-control" placeholder="0" style="width:34%;text-align:right" maxlength="17" onfocus="this.select();" onkeypress="return buat_angka(event,'0123456789')" readonly="">
					                                    </div>
							                        </td>
				                    		</tr>
			                    		<?
