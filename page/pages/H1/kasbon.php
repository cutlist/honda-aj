<?
	if($submenu == 'A')
		...
		if(!empty($_REQUEST[bayar]))
	        ...
	        $dK = mysql_fetch_array(mysql_query("SELECT kwitansicb FROM tbl_notajual_det WHERE tglbayarkomisi=CURDATE() ORDER BY SUBSTR(kwitansicb,-3,3) DESC LIMIT 1"));
			...
			<script type='text/javascript'>
				window.open('print/kwitansi_kasbon.php?id=$_REQUEST[bayar]','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')
			</script>";
			*/
			}
			                ...
			                <div class="box box-danger" style="overflow-x:hidden;overflow-y:auto;height:520px;">
			                	...
			                	<h4>KASIR <small>CASH BON</small></h4>	 
			                        ...
			                        <table id="example2" class="table table-bordered table-striped">
										...
										$q1 = mysql_query("SELECT * FROM tbl_notajual_det_vw WHERE ref!='' AND tglnota BETWEEN '$_SESSION[periode_awal]' AND '$_SESSION[periode_akhir]'");
			                            ...
			                            ?>
											<script type="text/javascript">
												...
												function popup_print<?echo $d1[id]?>(){
													window.open('print/kwitansi_kasbon.php?id=<?echo $d1[id]?>','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')
													}
											</script>
