			                ...
			                <div class="box box-danger" style="overflow-x:auto;overflow-y:auto;height:520px;">
			                    ...
			                    ?>
				                        <table id="example5" class="table table-bordered table-striped table-hover" style="width:100%;padding-right:20px">
					                        ...
					                        <?
					                       	/*
												$dA  = mysql_fetch_array(mysql_query("SELECT id FROM tbl_cekfisik_vw WHERE bulan='$periode_bulan'  AND tahun='$periode_tahun' AND bensinawal > literawal"));
												if(!empty($dA[id]))
													{
											?>
					                                <tr style="cursor:pointer;">
											...
											<?
													$q1	 = mysql_query("SELECT * FROM tbl_cekfisik_vw WHERE bulan='$periode_bulan'  AND tahun='$periode_tahun' AND bensinawal > literawal ORDER BY tanggal");
											...
											*/
												$dA  = mysql_fetch_array(mysql_query("SELECT id FROM tbl_notabeli WHERE bulan='$periode_bulan'  AND tahun='$periode_tahun' AND ikesalahanacc IN ('1','2')"));
												if(!empty($dA[id]))
													{
											?>
					                                <tr style="cursor:pointer;">
											...
											<?
													$q1	 = mysql_query("SELECT * FROM tbl_notabeli WHERE bulan='$periode_bulan'  AND tahun='$periode_tahun' AND ikesalahanacc IN ('1','2')");
													while($d1  = mysql_fetch_array($q1))
														{
							                            	...
							                            	$d2 = mysql_fetch_array(mysql_query("SELECT nama FROM tbl_stokunit_vw WHERE nonota='$d1[nonota]'"));
					                        ?>
											...
											<?	
												...
												$dA  = mysql_fetch_array(mysql_query("SELECT id FROM tbl_cekfisik_vw WHERE bulan='$periode_bulan'  AND tahun='$periode_tahun' AND ikesalahan!='0' ORDER BY tanggal"));
												if(!empty($dA[id]))
													{
											?>
					                                <tr style="cursor:pointer;">
											...
											<?
													$q1	 = mysql_query("SELECT * FROM tbl_cekfisik_vw WHERE bulan='$periode_bulan'  AND tahun='$periode_tahun' AND ikesalahan!='0' ORDER BY tanggal");
													while($d1  = mysql_fetch_array($q1))
														{
														$dCek = mysql_fetch_array(mysql_query("SELECT status FROM tbl_notajual WHERE nonota='$d1[nonota]'"));
														if($dCek[status]=="1")
															{
											...
											<?
												...
												$dA  = mysql_fetch_array(mysql_query("SELECT id FROM tbl_notabeli_det3_vw WHERE bulan='$periode_bulan'  AND tahun='$periode_tahun' AND (status='0' OR ikesalahan='1') ORDER BY tglnota"));
												if(!empty($dA[id]))
													{
											?>
					                                <tr style="cursor:pointer;">
											...
											<?
													$q1	 = mysql_query("SELECT *,COUNT(norangka) AS total FROM tbl_notabeli_det3_vw WHERE bulan='$periode_bulan'  AND tahun='$periode_tahun' AND (status='0' OR ikesalahan='1') GROUP BY nonota ORDER BY tglnota");
													while($d1  = mysql_fetch_array($q1))
														{
											...
											<?		
												$d1  = mysql_fetch_array(mysql_query("SELECT * FROM tbl_opname_vw WHERE bulan='$periode_bulan'  AND tahun='$periode_tahun'"));
												if(empty($d1[id]))
													{
											...
											<?
												...
												//$dA  = mysql_fetch_array(mysql_query("SELECT id FROM tbl_pengeluaranunit_vw WHERE bulan='$periode_bulan'  AND tahun='$periode_tahun' AND '$tglsampai' > tanggal AND tglsampai2=='0000-00-00' ORDER BY tanggal"));
												$dA  = mysql_fetch_array(mysql_query("SELECT id FROM tbl_pengeluaranunit_vw WHERE bulan='$periode_bulan'  AND tahun='$periode_tahun' AND '$tglsampai' > tanggal AND tglsampai2='0000-00-00'"));
												if(!empty($dA[id]))
													{
											?>
					                                <tr style="cursor:pointer;">
					                        ...
					                        <?
													//$q1	 = mysql_query("SELECT * FROM tbl_pengeluaranunit_vw WHERE bulan='$periode_bulan'  AND tahun='$periode_tahun' AND '$tglsampai' > tanggal AND tglsampai2!='0000-00-00' ORDER BY tanggal");
													$q1	 = mysql_query("SELECT * FROM tbl_pengeluaranunit_vw WHERE bulan='$periode_bulan'  AND tahun='$periode_tahun' AND '$tglsampai' > tanggal AND tglsampai2='0000-00-00'");
													while($d1  = mysql_fetch_array($q1))
														{
						                            	if($d1[ikesalahan]=="1"){$status = "<span class='btn btn-primary' style='padding:0px 10px;font-size:12px;width:150px'> Direspon</span>";$red="";}
						                            	if($d1[ikesalahan]=="0"){$status = "<span class='btn btn-danger' style='padding:0px 10px;font-size:12px;width:150px'>Membutuhkan Respon</span>";$red="color:red";}
...
<?
		...
		{
		mysql_query("UPDATE tbl_cekfisik SET lihat='1' WHERE id='$_REQUEST[id]'");
		
		$d5 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_cekfisik WHERE id='$_REQUEST[id]'"));
		$dB = mysql_fetch_array(mysql_query("SELECT * FROM tbl_notajual WHERE nonota='$d5[nonota]'"));
...
<?
		...
		$d2 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_bpkb WHERE nopesan='$dB[nopesan]'"));
		$d3 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_leasing WHERE id='$dB[idleasing]'"));
		$d4 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_stokunit WHERE norangka='$d5[norangka]'"));
		$d6 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_user_vw WHERE id='$dB[iduserpdi]'"));
?>
...
<?
    	...
    	while($dTemp = mysql_fetch_array($qTemp))
			...
			$dA = mysql_fetch_array(mysql_query("SELECT * FROM tbl_cekfisik WHERE norangka='$norangka'"));
			if($dA[helm]=='0' AND $helm=='1'){
				mysql_query("UPDATE stok_helm SET jual=jual+1 WHERE nonota='$_REQUEST[notabeli]'");
				}
			if($dA[spion]=='0' AND $spion=='1'){
				mysql_query("UPDATE stok_spion SET jual=jual+2 WHERE nonota='$_REQUEST[notabeli]'");
				}
			if($dA[accu]=='0' AND $accu=='1'){
				mysql_query("UPDATE stok_accu SET jual=jual+1 WHERE nonota='$_REQUEST[notabeli]'");
				}
			if($dA[toolkit]=='0' AND $toolkit=='1'){
				mysql_query("UPDATE stok_toolkit SET jual=jual+1 WHERE nonota='$_REQUEST[notabeli]'");
				}
			if($dA[alaskaki]=='0' AND $alaskaki=='1'){
				mysql_query("UPDATE stok_alaskaki SET jual=jual+1 WHERE nonota='$_REQUEST[notabeli]'");
				}
			if($dA[jaket]=='0' AND $jaket=='1'){
				mysql_query("UPDATE stok_jaket SET jual=jual+1 WHERE nonota='$_REQUEST[notabeli]'");
				}
			if($dA[bukuservis]=='0' AND $alaskaki=='1'){
				mysql_query("UPDATE stok_bukuservis SET jual=jual+1 WHERE nonota='$_REQUEST[notabeli]'");
				}
		...
		{
		mysql_query("UPDATE tbl_notabeli_det SET ikesalahan='1' WHERE status='0' AND nonota='$_REQUEST[id]'");
		//mysql_query("UPDATE tbl_notabeli SET scan='1' WHERE nonota='$_REQUEST[id]'");
		$d1 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_notabeli WHERE nonota='$_REQUEST[id]'"));
		$d2 = mysql_fetch_array(mysql_query("SELECT nama FROM tbl_stokunit_vw WHERE nonota='$_REQUEST[id]'"));
?>
			<aside class="right-side">
			    <section class="content">
			        <div class="row">
...
<?
		...
		{
		mysql_query("UPDATE tbl_notajual_det SET ikesalahan='1' WHERE norangka='$_REQUEST[id]'");
		$d1 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_pengeluaranunit_vw WHERE norangka='$_REQUEST[id]'"));
?>
			<aside class="right-side">
			    <section class="content">
			        <div class="row">
			            <div class="col-xs-12" style="margin-bottom:10px">
			                <div class="box box-danger">
			                	...
			                	<h4>KETERLAMBATAN PENGIRIMAN BARANG</h4>
				                	...
				                	<?
										$dB = mysql_fetch_array(mysql_query("SELECT * FROM tbl_notajual WHERE nonota='$d1[nonota]'"));
										...
										$d6 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_user_vw WHERE id='$dB[iduserpdi]'"));
										$d7 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_user_vw WHERE id='$dB[iduser]'"));
...
<?
		...
		{
		mysql_query("UPDATE tbl_notabeli SET ikesalahanacc='2' WHERE nonota='$_REQUEST[id]'");
		$d1 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_notabeli WHERE nonota='$_REQUEST[id]'"));
		$d2 = mysql_fetch_array(mysql_query("SELECT nama FROM tbl_stokunit_vw WHERE nonota='$_REQUEST[id]'"));
		
		$dHitung = mysql_fetch_array(mysql_query("SELECT COUNT(id) AS total FROM tbl_notabeli_det WHERE nonota='$d1[nonota]' AND status='1'"));
		$h1 = $dHitung[total];
		$h2 = $dHitung[total]*2;
		
		$dS1 = mysql_fetch_array(mysql_query("SELECT helm FROM stok_helm WHERE nonota='$d1[nonota]'"));
		$dS2 = mysql_fetch_array(mysql_query("SELECT bukuservis FROM stok_bukuservis WHERE nonota='$d1[nonota]'"));
		$dS3 = mysql_fetch_array(mysql_query("SELECT spion FROM stok_spion WHERE nonota='$d1[nonota]'"));
		$dS4 = mysql_fetch_array(mysql_query("SELECT accu FROM stok_accu WHERE nonota='$d1[nonota]'"));
		$dS5 = mysql_fetch_array(mysql_query("SELECT jaket FROM stok_jaket WHERE nonota='$d1[nonota]'"));
		$dS6 = mysql_fetch_array(mysql_query("SELECT toolkit FROM stok_toolkit WHERE nonota='$d1[nonota]'"));
		$dS7 = mysql_fetch_array(mysql_query("SELECT anakkunci FROM stok_anakkunci WHERE nonota='$d1[nonota]'"));
		$dS8 = mysql_fetch_array(mysql_query("SELECT alaskaki FROM stok_alaskaki WHERE nonota='$d1[nonota]'"));
