			                ...
			                <div class="box box-danger" style="overflow-x:auto;overflow-y:auto;height:520px;">
			                    ...
			                    ?>
				                        <table id="example6" class="table table-bordered table-striped table-hover" style="width:100%;padding-right:20px">
				                            ...
				                            <tbody>
					                        <?
												$q1	 = mysql_query("SELECT * FROM tbl_abis_dkonfirmasi WHERE bulan='$periode_bulan'  AND tahun='$periode_tahun' AND idkaskecil!='0' OR idreturbeli!='0' OR idpindah!='0' OR idpesanan!='0' ORDER BY id DESC");
