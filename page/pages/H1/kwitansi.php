			                	...
			                	<h4>KASIR <small>KWITANSI</small></h4>
									...
									<table id="example1" class="table table-striped table-hover">
										...
										if(!empty($_REQUEST[cari]) AND !empty($_REQUEST[idjenis]))
											{
											$q1 = mysql_query("SELECT * FROM tbl_kwitansi WHERE nokwitansi LIKE '%$_REQUEST[cari]%' AND jnskwitansi='$jns' ORDER BY id DESC LIMIT 0,100");
											}
										if(!empty($_REQUEST[cari]) AND empty($_REQUEST[idjenis]))
											{
											$q1 = mysql_query("SELECT * FROM tbl_kwitansi WHERE nokwitansi LIKE '%$_REQUEST[cari]%' ORDER BY id DESC LIMIT 0,100");
											}
										if(empty($_REQUEST[cari]) AND !empty($_REQUEST[idjenis]))
											{
											$q1 = mysql_query("SELECT * FROM tbl_kwitansi WHERE jnskwitansi='$jns' ORDER BY id DESC LIMIT 0,100");
											}
										if(empty($_REQUEST[cari]) AND empty($_REQUEST[idjenis]))
											{
											$q1 = mysql_query("SELECT * FROM tbl_kwitansi WHERE cetak='0' ORDER BY id DESC");
											}
			                            ...
			                            while($d1 = mysql_fetch_array($q1))
											...
											if($d1[jnskwitansi]=="piutang"){
												$dZ = mysql_fetch_array(mysql_query("SELECT status FROM tbl_piutang WHERE id='$d1[nomor]'"));
												...
												$dZ = mysql_fetch_array(mysql_query("SELECT status FROM tbl_potkompensasi WHERE id='$d1[idpotkom]'"));
												if($dZ[status]=="2"){$show = "0";}
												else{$show = "1";}
												}
											else{
											...
											if($d1[jnskwitansi]=="tunai" OR $d1[jnskwitansi]=="piutang"){
												$d2 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_karyawan WHERE id='$d1[idpelanggan]'"));
												}
											else{
...
<?
		...
		{
		$d1 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_notajual WHERE nonota='$_REQUEST[nonota]'"));
        ...
        $dNK = mysql_fetch_array(mysql_query("SELECT nokwitansi FROM tbl_kwitansi WHERE jnskwitansi='cashtempo' AND tanggal=CURDATE() ORDER BY SUBSTR(nokwitansi,-3,3) DESC LIMIT 1"));
				                	...
				                	<div style="padding:20px;min-height:200px;">
										<div style="min-height:90px">
											...
											<table id="example2" class="table table-striped">
					                            ...
					                            <tbody>
					                            <?
												$qA = mysql_query("SELECT * FROM tbl_notajual_det WHERE nonota='$_REQUEST[nonota]'");
...
<?
		...
		$q1 = mysql_query("UPDATE tbl_notajual SET sisabayar=sisabayar-$jumlah, tglpelunasan='$tglpelunasan' WHERE nonota='$nonota'");
		...
		<script type='text/javascript'>
			window.open('print/kwitansi.php?nokwitansi=$_REQUEST[nokwitansi]','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')
		</script>";
...
<?
		...
		{
		$d1 = mysql_fetch_array(mysql_query("SELECT id,idpelanggan,utitipan,jnstransaksi,jnscashtempo FROM tbl_pesanan WHERE nopesan='$_REQUEST[nonota]'"));
		...
		if(empty($d1[id]))
			...
			{
			$d3 = mysql_fetch_array(mysql_query("SELECT id FROM tbl_kwitansi WHERE nomor='$_REQUEST[nonota]' AND jnskwitansi='umuka'"));
			if(!empty($d3[id]))
				{
        ...
        $dNK = mysql_fetch_array(mysql_query("SELECT nokwitansi FROM tbl_kwitansi WHERE jnskwitansi='umuka' AND tanggal=CURDATE() ORDER BY SUBSTR(nokwitansi,-3,3) DESC LIMIT 1"));
				                	...
				                	<div style="padding:20px;min-height:200px;">
										<div style="min-height:90px">
											...
											<table id="example2" class="table table-striped">
					                            ...
					                            <tbody>
					                            <?
												$qA = mysql_query("SELECT * FROM tbl_pesanan_det WHERE nopesan='$_REQUEST[nonota]'");
					                            while($dA = mysql_fetch_array($qA))
					                            	{
					                            	$d3 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_masterbarang WHERE id='$dA[idbarang]'"));
					                            ?>
...
<?
		...
		if(empty($d1[id]))
			...
			{
			$d3 = mysql_fetch_array(mysql_query("SELECT id FROM tbl_kwitansi WHERE nomor='$_REQUEST[nonota]' AND jenis='titip'"));
			if(!empty($d3[id]))
				{
        ...
        $dNK = mysql_fetch_array(mysql_query("SELECT nokwitansi FROM tbl_kwitansi WHERE jnskwitansi='titip' AND tanggal=CURDATE() ORDER BY SUBSTR(nokwitansi,-3,3) DESC LIMIT 1"));
...
<?
		...
		{
		$d1 = mysql_fetch_array(mysql_query("SELECT batal,idpelanggan,utitipan FROM tbl_pesanan WHERE nopesan='$_REQUEST[nopesan]'"));
		if(empty($d1[batal]))
			{
			echo "<script>alert ('Mohon Ulangi Nomor Nota Yang Diinput, Karena Nomor Nota Tidak Ada.')</script>";
			print "<meta http-equiv='refresh' content='0;url=?opt=$opt&menu=$menu&submenu=add1'/>";
			...
			{
			$d3 = mysql_fetch_array(mysql_query("SELECT id FROM tbl_kwitansi WHERE nomor='$_REQUEST[nopesan]' AND jnskwitansi='pengembalian'"));
			$d4 = mysql_fetch_array(mysql_query("SELECT id FROM tbl_kwitansi WHERE nomor='$_REQUEST[nopesan]' AND jnskwitansi IN ('umuka','titip')"));
			if(empty($d4[id]))
				{
        ...
        $dNK = mysql_fetch_array(mysql_query("SELECT nokwitansi FROM tbl_kwitansi WHERE jnskwitansi='pengembalian' AND tanggal=CURDATE() ORDER BY SUBSTR(nokwitansi,-3,3) DESC LIMIT 1"));
				                	...
				                	<div style="padding:20px;min-height:200px;">
										<div style="min-height:90px">
											...
											<table id="example2" class="table table-striped">
					                            ...
					                            <tbody>
					                            <?
												$qA = mysql_query("SELECT * FROM tbl_pesanan_det WHERE nopesan='$_REQUEST[nopesan]'");
					                            while($dA = mysql_fetch_array($qA))
					                            	{
					                            	$d3 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_masterbarang WHERE id='$dA[idbarang]'"));
					                            ?>
...
<?
		...
		{
		$d1 = mysql_fetch_array(mysql_query("SELECT id,idpelanggan,bayar,jnstransaksi FROM tbl_notajual WHERE nonota='$_REQUEST[nonota]'"));
		if($d1[jnstransaksi]!='CASH')
			{
		...
		if(empty($d1[id]))
			...
			{
			$d3 = mysql_fetch_array(mysql_query("SELECT id FROM tbl_kwitansi WHERE nomor='$_REQUEST[nonota]' AND jnskwitansi='lunas'"));
			if(!empty($d3[id]))
				{
        ...
        $dNK = mysql_fetch_array(mysql_query("SELECT nokwitansi FROM tbl_kwitansi WHERE jnskwitansi='lunas' AND tanggal=CURDATE() ORDER BY SUBSTR(nokwitansi,-3,3) DESC LIMIT 1"));
		...
		*/
		...
		$q1 = mysql_query("INSERT INTO tbl_kwitansi (
											...
											VALUES (
												...
												'$updatex')
							");
		mysql_query("UPDATE tbl_notajual SET sisabayar=sisabayar-$jumlah WHERE nonota='$_REQUEST[nonota]'");
		...
		{
		$d3 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_kwitansi WHERE nokwitansi='$_REQUEST[nomor]'"));
		$d1 = mysql_fetch_array(mysql_query("SELECT id,idpelanggan FROM tbl_pesanan WHERE nopesan='$d3[nomor]'"));
		$d2 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_pelanggan WHERE id='$d1[idpelanggan]'"));
		
		//$d3 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_kwitansi WHERE nomor='$_REQUEST[nomor]' AND jnskwitansi='umuka'"));
?>
			<script type="text/javascript">
				var s5_taf_parent = window.location;
				function popup_print(){
					window.open('print/kwitansi.php?nokwitansi=<?echo $d3[nokwitansi]?>','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')
					}
			</script>
			<aside class="right-side">
			    <section class="content">
				                	...
				                	<div style="padding:20px;min-height:200px;">
										<div style="min-height:90px">
											...
											<table id="example2" class="table table-striped">
					                            ...
					                            <tbody>
					                            <?
												$qA = mysql_query("SELECT * FROM tbl_pesanan_det WHERE nopesan='$d3[nomor]'");
					                            while($dA = mysql_fetch_array($qA))
					                            	{
					                            	$d3 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_masterbarang WHERE id='$dA[idbarang]'"));
					                            ?>
...
<?
		...
		{
		$d2 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_kwitansi WHERE nokwitansi='$_REQUEST[nomor]'"));
		$d1 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_bpkb WHERE notajual='$d2[nomor]' OR nopesan='$d2[nomor]'"));
?>
			<script type="text/javascript">
				var s5_taf_parent = window.location;
				function popup_print(){
					window.open('print/kwitansinopol.php?nokwitansi=<?echo $d2[nokwitansi]?>','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')
					}
			</script>
			<aside class="right-side">
			    <section class="content">
			                	...
			                	<h4>KASIR <small>KWITANSI &nbsp; <i class="fa fa-angle-right"></i> &nbsp; Detail Kwitansi</small></h4>
				                	<div style="padding:20px;min-height:200px;">
										<div style="min-height:90px">
					                    	...
					                    	if($d1[status]=="2")
					                    		{
												$qA = mysql_query("SELECT * FROM tbl_notajual_det WHERE nonota='$d2[nomor]'");
											?>
					                    		<tr>
					                    			<td width="30%">NOMOR NOTA PENJUALAN</td>
					                    			<td width="2%">:</td>
											...
											<?
					                    		...
					                    		{
												$qA = mysql_query("SELECT * FROM tbl_pesanan_det WHERE nopesan='$d2[nomor]'");
											?>
					                    		<tr>
...
<?
		...
		{
		$d2 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_kwitansi WHERE nokwitansi='$_REQUEST[nomor]'"));
		$d1 = mysql_fetch_array(mysql_query("SELECT id,idpelanggan FROM tbl_pesanan WHERE nopesan='$d2[nomor]'"));
		$d3 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_pelanggan WHERE id='$d1[idpelanggan]'"));
?>
			<script type="text/javascript">
				var s5_taf_parent = window.location;
				function popup_print(){
					window.open('print/kwitansi.php?nokwitansi=<?echo $d2[nokwitansi]?>','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')
					}
			</script>
			<aside class="right-side">
			    <section class="content">
...
<?
		...
		{
		$d3 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_kwitansi WHERE nokwitansi='$_REQUEST[nomor]'"));
		$d1 = mysql_fetch_array(mysql_query("SELECT id,idpelanggan FROM tbl_notajual WHERE nonota='$d3[nomor]'"));
		$d2 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_pelanggan WHERE id='$d1[idpelanggan]'"));
?>
			<script type="text/javascript">
				var s5_taf_parent = window.location;
				                	...
				                	<div style="padding:20px;min-height:200px;">
										<div style="min-height:90px">
											...
											<table id="example2" class="table table-striped">
					                            ...
					                            <tbody>
					                            <?
												$qA = mysql_query("SELECT * FROM tbl_notajual_det WHERE nonota='$d3[nomor]'");
					                            while($dA = mysql_fetch_array($qA))
					                            	{
					                            	$d3 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_masterbarang WHERE id='$dA[idbarang]'"));
					                            ?>
				                	...
				                	<div style="padding:20px;min-height:200px;">
										<div style="min-height:90px">
											...
											<table id="example2" class="table table-striped">
					                            ...
					                            while($dA = mysql_fetch_array($qA))
					                            	{
					                            	$d4 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_masterbarang WHERE id='$dA[idbarang]'"));
					                            ?>
					                                <tr style="cursor:pointer">
...
<?
		...
		{
		$d1 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_kwitansi WHERE nokwitansi='$_REQUEST[nomor]'"));
		$d2 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_karyawan WHERE id='$d1[idpelanggan]'"));
...
?>
			<script type="text/javascript">
				var s5_taf_parent = window.location;
				function popup_print(){
					window.open('print/kwitansi_piutang.php?nokwitansi=<?echo $d1[nokwitansi]?>&status=1','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')
					}
			</script>
...
?>
			<script type="text/javascript">
				var s5_taf_parent = window.location;
				function popup_print(){
					window.open('print/kwitansi_tn.php?nokwitansi=<?echo $d1[nokwitansi]?>&status=1','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')
					}
			</script>
			            ...
			            <div class="col-xs-12">
			                <div class="box box-danger">
			                	...
			                	<h4>KASIR <small>KWITANSI &nbsp; <i class="fa fa-angle-right"></i> &nbsp; Detail Kwitansi</small></h4>
			                        ...
			                        if($d1[status]=='1'){
										if($d1[idpotkom]=="0"){
											$dB = mysql_fetch_array(mysql_query("SELECT * FROM tbl_piutang WHERE id='$d1[nomor]'"));
											$dPiu = mysql_fetch_array(mysql_query("SELECT SUM(jumlah) AS total FROM tbl_piutang WHERE jenis='piutang' AND idkaryawan='$dB[idkaryawan]' AND status='1' GROUP BY idkaryawan"));
											$dPby = mysql_fetch_array(mysql_query("SELECT SUM(jumlah) AS total FROM tbl_piutang WHERE jenis='pembayaran' AND idkaryawan='$dB[idkaryawan]' AND status='1' GROUP BY idkaryawan"));
