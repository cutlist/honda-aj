<?
	...
	if($submenu == 'A')
		...
		if(!empty($_REQUEST[delkas]))
			{
			$q1 = mysql_query("DELETE FROM tbl_bensin WHERE id='$_REQUEST[delkas]'");
			$q2 = mysql_query("INSERT INTO log_act VALUES (										
		                                    '',
		                                    'tbl_bensin',
		                                    CURDATE(),
...
?>
			<aside class="right-side">
			    <section class="content">
			                ...
			                <div class="box box-danger" style="overflow-x:hidden;overflow-y:auto;height:520px;">
								...
								?>	
			                        <table id="example2" class="table table-bordered table-striped">
										...
										$q1 = mysql_query("SELECT * FROM tbl_bensin WHERE tanggal BETWEEN '$_SESSION[periode_awal]' AND '$_SESSION[periode_akhir]' AND status='0' ORDER BY id DESC");
										$dI = mysql_fetch_array(mysql_query("SELECT SUM(jumlah) AS total FROM tbl_bensin WHERE jenis='INPUT' AND status='0'"));
										$dO = mysql_fetch_array(mysql_query("SELECT SUM(jumlah) AS total FROM tbl_bensin WHERE jenis='OUTPUT' AND status='0'"));
										$dIx = mysql_fetch_array(mysql_query("SELECT SUM(jumlah) AS total FROM tbl_bensin WHERE jenis='INPUT' AND tanggal BETWEEN '$_SESSION[periode_awal]' AND '$_SESSION[periode_akhir]' AND status='0'"));
										$dOx = mysql_fetch_array(mysql_query("SELECT SUM(jumlah) AS total FROM tbl_bensin WHERE jenis='OUTPUT' AND tanggal BETWEEN '$_SESSION[periode_awal]' AND '$_SESSION[periode_akhir]' AND status='0'"));
			        ...
			        <?
			        $qM = mysql_query("SELECT * FROM tbl_bensin WHERE tanggal BETWEEN '$_SESSION[periode_awal]' AND '$_SESSION[periode_akhir]' AND status='0' ORDER BY id DESC");
