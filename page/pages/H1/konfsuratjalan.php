			                ...
			                <div class="box box-danger" style="overflow-x:auto;overflow-y:auto;height:520px;">
			                	...
			                	<h4>ADMINISTRASI <small>DAFTAR KONFIRMASI SURAT JALAN</small></h4>
				                    ...
				                    <table id="example3" class="table table-striped table-bordered table-hover" style="min-width:250%">
			                            ...
			                            <tbody>
			                            <?
										$q1 = mysql_query("SELECT * FROM tbl_notajual_det WHERE tglsampai='0000-00-00' AND nonota IN (SELECT nonota FROM tbl_pengeluaranunit WHERE status='0')");
			                            ...
			                            ?>
											<script type="text/javascript">
												...
												function popup_print<?echo $d1[id]?>(){
													window.open('print/suratjalan.php?id=<?echo $d1[id]?>','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')
													}
											</script>
