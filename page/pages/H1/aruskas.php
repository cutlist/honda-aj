		            ...
		            ?>
						<script type="text/javascript">
							...
							function popup_print1(){
								window.open('print/aruskash1.php?tahun=<?echo $periode_tahun?>&bulan=<?echo $periode_bulan?>','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')
								}
						</script>
                        <div class="nav-tabs-custom" style="border-radius:4px 4px 0 0">
                            ...
                            <div class="tab-content" style="overflow-x:auto;overflow-y:auto;height:460px;">											
                                <div class="tab-pane active">
									...
									<?
									/*
									$qHit1 = mysql_query("SELECT norangka FROM tbl_labakredit1_vw WHERE bulan='$periode_bulan' AND tahun='$periode_tahun'");
									while($dHit1=mysql_fetch_array($qHit1))
										{
										$dH1 = mysql_fetch_array(mysql_query("SELECT nonota FROM tbl_stokunit WHERE norangka='$dHit1[norangka]' AND status='TERJUAL'"));
										$dH2 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_notabeli WHERE nonota='$dH1[nonota]'"));
										
										$bunga = $dH2[bayar]-$dH2[gtbayar]-$dH2[gtbayarppn];
										
										$dH3 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_hlaba WHERE nonota='$dH1[nonota]'"));
										if(empty($dH3[id])){
											if($bunga < 0){
												mysql_query("INSERT INTO tbl_hlaba (
																					nonota,
																					bulan,
																					tahun,
																					bunga,
									...
									*/
									...
									//echo "$dModalKredit[total].$dModalKredit[umtotal]</br>";
									//echo "$dLabaCash[total]";
									?>
                        	...
                        	if(!empty($_REQUEST[periode]))
                        		{
					                ...
					                $dA2  = mysql_fetch_array(mysql_query("SELECT SUM(jumlah) AS total FROM tbl_kaskecil WHERE tanggal BETWEEN '$periode_awal' AND '$periode_akhir' AND jenis='OUTPUT' AND status='1'"));
					                $dA2B  = mysql_fetch_array(mysql_query("SELECT SUM(jumlah) AS total FROM tbl_kaskecil WHERE tanggal BETWEEN '$periode_awal' AND '$periode_akhir' AND jenis='INPUT' AND status='1'"));
		                            ...
		                            $uangtitipan = mysql_fetch_array(mysql_query("SELECT SUM(jumlah) AS total FROM tbl_kwitansi WHERE tanggal BETWEEN '$periode_awal' AND '$periode_akhir' AND jnskwitansi IN ('titip','lunas','cashtempo')"));
		                        	...
		                        	$dA13A = mysql_fetch_array(mysql_query("SELECT SUM(jumlah) AS total FROM tbl_kwitansi WHERE tanggal BETWEEN '$periode_awal' AND '$periode_akhir' AND jnskwitansi IN ('nopol') AND status='1' AND jumlah>=0"));
		                        	$dA13B = mysql_fetch_array(mysql_query("SELECT SUM(jumlah) AS total FROM tbl_kwitansi WHERE tanggal BETWEEN '$periode_awal' AND '$periode_akhir' AND jnskwitansi IN ('nopol') AND status='1' AND jumlah<0"));
		                        	
		                        	$dA14  = mysql_fetch_array(mysql_query("SELECT SUM(gtbayarppn) AS total FROM tbl_notabeli WHERE tglnota BETWEEN '$periode_awal' AND '$periode_akhir' AND gtbayarppn!=''"));
		                        	$dA15  = mysql_fetch_array(mysql_query("SELECT SUM(tppnjual_min_ppnbeli) AS total FROM tbl_notajual WHERE tglnota BETWEEN '$periode_awal' AND '$periode_akhir' AND sisabayar<='0'"));
		                        	
		                            $otr  	= mysql_fetch_array(mysql_query("SELECT SUM(bayarotr) AS total FROM tbl_notajual_det_vw WHERE tglotr BETWEEN '$periode_awal' AND '$periode_akhir' AND statusotr='1'"));
		                            $gross  	= mysql_fetch_array(mysql_query("SELECT SUM(bayargross) AS total FROM tbl_notajual_det_vw WHERE tglgross BETWEEN '$periode_awal' AND '$periode_akhir' AND statusgross='1'"));
		                            $subsidi  = mysql_fetch_array(mysql_query("SELECT SUM(bayarsubsidi) AS total FROM tbl_notajual_det_vw WHERE tglsubsidi BETWEEN '$periode_awal' AND '$periode_akhir' AND statussubsidi='1'"));
		                            $matrix  	= mysql_fetch_array(mysql_query("SELECT SUM(bayarmatrix) AS total FROM tbl_notajual_det_vw WHERE tglmatrix BETWEEN '$periode_awal' AND '$periode_akhir' AND statusmatrix='1'"));
		                            $scpahm  	= mysql_fetch_array(mysql_query("SELECT SUM(bayarscpahm) AS total FROM tbl_notajual_det_vw WHERE tglscpahm BETWEEN '$periode_awal' AND '$periode_akhir' AND statusscpahm='1'"));
		                            $scpmd  	= mysql_fetch_array(mysql_query("SELECT SUM(bayarscpmd) AS total FROM tbl_notajual_det_vw WHERE tglscpmd BETWEEN '$periode_awal' AND '$periode_akhir' AND statusscpmd='1'"));
							...
							?>
				                        ...
				                        <table id="example2" class="table table-bordered table-striped table-hover">
				                            ...
				                            <!-- ############################ PEMBAYARAN PPN BELI UNIT ######################################################################### -->
					                            ...
					                            <?
													$q1 = mysql_query("SELECT tglnota,gtbayarppn,nonota FROM tbl_notabeli WHERE tglnota BETWEEN '$periode_awal' AND '$periode_akhir' AND gtbayarppn!=''");
						                            while($d1 = mysql_fetch_array($q1))
						                            	{
												?>
						                                <tr style="cursor:pointer">
				                            ...
				                            <!-- ############################ SISA PPN ######################################################################### -->
					                            ...
					                            <?
													$q1 = mysql_query("SELECT tppnjual_min_ppnbeli AS total,tglnota,nonota FROM tbl_notajual WHERE tglnota BETWEEN '$periode_awal' AND '$periode_akhir' AND sisabayar<='0'");
						                            while($d1 = mysql_fetch_array($q1))
						                            	{
												?>
						                                <tr style="cursor:pointer">
				                            ...
				                            <!-- ############################ PENGELUARAN KAS KECIL ######################################################################### -->
					                            ...
					                            <?
													$q1 = mysql_query("SELECT * FROM tbl_kaskecil WHERE tanggal BETWEEN '$periode_awal' AND '$periode_akhir' AND jenis='OUTPUT' AND status='1'");
						                            while($d1 = mysql_fetch_array($q1))
						                            	{
												?>
						                                <tr style="cursor:pointer">
				                            ...
				                            <!-- ############################ SELISIH STOCK OPNAME ################################################################################ -->
					                            ...
					                            <?
													$q1 = mysql_query("SELECT * FROM tbl_opname WHERE tanggal BETWEEN '$periode_awal' AND '$periode_akhir' AND status='1' ORDER BY inputx");
						                            while($d1 = mysql_fetch_array($q1))
						                            	{
						                            	$d2 = mysql_fetch_array(mysql_query("SELECT gudang FROM tbl_gudang WHERE id='$d1[idgudang]'"));
						                            	if(!empty($d2[gudang])){
				                            ...
				                            <!-- ############################ PENJUALAN CASH ####################################################################################### -->
						                        ...
						                        <?
													...
													$q1 = mysql_query("SELECT * FROM tbl_kwitansi WHERE tanggal BETWEEN '$periode_awal' AND '$periode_akhir' AND jnskwitansi='cashtempo'");
						                            while($d1 = mysql_fetch_array($q1))
						                            	{
						                            	$d3 = mysql_fetch_array(mysql_query("SELECT nama FROM tbl_pelanggan WHERE id='$d1[idpelanggan]'"));
												?>
				                            ...
				                            <!-- ############################ PEMBAYARAN PEMESANAN NOPOL ####################################################################################### -->
					                            ...
					                            <?
													$q1 = mysql_query("SELECT * FROM tbl_kwitansi WHERE tanggal BETWEEN '$periode_awal' AND '$periode_akhir' AND jnskwitansi='nopol' AND status='1'");
						                            while($d1 = mysql_fetch_array($q1))
						                            	{
						                            	$d2 = mysql_fetch_array(mysql_query("SELECT notajual FROM tbl_bpkb WHERE nopesan='$d1[nomor]'"));
						                            	$d3 = mysql_fetch_array(mysql_query("SELECT nama FROM tbl_pelanggan WHERE id='$d1[idpelanggan]'"));
												?>
						                                <tr style="cursor:pointer">
						                                    <td align="center"><?echo date("d-m-Y",strtotime($d1['tanggal']))?></td>
				                            ...
				                            <!-- ############################ PEMASUKAN KAS KECIL ######################################################################### -->
					                            ...
					                            <?
													$q1 = mysql_query("SELECT * FROM tbl_kaskecil WHERE tanggal BETWEEN '$periode_awal' AND '$periode_akhir' AND jenis='INPUT' AND status='1'");
						                            while($d1 = mysql_fetch_array($q1))
						                            	{
												?>
						                                <tr style="cursor:pointer">
