	...
	if($submenu == 'A')
		...
		if(empty($mod))
			...
			if(!empty($_REQUEST[input]))
				...
				mysql_query("UPDATE tbl_grossubsidi SET tgl2='$tanggal' WHERE status='1'");
			...
			if(!empty($_REQUEST[del]))
				{
				$q1 = mysql_query("DELETE FROM tbl_grossubsidi WHERE id='$_REQUEST[del]'");
				$q2 = mysql_query("INSERT INTO log_act VALUES (										
			                                    '',
			                                    'tbl_grossubsidi',
			                                    CURDATE(),
			...
			if(!empty($_REQUEST[aktif]))
				{
				$q1 = mysql_query("UPDATE tbl_grossubsidi SET status='1',tgl2='' WHERE id='$_REQUEST[aktif]'");
				$q2 = mysql_query("INSERT INTO log_act VALUES (										
			                                    '',
			                                    'tbl_grossubsidi',
			                                    CURDATE(),
...
<!-- ################## MODAL INPUT ########################################################################################## -->
                        <?
						$dA = mysql_fetch_array(mysql_query("SELECT * FROM tbl_grossubsidi WHERE status='1'"));
                        ?>
