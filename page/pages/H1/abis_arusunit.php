                                    	...
                                    	<table width="100%">
                                    		<tr>
												...
												if($_SESSION[posisi]=='DIREKSI')
													{
												?><td width="1%">
													<button type="button"  onclick="window.open('print/h1/abis_arusunit.php?periode=<?echo $_REQUEST[periode]?>','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')" class="btn btn-danger pull-right"><i class="fa fa-print"></i> Export Ke Excel</button>
										...
										while (strtotime($awal) <=  strtotime($akhir)) 
				                            ...
				                            ?>
			                                    ...
			                                    <!-- BARANG MASUK -->
			                                   		<td>
					                                <?
					                                	$qB = mysql_query("SELECT *,COUNT(nonota) AS tot FROM tbl_notabeli_det_vw WHERE tglnota='$awal' AND nodo!='' GROUP BY namabarang,varian,gudang");
				                                    ...
				                                    <td align="right">
					                                <?
					                                	$qB = mysql_query("SELECT *,COUNT(nonota) AS tot FROM tbl_notabeli_det_vw WHERE tglnota='$awal' AND nodo!=''");
					                                	while($dB = mysql_fetch_array($qB))
					                                		{
					                                		if($dB[tot]!='0')
					                                			{
