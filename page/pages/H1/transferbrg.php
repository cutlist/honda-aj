					...
					?>
						<script type="text/javascript">
							...
							function popup_print(){
								window.open('print/transferkeluar.php?notransfer=<?echo $d1[notransfer]?>','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')
								}
						</script>
...
<?
		...
		echo "			
		<script type='text/javascript'>
			window.open('print/transferkeluar.php?notransfer=$_SESSION[notransfer]','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')
		</script>";
...
<?
					...
					?>
						<script type="text/javascript">
							var s5_taf_parent = window.location;
							function popup_print(){
								window.open('print/transfermasuk.php?notransfer=<?echo $d1[notransfer]?>','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')
								}
						</script>
			            <div class="col-xs-12" style="margin-bottom:10px">
			                <div class="box box-danger">
