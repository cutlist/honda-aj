			                ...
			                <div class="box box-danger">
			                	...
			                	<h4>GUDANG & PDI <small>STOCK OPNAME BENSIN</small></h4>
			                        ...
			                        <table id="example3" class="table table-striped table-hover">
			                            ...
			                            <tbody>
			                            <?
										$q1 = mysql_query("SELECT * FROM tbl_bensin WHERE kode='OPNAME' AND substr(tanggal,6,2)='$periode_bulan' AND substr(tanggal,1,4)='$periode_tahun'");
...
<?
		...
		{
		$dCek2 = mysql_fetch_array(mysql_query("SELECT id FROM tbl_bensin WHERE kode='OPNAME' AND status='1'"));
		if(!empty($dCek2[id]))
			{
		...
		if(!empty($_REQUEST[input]))
			...
			$dCek = mysql_fetch_array(mysql_query("SELECT tanggal FROM tbl_bensin WHERE kode='OPNAME' ORDER BY tanggal DESC LIMIT 1"));
