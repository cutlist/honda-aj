	...
	if($submenu == 'A')
		...
		if(empty($mod))
			...
			if(!empty($_REQUEST[delinsentif]))
				{
				$q1 = mysql_query("DELETE FROM tbl_insentif_karyawan WHERE id_karyawan='$_REQUEST[delinsentif]'");
			                	...
			                	<h4>MASTER <small>KOMISI</small></h4>
			                        ...
			                        <table id="example1" class="table table-bordered table-striped">
										...
										if($_SESSION[posisi]=="DIREKSI"){
											...
											$q1 = mysql_query("SELECT * FROM tbl_insentif_karyawan_vw WHERE id_posisi NOT IN ('1','6') GROUP BY id_karyawan");
											}
...
<?
						...
						{
						$d1 = mysql_fetch_array(mysql_query("SELECT * FROM tbl_insentif_karyawan_vw WHERE id_karyawan='$_REQUEST[id_karyawan]'"));
?>
			            <div class="col-xs-12">
			                <div class="box box-danger">
			                    <div class="box-body table-responsive" style="overflow-y:auto;overflow-x:hidden;height:520px;">
										...
										<div style="min-height:90px;padding:20px">
				                    		<table style="width:100%;">
					                    		<tr>
							                    	...
							                    	<?
							                    		$qG = mysql_query("SELECT * FROM tbl_insentif_karyawan WHERE id_karyawan='$d1[id_karyawan]'");
								...
								<?
										...
										{
			                    		$dG=mysql_fetch_array(mysql_query("SELECT * FROM tbl_insentif_karyawan WHERE id_karyawan='$d1[id_karyawan]'"));
								?>
...
<?
						...
						if(!empty($_REQUEST[tambahdetinsentif]))
							...
							if($_REQUEST[id_posisi]=='2' || $_REQUEST[id_posisi]=='7' || $_REQUEST[id_posisi]=='6' || $_REQUEST[id_posisi]=='9')
								...
								$q1 = mysql_query("UPDATE tbl_insentif_karyawan SET flat='$flat' WHERE id='$_REQUEST[id]'");
								}
						...
						if(!empty($_REQUEST[deldetinsentif]))
							{
							$q1 = mysql_query("DELETE FROM tbl_insentif_karyawan WHERE id='$_REQUEST[iddet]'");
										...
										<div style="padding:20px;overflow-y:auto;overflow-x:hidden;height:220px;">
				                    		<table style="width:100%;">
					                    		<tr>
							                    	...
							                    	<?
							                    		$qG = mysql_query("SELECT * FROM tbl_insentif_karyawan WHERE id_karyawan='$d1[id_karyawan]' ORDER BY target");
							                    		while($dG=mysql_fetch_array($qG))
							                    			{
							                    	?>
															<tr>
					                    	...
					                    	<table style="width:100%">
					                    		<tr>
					                    			...
					                    			<td><select name="idkaryawan[]" class="form-control" id="tagPicker2" multiple="multiple">
																			<?
																				$q1 = mysql_query("SELECT * FROM tbl_karyawan WHERE id NOT IN (SELECT id_karyawan FROM tbl_insentif_karyawan) $pos ORDER BY nama");
...
<?
		...
		{
			        $flat = preg_replace( "/[^0-9]/", "",$_POST[flat]);
		mysql_query("UPDATE tbl_insentif_karyawan SET flat='$flat' WHERE id='$_REQUEST[id]'"); 
		print "<meta http-equiv='refresh' content='0;url=?opt=$opt&menu=$menu&submenu=A'/>";
		exit();
		}
