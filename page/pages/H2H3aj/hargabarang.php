			                ...
			                <div class="box box-danger">
			                	...
			                	<h4>MASTER <small>HARGA BARANG</small></h4>
			                        ...
			                        <table id="example1" class="table table-striped table-hover">
			                            ...
			                            <tbody>
			                            <?
										$q1 = mysql_query("SELECT * FROM x23_notabeli_vw WHERE id%2=0 AND harga='0' AND scan='1' AND dk='0' AND totalqty!='0'");
...
<?
		...
		$d2 = mysql_fetch_array(mysql_query("SELECT SUM(qty) AS qty, SUM(hargabelibersih) AS total, SUM(total) AS gtotal FROM x23_notabeli_det2_vw WHERE id%2=0 AND nonota='$d1[nonota]'"));			                           
?>
			<aside class="right-side">
			    <section class="content">
			        <div class="row">
        ...
        while($dA = mysql_fetch_array($qA))
			...
			*/
			...
			if(!empty($_REQUEST[hargajual.$id]))
		    	...
		    	mysql_query("UPDATE x23_stokpart SET hargajual='$hargajual',dk='$dk' WHERE id%2=0 AND id='$id'");
				*/
					
		    	mysql_query("UPDATE x23_stokpart SET hargajual='$hargajual',hargajual2='$hargajual2' WHERE id%2=0 AND id='$id'");
				}
        	}
        	
		
        	
		$q1 = mysql_query("UPDATE x23_notabeli SET harga='1' WHERE id%2=0 AND nonota='$_REQUEST[nonota]'");	
			                	...
			                	<h4>MASTER <small>HARGA BARANG</small></h4>
			                        ...
			                        <table id="example3" class="table table-striped table-hover">
										...
										if(!empty($_REQUEST[cari]))
											{
											$q1 = mysql_query("SELECT * FROM x23_notabeli_vw WHERE id%2=0 AND harga='1' AND nonota LIKE '%$_REQUEST[cari]%' OR nopo LIKE '%$_REQUEST[cari]%' OR nama LIKE '%$_REQUEST[cari]%' LIMIT 0,20");
											}
										else
											{
											$q1 = mysql_query("SELECT * FROM x23_notabeli_vw WHERE id%2=0 AND harga='1' ORDER BY id DESC LIMIT 0,20");
											}
			                            while($d1 = mysql_fetch_array($q1))
			                            	{
			                            ?>
			                ...
			                <div class="box box-danger">
			                	...
			                	<h4>MASTER <small>HARGA BARANG</small></h4>
			                        ...
			                        <table id="example3" class="table table-striped table-hover">
										...
										if(!empty($_REQUEST[cari]))
											{
											$q1 = mysql_query("SELECT * FROM x23_notabeli_vw WHERE id%2=0 AND harga='1' AND nonota IN (SELECT nonota FROM x23_notabeli_det_vw WHERE id%2=0 AND kodebarang LIKE '%$_REQUEST[cari]%' OR namabarang LIKE '%$_REQUEST[cari]%') LIMIT 0,20");
											}
										else
											{
											$q1 = mysql_query("SELECT * FROM x23_notabeli_vw WHERE id%2=0 AND harga='1' ORDER BY id DESC LIMIT 0,20");
...
<?
		...
		if(!empty($_REQUEST[ubahharga]))
			...
			$q1 = mysql_query("UPDATE x23_stokpart SET hargajual='$hargajual' WHERE id%2=0 AND id='$_REQUEST[ubahharga]'");
...
?>
			<aside class="right-side">
			    <section class="content">
		            ...
		            <?
					$q3 = mysql_query("SELECT * FROM x23_stokpart_vw WHERE id%2=0 AND nonota='$d1[nonota]'");
			                ...
			                <div class="box box-danger">
			                	...
			                	<h4>UBAH HARGA</h4>
			                        ...
			                        <table id="example3" class="table table-striped table-hover">
										...
										if(!empty($_REQUEST[cari]))
											{
											$q1 = mysql_query("SELECT *,SUM(totalstok) AS qty FROM x23_stokpart_group_vw2 WHERE id%2=0 AND kodebarang LIKE '%$_REQUEST[cari]%' OR namabarang LIKE '%$_REQUEST[cari]%' OR varian LIKE '%$_REQUEST[cari]%' GROUP BY hargajual ORDER BY totalstok LIMIT 0,20");
											}
										else
											{
...
<?
	...
	if($submenu == 'D')
		...
		if($_REQUEST[ubah]=="1")
			...
			mysql_fetch_array(mysql_query("UPDATE x23_stokpart SET hargajual='$hargabaru' WHERE id%2=0 AND idbarang='$_REQUEST[idbarang]'"));
