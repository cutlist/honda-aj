			        ...
			        <div class="row">
			            ...
			            <div class="col-xs-4">		                
			                <div class="small-box bg-green" style="text-align:center;height:520px;border-radius:5px 5px 0 0;margin-top:0px;padding:20px 0 0 0;border-bottom: 5px solid #fff">
			                	...
			                	<?
								$pA = mysql_fetch_array(mysql_query("SELECT COUNT(id) AS total FROM x23_notabeli WHERE id%2=0 AND tahun='$periode_tahun' AND bulan='$periode_bulan' AND bayar NOT IN ('0','') AND dk='0'"));
			                	?>
	                                <div class="inner">
			                		...
			                		<h4 style="border-bottom:1px dashed #ddd;padding-bottom:5px;width:96%">5 NOTA TERBARU (SUDAH BAYAR)</h4>
				                        <table class="table" style="width:96%">
				                            ...
				                            <tbody>
				                            <?
				                            $dc1 = mysql_fetch_array(mysql_query("SELECT * FROM x23_notabeli WHERE id%2=0 AND bayar NOT IN ('0','') AND dk='0' ORDER BY tglbayar DESC"));
				                            if(empty($dc1[id]))
				                            	{
				                            ?>
											...
											$q1 = mysql_query("SELECT * FROM x23_notabeli WHERE id%2=0 AND bayar NOT IN ('0','') AND dk='0' ORDER BY tglbayar DESC LIMIT 0,5");
			            ...
			            <div class="col-xs-4">			                
			                <div class="small-box bg-orange" style="text-align:center;height:520px;border-radius:5px 5px 0 0;margin-top:0px;padding:20px 0 0 0;border-bottom: 5px solid #fff">
			                	...
			                	<h5 style="margin-top:-10px">BULAN INI</h5>
			                	<?
								$pB = mysql_fetch_array(mysql_query("SELECT COUNT(id) AS total FROM x23_notabeli WHERE id%2=0 AND jns='PEMBELIAN' AND tahun='$periode_tahun' AND bulan='$periode_bulan' AND bayar IN ('0','') AND gtbayar!='' AND dk='0' AND harga='1'"));
			                	?>
			                		...
			                		<h4 style="border-bottom:1px dashed #ddd;padding-bottom:5px;width:96%">5 NOTA TERBARU (BELUM BAYAR)</h4>
				                        <table class="table" style="width:96%">
				                            ...
				                            <tbody>
				                            <?
				                            $dc1 = mysql_fetch_array(mysql_query("SELECT id FROM x23_notabeli WHERE id%2=0 AND jns='PEMBELIAN' AND bayar IN ('0','') AND gtbayar!='' AND dk='0' AND harga='1' ORDER BY tglbayar DESC LIMIT 0,5"));
				                            if(empty($dc1[id]))
				                            	{
				                            ?>
				                                <tr style="cursor:pointer">
											...
											$q1 = mysql_query("SELECT * FROM x23_notabeli WHERE id%2=0 AND jns='PEMBELIAN' AND bayar IN ('0','') AND gtbayar!='' AND dk='0' AND harga='1' ORDER BY tglbayar DESC");
				                            while($d1 = mysql_fetch_array($q1))
				                            	{
				                            ?>
				                                <tr style="cursor:pointer">
...
?>
			                        ...
			                        <table id="example1" class="table table-striped table-hover">
			                            <thead style="color:#666;font-size:13px">
			                                <tr>
			                                    ...
			                                    <th width="" style="padding:7px">TOTAL QTY BELI</th>
			                                    <th style="padding:7px">JUMLAH + PPN (RP)</th>
			                                </tr>
			                            </thead>
			                            <tbody>
			                            <?
										$q1 = mysql_query("SELECT * FROM x23_notabeli_vw WHERE id%2=0 AND bayar IN ('0','') AND gtbayar!='' AND dk='0' AND harga='1'");
			                            while($d1 = mysql_fetch_array($q1))
			                            	{
											$dA = mysql_fetch_array(mysql_query("SELECT * FROM x23_notabeli WHERE id%2=0 AND id='$_REQUEST[id]'"));
			                            ?>
			                                <tr style="cursor:pointer">
		            ...
		            <?
						$q3 = mysql_query("SELECT * FROM x23_notabeli WHERE id%2=0 AND bayar IN ('0','') AND dk='0'");
			            ...
			            <div class="col-xs-12">
			                <div class="box box-danger">
			                    <div class="box-body table-responsive" style="overflow-y:auto;overflow-x:auto;height:260px;">
			                        <table id="example2" class="table table-striped" style="width:120%">
			                            <thead style="color:#666;font-size:13px">
			                                <tr>
			                                    ...
			                                    <th width="" style="padding:7px"><center>STOK</center></th>
			                                </tr>
			                            </thead>
			                            <tbody>
			                            <?
										$d2 = mysql_fetch_array(mysql_query("SELECT * FROM x23_notabeli WHERE id%2=0 AND nonota='$d1[nonota]'"));
			                            $q1 = mysql_query("SELECT * FROM x23_notabeli_det2_vw WHERE id%2=0 AND nonota='$d1[nonota]'");
										 while($dA = mysql_fetch_array($q1))
			                            	{
											$d3 = mysql_fetch_array(mysql_query("SELECT stok FROM x23_stokpart WHERE id%2=0 AND idbarang='$dA[idbarang]' AND idgudang='$dA[idgudang]' AND rak='$dA[rak]' AND nonota='$dA[nonota]'"));
			                            ?>
			                                <tr style="cursor:pointer">
			                                    ...
			                                    <td align="right"><span style="margin-right:20%"><?echo number_format($d3[stok],"0","",".")?> PCS</span></td>
			                                </tr>
...
?>
					           			...
					           			<div class="col-xs-6">
					                        <table width="100%">
					                        	...
					                        	<tr>
					                    			...
					                    			<td><div class="input-group">
					                                        <span class="input-group-addon">RP.</span>
					                                        	<input type="text" value="<?echo number_format($d1[gtbayar],"0","",".")?>" onfocus="this.select();" style="width:80%;text-align:right" class="form-control uang" readonly> 
					                                    </div></td>
					                        	</tr>
					                        </table>
					                    </div>
					           			...
					           			<div class="col-xs-8">
					                        <table width="100%">
					                    		...
					                    		<tr>
					                    			...
					                    			<td>:</td>
					                    			<td><button type="button" data-toggle="modal" data-target="#compose-modal-notaretur"  class="btn btn-info" style="padding:2px;font-size:12px"> &nbsp;&nbsp; <i class="fa fa-search"></i> &nbsp;&nbsp;Pilih Nota Retur&nbsp;&nbsp;</button></td>
					                    			<td><a href="<?echo "?opt=$opt&menu=$menu&submenu=$submenu&mod=$mod&del=1&id=$_REQUEST[id]"?>"><button type="button" class="btn btn-danger" style="padding:2px;font-size:12px"> &nbsp;&nbsp; <i class="fa fa-trash-o"></i> &nbsp;&nbsp; Pilih Ulang Nota Retur &nbsp;&nbsp;</button></a></td>
					                    		</tr>
												<?
												if($_REQUEST[del]=="1"){
													mysql_query("DELETE FROM temp_x23_bayarsup_notaretur");
													}
												
								                $d3 = mysql_fetch_array(mysql_query("SELECT SUM(sisa) AS total FROM x23_notaretur WHERE id%2=0 AND noretur IN (SELECT noretur FROM temp_x23_bayarsup_notaretur) AND status!='1'"));
												if(!empty($d3[total]))
													{
												?>
						                    		<tr>
						                    				...
						                    				<table class="table table-striped" style="width:80%">
									                            <thead style="color:#666;font-size:13px">
									                                <tr>
									                                    ...
									                                    <th style="padding:2px">JUMLAH BELI (RP)</th>
									                                </tr>
									                            </thead>
									                            <tbody>
									                    		<?
									                    		$q2 = mysql_query("SELECT * FROM x23_notaretur WHERE id%2=0 AND noretur IN (SELECT noretur FROM temp_x23_bayarsup_notaretur) AND status!='1'");
			...
			<!-- ################## MODAL PILIH NOTA RETUR ########################################################################################## -->
									<?
									$dS = mysql_fetch_array(mysql_query("SELECT nama FROM x23_supplier WHERE id%2=0 AND id='$d1[idsupplier]'"));
									?>
							            ...
							            <div class="modal-dialog" style="width:45%;">
							                <div class="modal-content">
						                        ...
						                        <div class="modal-body" style="overflow-y:auto;overflow-x:hidden;">
							                    	<table width="100%">
							                    		<tr>
							                    			<td width="40%">PILIH NOTA RETUR BELI</td>
							                    			<td width="2%">:</td>
							                    			<td colspan="2"><select class="form-control" name="noretur" required style="width: 100%" required="">
																				<option value=''>Pilih</option>
																			<?
																				$q1 = mysql_query("SELECT * FROM x23_notaretur WHERE id%2=0 AND idsupplier='$d1[idsupplier]' AND status!='1' ORDER BY noretur");
																				while($dA=mysql_fetch_array($q1))
																					{
																			?>
...
<?
						...
						if(!empty($_REQUEST[bayarnota]))
							...
							if($_REQUEST[gtbayar] >= $_REQUEST['totalretur'])
								{
				  				$qA = mysql_query("SELECT * FROM x23_notaretur WHERE id%2=0 AND noretur IN (SELECT noretur FROM temp_x23_bayarsup_notaretur) AND status!='1'");
	                    		while($dA = mysql_fetch_array($qA))
		                    		{
									$dxz2 = mysql_fetch_array(mysql_query("SELECT * FROM x23_notaretur WHERE id%2=0 AND noretur='$dA[noretur]'"));
		                    		mysql_query("UPDATE x23_notaretur SET status='1',sisa='0',potong=jumlah,nonota2='$_REQUEST[nonota]',iduser='$_SESSION[id]' WHERE id%2=0 AND noretur='$dA[noretur]'");
							...
							if($_REQUEST[gtbayar] < $_REQUEST['totalretur'])
								...
								*/
								...
								$dA = mysql_fetch_array(mysql_query("SELECT * FROM x23_notaretur WHERE id%2=0 AND noretur='$dA1[noretur]' AND status!='1'"));
				  				$noreturX = $dA[noretur];
				  				
				  				$dB = mysql_fetch_array(mysql_query("SELECT SUM(sisa) AS total FROM x23_notaretur WHERE id%2=0 AND noretur IN (SELECT noretur FROM temp_x23_bayarsup_notaretur WHERE id%2=0 AND noretur!='$noreturX') AND status!='1'"));
				  				$sisa  = $_REQUEST[gtbayar]-$dB[total];
				  				$sisa2 = $dA[sisa]-$sisa;
								$sisaZ = $sisa+$dB[total]; 
								
	                    		mysql_query("UPDATE x23_notaretur SET status='2',potong='$sisa',sisa=$sisa2,nonota2='$_REQUEST[nonota]',iduser='$_SESSION[id]' WHERE id%2=0 AND noretur='$dA[noretur]'");
	                    		mysql_query("INSERT INTO x23_notaretur_use (
		                    											noretur,
		                    											tanggal,
		                    											bulan,
				  				...
				  				$qC = mysql_query("SELECT * FROM x23_notaretur WHERE id%2=0 AND noretur IN (SELECT noretur FROM temp_x23_bayarsup_notaretur WHERE id%2=0 AND noretur!='$noreturX') AND status!='1'");
	                    		while($dC = mysql_fetch_array($qC))
		                    		{
		                    		mysql_query("UPDATE x23_notaretur SET status='1',sisa='0',potong=jumlah,nonota2='$_REQUEST[nonota]',iduser='$_SESSION[id]' WHERE id%2=0 AND noretur='$dC[noretur]'");
									$dxz1 = mysql_fetch_array(mysql_query("SELECT * FROM x23_notaretur WHERE id%2=0 AND noretur='$dC[noretur]'"));
		                    		mysql_query("INSERT INTO x23_notaretur_use (
			                    											noretur,
			                    											tanggal,
			                    											bulan,
							...
							if($_REQUEST[harga]=='0'){
								//$q1 = mysql_query("UPDATE x23_notabeli SET dk='1',iduserbyr='$_SESSION[id]',updatex='$updatex' WHERE id%2=0 AND id='$_REQUEST[bayarnota]'");
									
								if($_REQUEST[gtbayar] < $_REQUEST['totalretur']){
									$q1 = mysql_query("UPDATE x23_notabeli SET dk='1',status='$status',bayar='$sisaZ',tglbayar='$tglbayar',iduserbyr='$_SESSION[id]',updatex='$updatex' WHERE id%2=0 AND id='$_REQUEST[bayarnota]'");
									}
								else{
									$q1 = mysql_query("UPDATE x23_notabeli SET dk='1',status='$status',bayar='$bayar',tglbayar='$tglbayar',iduserbyr='$_SESSION[id]',updatex='$updatex' WHERE id%2=0 AND id='$_REQUEST[bayarnota]'");
									}
							...
							if($_REQUEST[harga]=='1'){
								...
								if($_REQUEST[gtbayar] < $_REQUEST['totalretur']){
									$q1 = mysql_query("UPDATE x23_notabeli SET status='$status',bayar='$sisaZ',tglbayar='$tglbayar',iduserbyr='$_SESSION[id]',updatex='$updatex' WHERE id%2=0 AND id='$_REQUEST[bayarnota]'");
									}
								else{
									$q1 = mysql_query("UPDATE x23_notabeli SET status='$status',bayar='$bayar',tglbayar='$tglbayar',iduserbyr='$_SESSION[id]',updatex='$updatex' WHERE id%2=0 AND id='$_REQUEST[bayarnota]'");
									}
                                    	...
                                    	<table width="100%">
                                    		<tr>
                                    			<td>
		                                            	...
		                                            	<input type="text" style="height:34px" name="cari" autofocus placeholder="CARI NO. NOTA BELI / NAMA SUPPLIER ..." class="form-control"/>
		                                            </div>
                                    			</td>
                                    			<td width="40%"><input type="text" name="periode" style="height:34px;cursor:pointer;" value="<?echo $_REQUEST[periode]?>" placeholder="PERIODE TGL NOTA BELI" class="form-control" id="reservation"/></td>
			                        ...
			                        <table id="example3" class="table table-striped table-hover" style="width:130%">
										...
										if(empty($_REQUEST[periode]))
											...
											if(!empty($_REQUEST[cari]))
												{
												$q1 = mysql_query("SELECT * FROM x23_notabeli_vw WHERE id%2=0 AND bayar NOT IN ('0','') AND scan='1' AND dk='0' AND (nonota LIKE '%$_REQUEST[cari]%' OR nama LIKE '%$_REQUEST[cari]%') LIMIT 0,20");
												$q3 = mysql_query("SELECT * FROM x23_notabeli_vw WHERE id%2=0 AND bayar NOT IN ('0','') AND scan='1' AND dk='0' AND (nonota LIKE '%$_REQUEST[cari]%' OR nama LIKE '%$_REQUEST[cari]%') LIMIT 0,20");
												}
											else
												{
												$q1 = mysql_query("SELECT * FROM x23_notabeli_vw WHERE id%2=0 AND bayar NOT IN ('0','') AND scan='1' AND dk='0' ORDER BY id DESC LIMIT 0,20");
												$q3 = mysql_query("SELECT * FROM x23_notabeli_vw WHERE id%2=0 AND bayar NOT IN ('0','') AND scan='1' AND dk='0' ORDER BY id DESC LIMIT 0,20");
												}
											}
											...
											if(!empty($_REQUEST[cari]))
												{
												$q1 = mysql_query("SELECT * FROM x23_notabeli_vw WHERE id%2=0 AND bayar NOT IN ('0','') AND scan='1' AND dk='0' AND tglnota BETWEEN '$_SESSION[periode_awal]' AND '$_SESSION[periode_akhir]'  AND (nonota LIKE '%$_REQUEST[cari]%' OR nama LIKE '%$_REQUEST[cari]%') LIMIT 0,20");
												$q3 = mysql_query("SELECT * FROM x23_notabeli_vw WHERE id%2=0 AND bayar NOT IN ('0','') AND scan='1' AND dk='0' AND tglnota BETWEEN '$_SESSION[periode_awal]' AND '$_SESSION[periode_akhir]' AND (nonota LIKE '%$_REQUEST[cari]%' OR nama LIKE '%$_REQUEST[cari]%') LIMIT 0,20");
												}
											else
												{
												$q1 = mysql_query("SELECT * FROM x23_notabeli_vw WHERE id%2=0 AND bayar NOT IN ('0','') AND scan='1' AND dk='0' AND tglnota BETWEEN '$_SESSION[periode_awal]' AND '$_SESSION[periode_akhir]' ORDER BY id DESC LIMIT 0,20");
												$q3 = mysql_query("SELECT * FROM x23_notabeli_vw WHERE id%2=0 AND bayar NOT IN ('0','') AND scan='1' AND dk='0' AND tglnota BETWEEN '$_SESSION[periode_awal]' AND '$_SESSION[periode_akhir]' ORDER BY id DESC LIMIT 0,20");
												}
											}
			                            while($d1 = mysql_fetch_array($q1))
			                            	{
...
<?
						...
						if(!empty($_REQUEST[ubah]))
							...
							$q1 = mysql_query("UPDATE x23_bayarsup_history SET jumlah='$bayar' WHERE id%2=0 AND id='$_REQUEST[ubah]'");
							...
							$q2 = mysql_query("UPDATE x23_notabeli SET status='$status',bayar='$bayarupdate',tglbayar=CURDATE(),updatex='$updatex' WHERE id%2=0 AND id='$_REQUEST[id]'");
							$q3 = mysql_query("INSERT INTO log_act VALUES (										
						                                    '',
						                                    'x23_notabeli',
						                                    CURDATE(),
						...
						$dA = mysql_fetch_array(mysql_query("SELECT * FROM x23_bayarsup_history WHERE id%2=0 AND id='$_REQUEST[idbayar]'"));
?>
			            <div class="col-xs-12" style="margin-bottom:10px">
			                <div class="box box-danger">
			                    <div class="box-body table-responsive" style="overflow-y:auto;overflow-x:hidden;height:520px;">
...
<?
						...
						if(!empty($_REQUEST[bayarnota]))
							...
							$q1 = mysql_query("UPDATE x23_notabeli SET status='$status',bayar='$bayar',tglbayar='$tglbayar',updatex='$updatex' WHERE id%2=0 AND id='$_REQUEST[bayarnota]'");
							      mysql_query("INSERT INTO x23_bayarsup_history VALUES (
								  								'',
								  								'$_REQUEST[nonota]',
								  								'$bayar2',
					           			...
					           			<div class="col-xs-6">
					                        <table width="100%">
					                        	...
					                        	<tr>
					                    			...
					                    			<td><div class="input-group">
					                                        <span class="input-group-addon">RP.</span>
					                                        	<input type="text" value="<?echo $sh?>" onfocus="this.select();" style="width:80%;text-align:right" class="form-control uang" readonly> 
					                                    </div></td>
					                        	</tr>
					                        </table>
					                    </div>
			                ...
			                <div class="box box-danger">
			                    <div class="box-body table-responsive" style="overflow-y:auto;overflow-x:auto;height:260px;">
			                        <table id="example2" class="table table-striped" style="width:120%">
			                            <thead style="color:#666;font-size:13px">
			                                <tr>
			                                    <th style="padding:7px">KODE BARANG<?//echo $d1[nonota]?></th>
			                                    <th style="padding:7px">NAMA BARANG</th>
			                                    <th style="padding:7px">VARIAN</th>
			                                    <th width="7%" style="padding:7px"><center>QTY BELI</center></th>
			                                    <th width="" style="padding:7px"><center>HARGA BELI (RP)</center></th>
					                ...
					                <div class="modal-content">
				                        ...
				                        <div class="modal-body">
					                        <table id="example2" class="table table-striped" style="width:100%">
					                            ...
					                            <tbody>
					                            <?
												$d2 = mysql_fetch_array(mysql_query("SELECT SUM(jumlah) AS total FROM x23_bayarsup_history WHERE id%2=0 AND nonota='$d1[nonota]'"));
												$q1 = mysql_query("SELECT * FROM x23_bayarsup_history WHERE id%2=0 AND nonota='$d1[nonota]'");
					                            while($dA = mysql_fetch_array($q1))
					                            	{
					                            ?>
					                                <tr style="cursor:pointer">
					                                    <td align="center"><?echo date("d-m-Y",strtotime($dA[tanggal]))?></td>
					                                    <td align=""><?echo $dA[keterangan]?></td>
					                                    <td align="right"><span style="margin-right:30%"><?echo number_format($dA[jumlah],"0","",".")?></span></td>
					                                    <td width="1%" align="center">
				                                    	<?
		                                            	if($_SESSION[posisi]=='DIREKSI'){
															if(substr($dA[keterangan],0,2)=='PE'){
														?>
						                                    	<div class="btn-group">
					           			...
					           			<div class="col-xs-6">
					                        <table width="100%">
					                        	...
					                        	<tr>
					                    			...
					                    			<td><div class="input-group">
					                                        <span class="input-group-addon">RP.</span>
					                                        	<input type="text" value="<?echo number_format($d1[bayar],"0","",".")?>" onfocus="this.select();" style="width:80%;text-align:right" class="form-control uang" readonly> 
					                                    </div></td>
					                        	</tr>
												<?
												$shX = $d1[gtbayar]-$d1[bayar];
						...
						if(!empty($_REQUEST[bayarnota]))
							...
							if($_REQUEST[gtbayar] < $_REQUEST['totalretur'])
								...
								$dA = mysql_fetch_array(mysql_query("SELECT * FROM x23_notaretur WHERE id%2=0 AND noretur='$dA1[noretur]' AND status!='1'"));
				  				...
				  				$dC = mysql_fetch_array(mysql_query("SELECT COUNT(noretur) AS tot FROM temp_x23_bayarsup_notaretur WHERE id%2=0 AND noretur!='$dA1[noretur]'"));
				  				if($dC[tot]=='0')
				  					{
		                    		...
		                    		mysql_query("UPDATE x23_notaretur SET status='2',potong='$sisa',sisa=$sisa2,nonota2='$_REQUEST[nonota]',iduser='$_SESSION[id]' WHERE id%2=0 AND noretur='$dA[noretur]'");
					  				...
					  				$qC = mysql_query("SELECT * FROM x23_notaretur WHERE id%2=0 AND noretur IN (SELECT noretur FROM temp_x23_bayarsup_notaretur where noretur!='$noreturX') AND status!='1'");
		                    		while($dC = mysql_fetch_array($qC))
			                    		{
			                    		mysql_query("UPDATE x23_notaretur SET status='1',sisa='0',potong=jumlah,nonota2='$_REQUEST[nonota]',iduser='$_SESSION[id]' WHERE id%2=0 AND noretur='$dC[noretur]'");
			                    		mysql_query("INSERT INTO x23_notaretur_use (
							...
							if($_REQUEST[gtbayar] < $_REQUEST['totalretur']){
								...
								$q1 = mysql_query("UPDATE x23_notabeli SET status='$status',bayar='$bayarZ',tglbayar='$tglbayar',iduserbyr='$_SESSION[id]',updatex='$updatex' WHERE id%2=0 AND id='$_REQUEST[bayarnota]'");
								}
...
<?
		...
		if(!empty($_REQUEST[ubahbayarnota]))
			...
			$q1 = mysql_query("UPDATE x23_notabeli SET status='$status',bayar='$bayar2',tglbayar='$tglbayar',updatex='$updatex' WHERE id%2=0 AND id='$_REQUEST[ubahbayarnota]'");
...
?>
			                ...
			                <div class="box box-danger">
			                	...
			                	<h4>PENCARIAN NOTA BELI</h4>
                                    	...
                                    	<table width="100%">
                                    		<tr>
												...
												if($_SESSION[posisi]=='DIREKSI')
													{
												?>
													<button type="button"  onclick="window.open('printaj/h2/bayarsup.php','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')" class="btn btn-danger pull-right"><i class="fa fa-print"></i> Export Ke Excel</button>
				                       			<?
				                       				}
				                       			?>
                                    			</td>
			                        ...
			                        <table id="example1" class="table table-bordered table-striped table-hover" style="width: 130%">
			                            ...
			                            <tbody>
			                            <?			                            
										$q1 = mysql_query("SELECT * FROM x23_notabeli_vw WHERE id%2=0 AND tglnota BETWEEN '$_SESSION[periode_awal]' AND '$_SESSION[periode_akhir]' AND gtbayar!='' AND dk='0'");
			                            while($d1 = mysql_fetch_array($q1))
			                            	{
			                            	if($d1[status]=="1"){$status = "<span class='btn btn-primary' style='padding:0px 10px;font-size:12px;width:90px'>Lunas</span>";}
			                            	if($d1[status]=="0"){
		            ...
		            <?
						$q3 = mysql_query("SELECT * FROM x23_notabeli WHERE id%2=0 AND status='0'");
			            while($d3 = mysql_fetch_array($q3))
			            	{
		            ?>
	<!-- ################## MODAL BAYAR ########################################################################################## -->
...
<?
						...
						$q3 = mysql_query("SELECT * FROM x23_notabeli WHERE id%2=0 AND status='1'");
			            while($d3 = mysql_fetch_array($q3))
			            	{
?>
	<!-- ################## MODAL BAYAR ########################################################################################## -->
...
?>
		            ...
		            <?
						$q3 = mysql_query("SELECT * FROM x23_notabeli WHERE id%2=0 AND id='$_REQUEST[id]'");
			            while($d3 = mysql_fetch_array($q3))
			            	{
		            ?>
	<!-- ################## MODAL UBAH BARANG ########################################################################################## -->
