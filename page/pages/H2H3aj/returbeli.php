			                	...
			                	<h4>ADMINISTRASI <small>RETUR BELI <i class="fa fa-angle-right"></i> DAFTAR RETUR BELI</small></h4>
									...
									?>
	                           		...
	                           		<div style="float:right" class="col-xs-7">
										...
										if($_SESSION[posisi]=='DIREKSI')
											{
										?>
											<button type="button"  onclick="window.open('printaj/h2/returbeli.php','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')" class="btn btn-danger pull-right"><i class="fa fa-print"></i> Export Ke Excel</button>
	                           			<?
	                           				}
	                           			?>
	                           		</div>
			                        <table id="example4" class="table table-striped" style="width:160%">
										...
										if(!empty($_REQUEST[cari]))
											...
											{
											$q1 = mysql_query("SELECT * FROM x23_returbeli_vw WHERE id%2=0 ORDER BY id DESC LIMIT 0,20");
											}
			                	...
			                	<h4>ADMINISTRASI <small>RETUR BELI <i class="fa fa-angle-right"></i> <?echo $d1[nopo]?></small></h4>
			                        ...
			                        <table id="example2" class="table table-striped table-hover" style="width:130%">
				           			...
				           			<div class="col-xs-12">
				           				<input type="hidden" name="id" value="<?echo $_REQUEST[id]?>"/>
				                        <div class="modal-footer clearfix">
											<button type="button"  onclick="window.open('printaj/h2/returbelidet.php?id=<?echo $_REQUEST[id]?>','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')" class="btn btn-info pull-left"><i class="fa fa-print"></i> Export Ke Excel</button>
