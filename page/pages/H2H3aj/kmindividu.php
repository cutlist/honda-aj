			                ...
			                <div class="box box-danger" style="overflow-x:auto;overflow-y:auto;height:520px;">
			                    ...
			                    ?>
			                        <table id="example2" class="table table-bordered table-striped table-hover" style="width:200%;padding-right:20px">
										...
										$dA1 = mysql_fetch_array(mysql_query("SELECT COUNT(nonota) AS total FROM x23_notaservice WHERE id%2=0 AND idmekanik='$_REQUEST[idmekanik]' AND tglselesai BETWEEN '$_SESSION[periode_awal]' AND '$_SESSION[periode_akhir]' AND statuskwitansi='1'"));
										$dA2 = mysql_fetch_array(mysql_query("SELECT COUNT(nonota) AS total FROM x23_notaservice_det1_vw WHERE id%2=0 AND kpbke!='' AND nonota IN (SELECT nonota FROM x23_notaservice WHERE idmekanik='$_REQUEST[idmekanik]' AND tglselesai BETWEEN '$_SESSION[periode_awal]' AND '$_SESSION[periode_akhir]' AND statuskwitansi='1')"));
										$dA4 = mysql_fetch_array(mysql_query("SELECT COUNT(nonota) AS total FROM x23_notaservice WHERE id%2=0 AND jns='SERVIS JR' AND idmekanik='$_REQUEST[idmekanik]' AND tglselesai BETWEEN '$_SESSION[periode_awal]' AND '$_SESSION[periode_akhir]' AND statuskwitansi='1'"));
										
										$q1 = mysql_query("SELECT * FROM x23_notaservice WHERE id%2=0 AND idmekanik='$_REQUEST[idmekanik]' AND tglselesai BETWEEN '$_SESSION[periode_awal]' AND '$_SESSION[periode_akhir]' AND statuskwitansi='1'");
