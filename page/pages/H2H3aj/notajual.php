			                	...
			                	<h4>PENJUALAN <small>NAMA BARANG</small></h4>
									...
									<table id="example2" class="table table-striped table-hover">
										...
										if(!empty($_REQUEST[cari]))
											...
											$q2 = mysql_query("SELECT * FROM tbl_pelanggan WHERE  id%2=0 AND  nama LIKE '%$_REQUEST[cari]%' OR ohc LIKE '%$_REQUEST[cari]%' OR notelepon LIKE '%$_REQUEST[cari]%'");
											}
										else
											{
											$q1 = mysql_query("SELECT * FROM tbl_pelanggan WHERE  id%2=0 ORDER BY id DESC LIMIT 0,20");
											$q2 = mysql_query("SELECT * FROM tbl_pelanggan WHERE  id%2=0");
											}
