			                	...
			                	<h4>PEMBELIAN <small>NOTA BELI</small></h4>
			                        ...
			                        <table id="example3" class="table table-striped table-hover" style="width:120%">
										...
										if(!empty($_REQUEST[cari]))
											{
											$q1 = mysql_query("SELECT * FROM x23_notabeli_vw  WHERE id%2=0 AND  jns='PEMBELIAN' AND (nonota LIKE '%$_REQUEST[cari]%' OR nopo LIKE '%$_REQUEST[cari]%' OR tglnota LIKE '%$_REQUEST[cari]%' OR nama LIKE '%$_REQUEST[cari]%') LIMIT 0,20");
											}
										else
											{
											$q1 = mysql_query("SELECT * FROM x23_notabeli_vw WHERE id%2=0 AND  jns='PEMBELIAN' ORDER BY id DESC LIMIT 0,20");
											}
...
?>
						<script type="text/javascript">
							...
							function popup_print(){
								window.open('printaj/notabelih23.php?nonota=<?echo $d1[nonota]?>','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')
								}
						</script>
...
<?
		...
		echo "			
		<script type='text/javascript'>
			window.open('printaj/notabelih23.php?nonota=$_SESSION[nonotabeli]','page','toolbar=0,titlebar=0,fullscreen=0,directories=0,channelmode=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1,height=1,left=150,top=100')
		</script>";
