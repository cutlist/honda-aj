			                        ...
			                        <table id="example1" class="table table-bordered table-striped" style="width:220%">
			                            <thead style="color:#666;font-size:13px">
			                                <tr>
			                                    ...
			                                    <th style="padding:7px" width="">TOTAL PELUNASAN (RP)</th>
			                            ...
			                            ?>
			                                <tr style="cursor:pointer">
			                                    ...
			                                    <td align="right"><span style="padding-right:20%"><?echo number_format(round(($d1[penerimaan]-$d1[kpb])/2),"0","",".")?></span></td>
			                                    <td align="right"><span style="padding-right:20%"><?echo number_format(round($d1[kpb]/2),"0","",".")?></span></td>
			                                    <td align="right"><span style="padding-right:20%"><?echo number_format(round($d1[penerimaan]/2),"0","",".")?></span></td>
			                                    <td align="right"><span style="padding-right:20%"><?echo number_format(round($d1[pengeluaran]/2),"0","",".")?></span></td>
			                                    <td align="right"><span style="padding-right:20%"><?echo number_format(round($d1[notakecil]/2),"0","",".")?></span></td>
			                                    <td align="right"><span style="padding-right:20%"><?echo number_format(round($d1[pjs]/2),"0","",".")?></span></td>
			                                    <td align="right"><span style="padding-right:20%"><?echo number_format(round($d1[pjmpm]/2),"0","",".")?></span></td>
			                                    <td align="right"><span style="padding-right:20%"><?echo number_format(round($d1[pembulatan]/2),"0","",".")?></span></td>
			                                    <td align="right"><span style="padding-right:20%"><?echo number_format(round($d1[ho]/2),"0","",".")?></span></td>
			                                    <td align="right"><span style="padding-right:20%"><?echo number_format(round($d1[um]/2),"0","",".")?></span></td>
			                                    <td align="right"><span style="padding-right:20%"><?echo number_format(round($d1[pelunasan]/2),"0","",".")?></span></td>
			                                    <td align="right"><span style="padding-right:20%"><?echo number_format(round($d1[pengembalian]/2),"0","",".")?></span></td>
			                                    <td align="right"><span style="padding-right:20%"><?echo number_format(round($d1[jumlah]/2),"0","",".")?></span></td>
												<!--
