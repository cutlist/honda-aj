			                	...
			                	<h4>SERVIS <small>INPUT NOTA SERVIS</small></h4>
									...
									<table id="example1" class="table table-striped table-hover">
										...
										if(!empty($_REQUEST[cari]))
											{
											$q1 = mysql_query("SELECT * FROM tbl_pelanggan WHERE id%2=0 AND nama LIKE '%$_REQUEST[cari]%' OR ohc LIKE '%$_REQUEST[cari]%' OR notelepon LIKE '%$_REQUEST[cari]%' LIMIT 0,20");
											}
										else
											{
...
<?
		...
		$dX = mysql_fetch_array(mysql_query("SELECT * FROM x23_notaservice WHERE id%2=0 AND id='$_REQUEST[id]'"));
			                    	...
			                    	<div id="spoiler" style="display:none">
										...
										<table class="table table-striped table-hover" >
											<thead>
				                       		...
				                       		<tbody>
				                            <?
				                            $q1 = mysql_query("SELECT * FROM x23_notaservice WHERE id%2=0 AND idpelanggan='$_REQUEST[id]' AND nonota!='' ORDER BY tglnota DESC");
				                            while($d1 = mysql_fetch_array($q1))
				                            	{
				                            ?>
