			                ...
			                <div class="box box-danger" style="overflow-x:auto;overflow-y:auto;height:520px;">
			                    ...
			                    ?>
			                        <table id="example2" class="table table-bordered table-striped table-hover" style="width:520%;padding-right:20px">
										...
										$no = 1;
										$q1 = mysql_query("SELECT * FROM x23_notajual_det_vw WHERE id%2=0 AND tglnota BETWEEN '$_SESSION[periode_awal]' AND '$_SESSION[periode_akhir]'");
			                        ...
			                        <table id="example4" class="table table-bordered table-striped table-hover" style="width:300%;padding-right:20px">
			                            ...
			                            <?
										$no2 = 1;
										$q1 = mysql_query("SELECT * FROM x23_indent_det_vw WHERE id%2=0 AND tglindent BETWEEN '$_SESSION[periode_awal]' AND '$_SESSION[periode_akhir]' AND status='0'");
			                            while($d1 = mysql_fetch_array($q1))
			                            	{
			            					if(strlen($no2)==1)
			            						{
