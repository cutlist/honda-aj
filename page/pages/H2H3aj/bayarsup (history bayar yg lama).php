			                	...
			                	<h4>PEMBELIAN <small>NOTA BELI SUDAH BAYAR</small></h4>
			                        ...
			                        <table id="example3" class="table table-striped table-hover" style="width:130%">
										...
										if(!empty($_REQUEST[cari]))
											{
											$q1 = mysql_query("SELECT * FROM x23_notabeli_vw WHERE id%2=0 AND bayar NOT IN ('0','') AND scan='1' AND dk='0' AND nonota LIKE '%$_REQUEST[cari]%' OR nodo LIKE '%$_REQUEST[cari]%' OR tglbayar LIKE '%$_REQUEST[cari]%' OR nodo LIKE '%$_REQUEST[cari]%' LIMIT 0,20");
											$q3 = mysql_query("SELECT * FROM x23_notabeli_vw WHERE id%2=0 AND bayar NOT IN ('0','') AND scan='1' AND dk='0' AND nonota LIKE '%$_REQUEST[cari]%' OR nodo LIKE '%$_REQUEST[cari]%' LIMIT 0,20");
											}
										else
											{
