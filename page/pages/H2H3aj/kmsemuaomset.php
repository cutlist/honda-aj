			                        ...
			                        <table id="example2" class="table table-bordered table-striped table-hover" style="width:<?echo $widthtable;?>;padding-right:20px">
			                            ...
			                            ?>
			                                <tr style="cursor:pointer">
												...
												while($dM = mysql_fetch_array($qM))
													{
													$dNS1 = mysql_fetch_array(mysql_query("SELECT SUM(hargampm) AS total FROM x23_notaservice_det1_vw WHERE id%2=0 AND nonota IN (SELECT nonota FROM x23_notaservice WHERE idmekanik='$dM[id]' AND tglselesai='$d1[tglnota]' AND statuskwitansi='1')"));
													$dNS2 = mysql_fetch_array(mysql_query("SELECT SUM(tarif) AS total FROM x23_notaservice_det WHERE id%2=0 AND nonota IN (SELECT nonota FROM x23_notaservice WHERE idmekanik='$dM[id]' AND tglselesai='$d1[tglnota]' AND statuskwitansi='1')"));
												?>
										...
										*/
			                            ...
			                            <tfoot>
			                            	<tr>
												...
												while($dM = mysql_fetch_array($qM))
													{
													$dNS1 = mysql_fetch_array(mysql_query("SELECT SUM(hargampm) AS total FROM x23_notaservice_det1_vw WHERE id%2=0 AND nonota IN (SELECT nonota FROM x23_notaservice WHERE idmekanik='$dM[id]' AND  tglselesai BETWEEN '$_SESSION[periode_awal]' AND '$_SESSION[periode_akhir]' AND statuskwitansi='1')"));
													$dNS2 = mysql_fetch_array(mysql_query("SELECT SUM(tarif) AS total FROM x23_notaservice_det WHERE id%2=0 AND nonota IN (SELECT nonota FROM x23_notaservice WHERE idmekanik='$dM[id]' AND  tglselesai BETWEEN '$_SESSION[periode_awal]' AND '$_SESSION[periode_akhir]' AND statuskwitansi='1')"));
												?>
